...
const mvt = async (bbox, pgClient, filterParams, channel) => {
  ...
  const blobName = `wireless-penetration-heatmap-county-${channel.toLowerCase()}-${partitionKey}.mvt`;
