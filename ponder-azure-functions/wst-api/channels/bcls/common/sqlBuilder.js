const whereClause = params =>
{
    const {
        vpgm, archetype, dmaName, zipcode, indoorCovScore, fiveg,
             ...
             popDensity, medIncome, hypergig, scsScore, fivegplusCbandScs, wbbSuitabilityScs, speedExperienceScs, wbbEvaluationIcs, wbbEvaluationScs, newlyLit, psa, fiberPid, svid, nsbId,  locationId, firstLit, noSpend, businessEmployees, sicCdGrp,
             totalEmployeesHere
    } = params;
