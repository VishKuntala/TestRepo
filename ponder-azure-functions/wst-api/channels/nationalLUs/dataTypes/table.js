...
module.exports = async (pgClient, postParams, getParams, entityType) => {
    ...
    SELECT * FROM (
        ...
        (SELECT EXTERNAL_LIVING_UNIT_ID, ADDRESS, CITY, STATE_CD, ZIPCODE, ADDRESS_LINE_2,
          NETWORK_BUILD_TYPE_CD, latitude::text, longitude::text, 
          network_build_type_sort_column
