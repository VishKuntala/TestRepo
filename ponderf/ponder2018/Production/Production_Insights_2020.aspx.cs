...
public partial class Production_Production_Insights_2020 : System.Web.UI.Page
{
    ...
    public void InitSelectors()
    {
        ...
        ddlMonth.Items.Add(new ListItem("January", "2023-01-01"));

        string currentMonth = DateTime.Now.Month.ToString();

        if (currentMonth == "2")
        {
            ddlMonth.Items.Add(new ListItem("February", "2023-02-01"));
            ddlMonth.DataBind();
        ...
        {
            ddlMonth.Items.Add(new ListItem("February", "2023-02-01"));
            ddlMonth.Items.Add(new ListItem("March", "2023-03-01"));
            ddlMonth.DataBind();
        ...
        if (currentMonth == "4")
        {
            ddlMonth.Items.Add(new ListItem("February", "2023-02-01"));
            ddlMonth.Items.Add(new ListItem("March", "2023-03-01"));
            ddlMonth.Items.Add(new ListItem("April", "2023-04-01"));
            ddlMonth.DataBind();
        ...
        if (currentMonth == "5")
        {
            ...
            ddlMonth.Items.Add(new ListItem("March", "2023-03-01"));
            ddlMonth.Items.Add(new ListItem("April", "2023-04-01"));
            ddlMonth.Items.Add(new ListItem("May", "2023-05-01"));
            ddlMonth.DataBind();
        ...
        if (currentMonth == "6")
        {
            ...
            ddlMonth.Items.Add(new ListItem("April", "2023-04-01"));
            ddlMonth.Items.Add(new ListItem("May", "2023-05-01"));
            ddlMonth.Items.Add(new ListItem("June", "2023-06-01"));
            ddlMonth.DataBind();
        ...
        if (currentMonth == "7")
        {
            ...
            ddlMonth.Items.Add(new ListItem("May", "2023-05-01"));
            ddlMonth.Items.Add(new ListItem("June", "2023-06-01"));
            ddlMonth.Items.Add(new ListItem("July", "2023-07-01"));
            ddlMonth.DataBind();
        ...
        if (currentMonth == "8")
        {
            ...
            ddlMonth.Items.Add(new ListItem("June", "2023-06-01"));
            ddlMonth.Items.Add(new ListItem("July", "2023-07-01"));
            ddlMonth.Items.Add(new ListItem("August", "2023-08-01"));
            ddlMonth.DataBind();
        ...
        if (currentMonth == "9")
        {
            ...
            ddlMonth.Items.Add(new ListItem("July", "2023-07-01"));
            ddlMonth.Items.Add(new ListItem("August", "2023-08-01"));
            ddlMonth.Items.Add(new ListItem("September", "2023-09-01"));
            ddlMonth.DataBind();
        ...
        if (currentMonth == "10")
        {
            ...
            ddlMonth.Items.Add(new ListItem("August", "2023-08-01"));
            ddlMonth.Items.Add(new ListItem("September", "2023-09-01"));
            ddlMonth.Items.Add(new ListItem("October", "2023-10-01"));
            ddlMonth.DataBind();
        ...
        if (currentMonth == "11")
        {
            ...
            ddlMonth.Items.Add(new ListItem("September", "2023-09-01"));
            ddlMonth.Items.Add(new ListItem("October", "2023-10-01"));
            ddlMonth.Items.Add(new ListItem("November", "2023-11-01"));
            ddlMonth.DataBind();
        ...
        if (currentMonth == "12")
        {
            ...
            ddlMonth.Items.Add(new ListItem("October", "2023-10-01"));
            ddlMonth.Items.Add(new ListItem("November", "2023-11-01"));
            ddlMonth.Items.Add(new ListItem("December", "2023-12-01"));
            ddlMonth.DataBind();
    ...
    public static string Get_RYG_Modal(string groupVariable, string marketVariable, string monthVariable, string MonthNumber, string RecentMSVariable, string PlanFcstVariable, string colSelected, string pptpOneVariable, string pptpTwoVariable, string pptpThreeVariable, string pptpFourVariable, string pptpFiveVariable)
    {
        ...
        string sqlPlan = @"SELECT * FROM (SELECT CASE WHEN CY_PUSH = 1 THEN 'PUSH " + RecentMSVariable + @"'
                    WHEN " + RecentMSVariable + @"_ACTUAL IS NOT NULL AND EXTRACT(YEAR FROM " + RecentMSVariable + @"_ACTUAL) < EXTRACT(YEAR FROM " + RecentMSVariable + @"_PLAN)  THEN 'ACTUAL BEFORE PLAN " + RecentMSVariable + @"'
    ...
    public static string Get_RYG_Modal2_1(string groupVariable, string marketVariable, string MonthNumber, string RecentMSVariable, string PlanFcstVariable, string pptpOneVariable, string pptpTwoVariable, string pptpThreeVariable, string pptpFourVariable, string pptpFiveVariable)
    {
        ...
        string sql = @"SELECT * FROM (
                    ...
                    WHEN " + RecentMSVariable + @"_ACTUAL IS NOT NULL AND EXTRACT(YEAR FROM " + RecentMSVariable + @"_ACTUAL) < EXTRACT(YEAR FROM EXECUTED_ON) THEN 'PREVIOUS " + RecentMSVariable + @"'
        ...
        if (ddlGeo.SelectedItem.Value == "ACE")
        {
            if (ddlMarket.SelectedItem.Value == "ALL")
            {
                ...
                WHERE STATUS IN ('Active', 'Complete')
                    AND TO_CHAR(ONAIR_FORECAST, 'YYYY') = '2023'
                    AND RAN_REGION LIKE '%'
                    AND RAN_AVP LIKE '%'
                    AND RAN_MARKET LIKE '%'
        ...
        if (groupVariable == "ACE")
        {
            if (marketVariable == "ALL")
            {
                ...
                (
                   ...
                   FOR FORECAST_MONTH IN ('2023-01' AS JAN, '2023-02' AS FEB, '2023-03' AS MAR, '2023-04' AS APR, '2023-05' AS MAY, '2023-06' AS JUN, '2023-07' AS JUL, '2023-08' AS AUG, '2023-09' AS SEP, '2023-10' AS OCT, '2023-11' AS NOV, '2023-12' AS DEC)
                ))t5
            ...
            if (marketVariable == "ALL")
            {
                ...
                UNION ALL
                    SELECT FORECAST_MONTH, GEO_TYPE, PPTP_CUSTOM_ONE, PPTP_CUSTOM_TWO, PPTP_CUSTOM_THREE, PPTP_CUSTOM_FOUR, PPTP_CUSTOM_FIVE,
                      RAN_REGION, RAN_AVP, RAN_MARKET, RAN_SUBMARKET, SALES_REGION, SALES_VPGM_MARKET, CUMU_PROJECTS_PLAN_ONAIR AS TABLE_PLAN, CUMU_PROJECTS_FCST_ONAIR AS TABLE_FORECAST, CUMU_PROJECTS_ONAIR_ACTUAL AS TABLE_ACTUAL FROM (
                    SELECT * FROM PONDER.PRODUCTION_INSIGHTS_PC 
                    WHERE PPTP_CUSTOM_ONE = '" + pptpOneVariable + @"'
                    AND PPTP_CUSTOM_TWO = '" + pptpTwoVariable + @"'
                    AND PPTP_CUSTOM_THREE = '" + pptpThreeVariable + @"'
