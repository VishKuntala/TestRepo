<%@ Page Title="TESTING Production Insights 2020" Language="C#" MasterPageFile="~/MasterPageProduction.master" AutoEventWireup="true" CodeFile="Production_Insights_2020_Testing.aspx.cs" Inherits="Production_Production_Insights_2020_Testing" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <link href="../tabulator4_6/dist/css/tabulator.css" rel="stylesheet" />
    <script src="../Content/Bootstrap/js/bootstrap.min.js"></script>
    <%--<script type="text/javascript" src="../tabulator/dist/js/tabulator.min.js"></script>--%>
    <script type="text/javascript" src="../tabulator4_6/dist/js/tabulator.js"></script>
    ...
    <%--<div class="d-flex align-items-center">
        <div class="mr-auto">--%>
            ...
            <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                ...
                <li class="m-nav__item">
                    <a href="/Production/Production_Insights_2020_Testing.aspx" class="m-nav__link">
                            ...
                            <div class="col-lg-12" id="tabs">
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-toggle="tab" href="#m_tabs_1_tab1" id="tab1">
                                            ...
                                            <h6><span id="tabname_tab1"></span></h6>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#m_tabs_1_tab2" id="tab2">
                                           <h6><span id="tabname_tab2"></span></h6>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#m_tabs_1_tab3" id="tab3">
                                            ...
                                            <h6><span id="tabname_tab3"></span></h6>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#m_tabs_1_tab4" id="tab4">
                                            <%--<i class="flaticon-map"></i><span class="m--visible-desktop-inline-block">5G mmWave Nodes</span>--%>
                                            <h6><span id="tabname_tab4"></span></h6>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#m_tabs_1_tab5" id="tab5">
                                        <%--<i class="flaticon-calendar-3"></i><span class="m--visible-desktop-inline-block">Placeholder 5</span>--%>
                                        <h6><span id="tabname_tab5"></span></h6>
                                    </a>
                                    </li>                          
                                    <%--<li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#m_tabs_1_tab6" id="tab6">
                                            <i class="flaticon-share"></i><span class="m--visible-desktop-inline-block">Placeholder 6</span>
                                        </a>
                                    </li>--%>
                                    <%--<li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#m_tabs_1_tab7" id="tab7">
                                            <i class="flaticon-graph"></i><span class="m--visible-desktop-inline-block">Placeholder 7</span>
                                        </a>
                                    </li>--%>                                
                                    <%--<li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#m_tabs_1_tab8" id="tab8">
                                ...
                                <div class="tab-content">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12" id="RecentDiv2_tab1">
                                                        <div style="text-align: center; color: #343a40">
                                                            <h5><span class="ProgramTitle_tab1"></span> - <span class="current_geo"></span>: <span class="current_market"></span> - <span class="current_year"></span> Production Numbers</h5>
                                                          ...
                                                          <%--  <div id="Quad1_tab1" class="m-section__content" style="height: 200px; width: 100%;">--%>
                                                            <div id="Quad1_tab1">
                                                               ...
                                                               <%-- <div class="m-demo__preview m-demo__preview--btn">                                                                    
                                                                    <button type="button" class="btn btn-primary btn-sm" id="Quad1ShowRows_tab1" onclick="ShowQuad1('_tab1')"> Show All Previous Months </button>
                                                                 </div>--%>
                                                                ...
                                                                <table id="PlanFcstActTable_tab1" class="table compact cell-border" style="width: 100%; height: 100%; font-size: 14px; white-space: nowrap; text-align: center; color: black;">
                                                                    <thead>
                                                                        <tr>
                                                                            <th bgcolor="#87CEFA" style="background-color: lightgreen" title="Click to Show/Hide Additional Months" onclick="ShowQuad1('_tab1')" ><span id="Quad1ShowHide_tab1"></span></th>
                                                                            <th bgcolor="#87CEFA" title="Jobs in POE with On Air Plan date within time range">POE</th>
                                                                            <th bgcolor="#87CEFA" title="Jobs with On Air Forecast date within time range">Forecast</th>
                                                                            <th bgcolor="#87CEFA" title="Jobs with On Air Actual date within time range">Actual</th>
                                                                            <th bgcolor="#87CEFA" title="Actual / POE">Actual % of POE</th>
                                                                        </tr>
                                                                    </thead>
                                                               ...
                                                               <div id="Quad1BottomTableDiv_tab1" style="overflow-x:auto;">
                                                                <table id="PlanFcstActTable2_tab1" class="table compact cell-border" style="width: 100%; height: 100%; font-size: 14px; white-space: nowrap; text-align: center; color: black; visibility: visible">
                                            ...
                                            <div class="col-lg-6" id="RecentDiv3_tab1">
                                                <div class="row">
                                                    <div class="col-lg-12" id="RecentDiv4_tab1">
                                                        <div style="text-align: center; color: #343a40">
                                                            <h5><span class="ProgramTitle_tab1"></span> - <span class="current_geo"></span>: <span class="current_market"></span> - <span class="current_year"></span> Production Curve</h5>
                                                            ...
                                                            <div id="Quad2_tab1">
                                                                ...
                                                                <button type="button" class="btn btn-primary" id="HidePCTableButton_tab1" onclick="HidePC_Table('_tab1')">Hide Table</button>
                                                                <button type="button" class="btn btn-primary" id="ShowPCTableButton_tab1" onclick="ShowPC_Table('_tab1')">Show Table</button>
                                            ...
                                            <div class="col-lg-6" id="RecentDiv5_tab1">
                                                <div class="row">
                                                    <div class="col-lg-12" id="RecentDiv6_tab1">
                                                        <div id="buttonrowcenterTP2_tab1" style="visibility: visible;">
                                                            <div style="text-align: center; color: #343a40">
                                                                <h5><span class="ProgramTitle_tab1"></span> - <span class="current_geo"></span>: <span class="current_market"></span> - Current and Previous Month Map</h5>
                                                                ...
                                                                <div id="Quad3_tab1">                                                            
                                                                    ...
                                                                    <div id="salesmapdiv_tab1"></div>
                                                                    <br />
                                                                    <div id="Recent_Sales_Detail_tab1">
                                                                        <%--<div id="Sales_Detail_tab12" ></div>--%>
                                                                        <table id="Sales_Detail_tab1" class="table compact" style="width: 100%; height: 100%; font-size: 12px; white-space: nowrap; text-align: center; color: black; visibility: visible">
                                                                            <thead>
                                                                                <tr>
                                                                    ...
                                                                    <button type="button" class="btn btn-primary" id="HideMapTableButton_tab1" onclick="HideMap_Table('_tab1')">Hide Job Details</button>
                                                                    <button type="button" class="btn btn-primary" id="ShowMapTableButton_tab1" onclick="ShowMap_Table('_tab1')">Show Job Details</button>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12" id="RecentDiv8_tab1">
                                                        ...
                                                        <div id="buttonrowcenterTP_tab1" style="visibility: visible;">
                                                            <div style="text-align: center; color: #343a40">
                                                                <h5><span class="ProgramTitle_tab1"></span> - <span class="current_geo"></span>: <span class="current_market"></span> - <span class="current_year"></span> Task Progression</h5>
                                  ...
                                  <div class="tab-pane" id="m_tabs_1_tab2" role="tabpanel">
                                            ...
                                            <div class="col-lg-6" id="RecentDiv_tab2">
                                                <div class="row">
                                                    <div class="col-lg-12" id="RecentDiv2_tab2">
                                                        <div style="text-align: center; color: #343a40">
                                                            <h5><span class="ProgramTitle_tab2"></span> - <span class="current_geo"></span>: <span class="current_market"></span> - <span class="current_year"></span> Production Numbers</h5>
                                                          ...
                                                          <%--  <div id="Quad1_tab2" class="m-section__content" style="height: 200px; width: 100%;">--%>
                                                            <div id="Quad1_tab2">
                                                               ...
                                                               <%-- <div class="m-demo__preview m-demo__preview--btn">                                                                    
                                                                    <button type="button" class="btn btn-primary btn-sm" id="Quad1ShowRows_tab2" onclick="ShowQuad1('_tab2')"> Show All Previous Months </button>
                                                                 </div>--%>
                                                                ...
                                                                <table id="PlanFcstActTable_tab2" class="table compact cell-border" style="width: 100%; height: 100%; font-size: 14px; white-space: nowrap; text-align: center; color: black;">
                                                                    <thead>
                                                                        <tr>
                                                                            <th bgcolor="#87CEFA" style="background-color: lightgreen" title="Click to Show/Hide Additional Months" onclick="ShowQuad1('_tab2')" ><span id="Quad1ShowHide_tab2"></span></th>
                                                                            <th bgcolor="#87CEFA" title="Jobs in POE with On Air Plan date within time range">POE</th>
                                                                            <th bgcolor="#87CEFA" title="Jobs with On Air Forecast date within time range">Forecast</th>
                                                                            <th bgcolor="#87CEFA" title="Jobs with On Air Actual date within time range">Actual</th>
                                                                            <th bgcolor="#87CEFA" title="Actual / POE">Actual % of POE</th>
                                                               ...
                                                               <div id="Quad1BottomTableDiv_tab2" style="overflow-x:auto;">
                                                                <table id="PlanFcstActTable2_tab2" class="table compact cell-border" style="width: 100%; height: 100%; font-size: 14px; white-space: nowrap; text-align: center; color: black; visibility: visible">
                                                                    <thead style="visibility: collapse;">
                                                                        <tr>
                                                                            <th bgcolor="#87CEFA" title=""></th>
                                                                            <th bgcolor="#87CEFA" title="Jobs in POE with On Air Plan date within time range">POE</th>
                                            ...
                                            <div class="col-lg-6" id="RecentDiv3_tab2">
                                                <div class="row">
                                                    <div class="col-lg-12" id="RecentDiv4_tab2">
                                                        <div style="text-align: center; color: #343a40">
                                                            <h5><span class="ProgramTitle_tab2"></span> - <span class="current_geo"></span>: <span class="current_market"></span> - <span class="current_year"></span> Production Curve</h5>
                                                            ...
                                                            <div id="Quad2_tab2">
                                                                ...
                                                                <button type="button" class="btn btn-primary" id="HidePCTableButton_tab2" onclick="HidePC_Table('_tab2')">Hide Table</button>
                                                                <button type="button" class="btn btn-primary" id="ShowPCTableButton_tab2" onclick="ShowPC_Table('_tab2')">Show Table</button>
                                            ...
                                            <div class="col-lg-6" id="RecentDiv5_tab2">
                                                <div class="row">
                                                    <div class="col-lg-12" id="RecentDiv6_tab2">
                                                        <div id="buttonrowcenterTP2_tab2" style="visibility: visible;">
                                                            <div style="text-align: center; color: #343a40">
                                                                <h5><span class="ProgramTitle_tab2"></span> - <span class="current_geo"></span>: <span class="current_market"></span> - Current and Previous Month Map</h5>
                                                                ...
                                                                <div id="Quad3_tab2">                                                            
                                                                    ...
                                                                    <div id="salesmapdiv_tab2"></div>
                                                                    <br />
                                                                    <div id="Recent_Sales_Detail_tab2">
                                                                        <%--<div id="Sales_Detail_tab22" ></div>--%>
                                                                        <table id="Sales_Detail_tab2" class="table compact" style="width: 100%; height: 100%; font-size: 12px; white-space: nowrap; text-align: center; color: black; visibility: visible">
                                                                            <thead>
                                                                                <tr>
                                                                                    <th bgcolor="#87CEFA">Category</th>
                                                                                    <th bgcolor="#87CEFA">PACE Number</th>
                                                                    ...
                                                                    <button type="button" class="btn btn-primary" id="HideMapTableButton_tab2" onclick="HideMap_Table('_tab2')">Hide Job Details</button>
                                                                    <button type="button" class="btn btn-primary" id="ShowMapTableButton_tab2" onclick="ShowMap_Table('_tab2')">Show Job Details</button>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12" id="RecentDiv8_tab2">
                                                        ...
                                                        <div id="buttonrowcenterTP_tab2" style="visibility: visible;">
                                                            <div style="text-align: center; color: #343a40">
                                                                <h5><span class="ProgramTitle_tab2"></span> - <span class="current_geo"></span>: <span class="current_market"></span> - <span class="current_year"></span> Task Progression</h5>
                                            ...
                                            <div class="col-lg-6" id="RecentDiv_tab3">
                                                <div class="row">
                                                    <div class="col-lg-12" id="RecentDiv2_tab3">
                                                        <div style="text-align: center; color: #343a40">
                                                            <h5><span class="ProgramTitle_tab3"></span> - <span class="current_geo"></span>: <span class="current_market"></span> - <span class="current_year"></span> Production Numbers</h5>
                                                          ...
                                                          <%--  <div id="Quad1_tab3" class="m-section__content" style="height: 200px; width: 100%;">--%>
                                                            <div id="Quad1_tab3">
                                                               ...
                                                               <%-- <div class="m-demo__preview m-demo__preview--btn">                                                                    
                                                                    <button type="button" class="btn btn-primary btn-sm" id="Quad1ShowRows_tab3" onclick="ShowQuad1('_tab3')"> Show All Previous Months </button>
                                                                 </div>--%>
                                                                ...
                                                                <table id="PlanFcstActTable_tab3" class="table compact cell-border" style="width: 100%; height: 100%; font-size: 14px; white-space: nowrap; text-align: center; color: black;">
                                                                    <thead>
                                                                        <tr>
                                                                            <th bgcolor="#87CEFA" style="background-color: lightgreen" title="Click to Show/Hide Additional Months" onclick="ShowQuad1('_tab3')" ><span id="Quad1ShowHide_tab3"></span></th>
                                                                            <th bgcolor="#87CEFA" title="Jobs in POE with On Air Plan date within time range">POE</th>
                                                                            <th bgcolor="#87CEFA" title="Jobs with On Air Forecast date within time range">Forecast</th>
                                                                            <th bgcolor="#87CEFA" title="Jobs with On Air Actual date within time range">Actual</th>
                                                                            <th bgcolor="#87CEFA" title="Actual / POE">Actual % of POE</th>
                                                               ...
                                                               <div id="Quad1BottomTableDiv_tab3" style="overflow-x:auto;">
                                                                <table id="PlanFcstActTable2_tab3" class="table compact cell-border" style="width: 100%; height: 100%; font-size: 14px; white-space: nowrap; text-align: center; color: black; visibility: visible">
                                                                    <thead style="visibility: collapse;">
                                                                        <tr>
                                                                            <th bgcolor="#87CEFA" title=""></th>
                                                                            <th bgcolor="#87CEFA" title="Jobs in POE with On Air Plan date within time range">POE</th>
                                                                ...
                                                                <div class="m-demo__preview m-demo__preview--btn">                                                                    
                                                                    <button type="button" class="btn btn-primary btn-sm" id="Pulls_btn_tab3" onclick="ShowPushPullMap('_tab3')"><i class="fa fa-arrow-left "></i>&nbsp;<span class="current_year"></span> Pull Ins: <span id="btn_CY_PULL_tab3"></span> jobs (<span id="btn_CY_PULL_perc_POE_tab3"></span>% of POE) <br /><span class="current_year"></span> Push Outs: <span id="btn_CY_PUSH_tab3"></span> jobs (<span id="btn_CY_PUSH_perc_POE_tab3"></span>% of POE)&nbsp;<i class="fa fa-arrow-right "></i></button>&nbsp;
                                                                    <%--<button type="button" class="btn btn-outline-brand btn-pill" id="Pulls_btn_tab3" onclick="ShowPushPullMap_tab3()"><i class="fa fa-arrow-left "></i>&nbsp;<span class="current_year"></span> Pull In Details (<span id="btn_CY_PULL_tab3"></span> jobs,&nbsp;<span id="btn_CY_PULL_perc_POE_tab3"></span>% of POE) and <br /><span class="current_year"></span> Push Out Details (<span id="btn_CY_PUSH_tab3"></span> jobs,&nbsp;<span id="btn_CY_PUSH_perc_POE_tab3"></span>% of POE)&nbsp;<i class="fa fa-arrow-right "></i></button>&nbsp;--%>
                                                                </div>
                                            ...
                                            <div class="col-lg-6" id="RecentDiv3_tab3">
                                                <div class="row">
                                                    <div class="col-lg-12" id="RecentDiv4_tab3">
                                                        <div style="text-align: center; color: #343a40">
                                                            <h5><span class="ProgramTitle_tab3"></span> - <span class="current_geo"></span>: <span class="current_market"></span> - <span class="current_year"></span> Production Curve</h5>
                                                            ...
                                                            <div id="Quad2_tab3">
                                                                ...
                                                                <button type="button" class="btn btn-primary" id="HidePCTableButton_tab3" onclick="HidePC_Table('_tab3')">Hide Table</button>
                                                                <button type="button" class="btn btn-primary" id="ShowPCTableButton_tab3" onclick="ShowPC_Table('_tab3')">Show Table</button>
                                            ...
                                            <div class="col-lg-6" id="RecentDiv5_tab3">
                                                <div class="row">
                                                    <div class="col-lg-12" id="RecentDiv6_tab3">
                                                        <div id="buttonrowcenterTP2_tab3" style="visibility: visible;">
                                                            <div style="text-align: center; color: #343a40">
                                                                <h5><span class="ProgramTitle_tab3"></span> - <span class="current_geo"></span>: <span class="current_market"></span> - Current and Previous Month Map</h5>
                                                                ...
                                                                <div id="Quad3_tab3">                                                            
                                                                    ...
                                                                    <div id="salesmapdiv_tab3"></div>
                                                                    <br />
                                                                    <div id="Recent_Sales_Detail_tab3">
                                                                        <%--<div id="Sales_Detail_tab32" ></div>--%>
                                                                        <table id="Sales_Detail_tab3" class="table compact" style="width: 100%; height: 100%; font-size: 12px; white-space: nowrap; text-align: center; color: black; visibility: visible">
                                                                            <thead>
                                                                                <tr>
                                                                                    <th bgcolor="#87CEFA">Category</th>
                                                                                    <th bgcolor="#87CEFA">PACE Number</th>
                                                                    ...
                                                                    <button type="button" class="btn btn-primary" id="HideMapTableButton_tab3" onclick="HideMap_Table('_tab3')">Hide Job Details</button>
                                                                    <button type="button" class="btn btn-primary" id="ShowMapTableButton_tab3" onclick="ShowMap_Table('_tab3')">Show Job Details</button>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12" id="RecentDiv8_tab3">
                                                        ...
                                                        <div id="buttonrowcenterTP_tab3" style="visibility: visible;">
                                                            <div style="text-align: center; color: #343a40">
                                                                <h5><span class="ProgramTitle_tab3"></span> - <span class="current_geo"></span>: <span class="current_market"></span> - <span class="current_year"></span> Task Progression</h5>
                                    ...
                                    <div class="tab-pane" id="m_tabs_1_tab4" role="tabpanel">
                                            ...
                                            <div class="col-lg-6" id="RecentDiv_tab4">
                                                <div class="row">
                                                    <div class="col-lg-12" id="RecentDiv2_tab4">
                                                        <div style="text-align: center; color: #343a40">
                                                            <h5><span class="ProgramTitle_tab4"></span> - <span class="current_geo"></span>: <span class="current_market"></span> - <span class="current_year"></span> Production Numbers</h5>
                                                          ...
                                                          <%--  <div id="Quad1_tab4" class="m-section__content" style="height: 200px; width: 100%;">--%>
                                                            <div id="Quad1_tab4">
                                                               ...
                                                               <%-- <div class="m-demo__preview m-demo__preview--btn">                                                                    
                                                                    <button type="button" class="btn btn-primary btn-sm" id="Quad1ShowRows_tab4" onclick="ShowQuad1('_tab4')"> Show All Previous Months </button>
                                                                 </div>--%>
                                                                ...
                                                                <table id="PlanFcstActTable_tab4" class="table compact cell-border" style="width: 100%; height: 100%; font-size: 14px; white-space: nowrap; text-align: center; color: black;">
                                                                    <thead>
                                                                        <tr>
                                                                            <th bgcolor="#87CEFA" style="background-color: lightgreen" title="Click to Show/Hide Additional Months" onclick="ShowQuad1('_tab4')" ><span id="Quad1ShowHide_tab4"></span></th>
                                                                            <th bgcolor="#87CEFA" title="Jobs in POE with On Air Plan date within time range">POE</th>
                                                                            <th bgcolor="#87CEFA" title="Jobs with On Air Forecast date within time range">Forecast</th>
                                                                            <th bgcolor="#87CEFA" title="Jobs with On Air Actual date within time range">Actual</th>
                                                                            <th bgcolor="#87CEFA" title="Actual / POE">Actual % of POE</th>
                                                               ...
                                                               <div id="Quad1BottomTableDiv_tab4" style="overflow-x:auto;">
                                                                <table id="PlanFcstActTable2_tab4" class="table compact cell-border" style="width: 100%; height: 100%; font-size: 14px; white-space: nowrap; text-align: center; color: black; visibility: visible">
                                                                    <thead style="visibility: collapse;">
                                                                        <tr>
                                                                            <th bgcolor="#87CEFA" title=""></th>
                                                                            <th bgcolor="#87CEFA" title="Jobs in POE with On Air Plan date within time range">POE</th>
                                                                ...
                                                                <div class="m-demo__preview m-demo__preview--btn">                                                                    
                                                                    <button type="button" class="btn btn-primary btn-sm" id="Pulls_btn_tab4" onclick="ShowPushPullMap('_tab4')"><i class="fa fa-arrow-left "></i>&nbsp;<span class="current_year"></span> Pull Ins: <span id="btn_CY_PULL_tab4"></span> jobs (<span id="btn_CY_PULL_perc_POE_tab4"></span>% of POE) <br /><span class="current_year"></span> Push Outs: <span id="btn_CY_PUSH_tab4"></span> jobs (<span id="btn_CY_PUSH_perc_POE_tab4"></span>% of POE)&nbsp;<i class="fa fa-arrow-right "></i></button>&nbsp;
                                                                    <%--<button type="button" class="btn btn-outline-brand btn-pill" id="Pulls_btn_tab4" onclick="ShowPushPullMap_tab4()"><i class="fa fa-arrow-left "></i>&nbsp;<span class="current_year"></span> Pull In Details (<span id="btn_CY_PULL_tab4"></span> jobs,&nbsp;<span id="btn_CY_PULL_perc_POE_tab4"></span>% of POE) and <br /><span class="current_year"></span> Push Out Details (<span id="btn_CY_PUSH_tab4"></span> jobs,&nbsp;<span id="btn_CY_PUSH_perc_POE_tab4"></span>% of POE)&nbsp;<i class="fa fa-arrow-right "></i></button>&nbsp;--%>
                                                                </div>
                                            ...
                                            <div class="col-lg-6" id="RecentDiv3_tab4">
                                                <div class="row">
                                                    <div class="col-lg-12" id="RecentDiv4_tab4">
                                                        <div style="text-align: center; color: #343a40">
                                                            <h5><span class="ProgramTitle_tab4"></span> - <span class="current_geo"></span>: <span class="current_market"></span> - <span class="current_year"></span> Production Curve</h5>
                                                            ...
                                                            <div id="Quad2_tab4">
                                                                ...
                                                                <button type="button" class="btn btn-primary" id="HidePCTableButton_tab4" onclick="HidePC_Table('_tab4')">Hide Table</button>
                                                                <button type="button" class="btn btn-primary" id="ShowPCTableButton_tab4" onclick="ShowPC_Table('_tab4')">Show Table</button>
                                            ...
                                            <div class="col-lg-6" id="RecentDiv5_tab4">
                                                <div class="row">
                                                    <div class="col-lg-12" id="RecentDiv6_tab4">
                                                        <div id="buttonrowcenterTP2_tab4" style="visibility: visible;">
                                                            <div style="text-align: center; color: #343a40">
                                                                <h5><span class="ProgramTitle_tab4"></span> - <span class="current_geo"></span>: <span class="current_market"></span> - Current and Previous Month Map</h5>
                                                                ...
                                                                <div id="Quad3_tab4">                                                            
                                                                    ...
                                                                    <div id="salesmapdiv_tab4"></div>
                                                                    <br />
                                                                    <div id="Recent_Sales_Detail_tab4">
                                                                        <%--<div id="Sales_Detail_tab42" ></div>--%>
                                                                        <table id="Sales_Detail_tab4" class="table compact" style="width: 100%; height: 100%; font-size: 12px; white-space: nowrap; text-align: center; color: black; visibility: visible">
                                                                            <thead>
                                                                                <tr>
                                                                                    <th bgcolor="#87CEFA">Category</th>
                                                                                    <th bgcolor="#87CEFA">PACE Number</th>
                                                                    ...
                                                                    <button type="button" class="btn btn-primary" id="HideMapTableButton_tab4" onclick="HideMap_Table('_tab4')">Hide Job Details</button>
                                                                    <button type="button" class="btn btn-primary" id="ShowMapTableButton_tab4" onclick="ShowMap_Table('_tab4')">Show Job Details</button>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12" id="RecentDiv8_tab4">
                                                        ...
                                                        <div id="buttonrowcenterTP_tab4" style="visibility: visible;">
                                                            <div style="text-align: center; color: #343a40">
                                                                <h5><span class="ProgramTitle_tab4"></span> - <span class="current_geo"></span>: <span class="current_market"></span> - <span class="current_year"></span> Task Progression</h5>
                                    ...
                                    <div class="tab-pane" id="m_tabs_1_tab5" role="tabpanel">
                                            ...
                                            <div class="col-lg-6" id="RecentDiv_tab5">
                                                <div class="row">
                                                    <div class="col-lg-12" id="RecentDiv2_tab5">
                                                        <div style="text-align: center; color: #343a40">
                                                            <h5><span class="ProgramTitle_tab5"></span> - <span class="current_geo"></span>: <span class="current_market"></span> - <span class="current_year"></span> Production Numbers</h5>
                                                          ...
                                                          <%--  <div id="Quad1_tab5" class="m-section__content" style="height: 200px; width: 100%;">--%>
                                                            <div id="Quad1_tab5">
                                                               ...
                                                               <%-- <div class="m-demo__preview m-demo__preview--btn">                                                                    
                                                                    <button type="button" class="btn btn-primary btn-sm" id="Quad1ShowRows_tab5" onclick="ShowQuad1('_tab5')"> Show All Previous Months </button>
                                                                 </div>--%>
                                                                ...
                                                                <table id="PlanFcstActTable_tab5" class="table compact cell-border" style="width: 100%; height: 100%; font-size: 14px; white-space: nowrap; text-align: center; color: black;">
                                                                    <thead>
                                                                        <tr>
                                                                            <th bgcolor="#87CEFA" style="background-color: lightgreen" title="Click to Show/Hide Additional Months" onclick="ShowQuad1('_tab5')" ><span id="Quad1ShowHide_tab5"></span></th>
                                                                            <th bgcolor="#87CEFA" title="Jobs in POE with On Air Plan date within time range">POE</th>
                                                                            <th bgcolor="#87CEFA" title="Jobs with On Air Forecast date within time range">Forecast</th>
                                                                            <th bgcolor="#87CEFA" title="Jobs with On Air Actual date within time range">Actual</th>
                                                                            <th bgcolor="#87CEFA" title="Actual / POE">Actual % of POE</th>
                                                               ...
                                                               <div id="Quad1BottomTableDiv_tab5" style="overflow-x:auto;">
                                                                <table id="PlanFcstActTable2_tab5" class="table compact cell-border" style="width: 100%; height: 100%; font-size: 14px; white-space: nowrap; text-align: center; color: black; visibility: visible">
                                                                    <thead style="visibility: collapse;">
                                                                        <tr>
                                                                            <th bgcolor="#87CEFA" title=""></th>
                                                                            <th bgcolor="#87CEFA" title="Jobs in POE with On Air Plan date within time range">POE</th>
                                                                ...
                                                                <div class="m-demo__preview m-demo__preview--btn">                                                                    
                                                                    <button type="button" class="btn btn-primary btn-sm" id="Pulls_btn_tab5" onclick="ShowPushPullMap('_tab5')"><i class="fa fa-arrow-left "></i>&nbsp;<span class="current_year"></span> Pull Ins: <span id="btn_CY_PULL_tab5"></span> jobs (<span id="btn_CY_PULL_perc_POE_tab5"></span>% of POE) <br /><span class="current_year"></span> Push Outs: <span id="btn_CY_PUSH_tab5"></span> jobs (<span id="btn_CY_PUSH_perc_POE_tab5"></span>% of POE)&nbsp;<i class="fa fa-arrow-right "></i></button>&nbsp;
                                                                    <%--<button type="button" class="btn btn-outline-brand btn-pill" id="Pulls_btn_tab5" onclick="ShowPushPullMap_tab5()"><i class="fa fa-arrow-left "></i>&nbsp;<span class="current_year"></span> Pull In Details (<span id="btn_CY_PULL_tab5"></span> jobs,&nbsp;<span id="btn_CY_PULL_perc_POE_tab5"></span>% of POE) and <br /><span class="current_year"></span> Push Out Details (<span id="btn_CY_PUSH_tab5"></span> jobs,&nbsp;<span id="btn_CY_PUSH_perc_POE_tab5"></span>% of POE)&nbsp;<i class="fa fa-arrow-right "></i></button>&nbsp;--%>
                                                                </div>
                                            ...
                                            <div class="col-lg-6" id="RecentDiv3_tab5">
                                                <div class="row">
                                                    <div class="col-lg-12" id="RecentDiv4_tab5">
                                                        <div style="text-align: center; color: #343a40">
                                                            <h5><span class="ProgramTitle_tab5"></span> - <span class="current_geo"></span>: <span class="current_market"></span> - <span class="current_year"></span> Production Curve</h5>
                                                            ...
                                                            <div id="Quad2_tab5">
                                                                ...
                                                                <button type="button" class="btn btn-primary" id="HidePCTableButton_tab5" onclick="HidePC_Table('_tab5')">Hide Table</button>
                                                                <button type="button" class="btn btn-primary" id="ShowPCTableButton_tab5" onclick="ShowPC_Table('_tab5')">Show Table</button>
                                            ...
                                            <div class="col-lg-6" id="RecentDiv5_tab5">
                                                <div class="row">
                                                    <div class="col-lg-12" id="RecentDiv6_tab5">
                                                        <div id="buttonrowcenterTP2_tab5" style="visibility: visible;">
                                                            <div style="text-align: center; color: #343a40">
                                                                <h5><span class="ProgramTitle_tab5"></span> - <span class="current_geo"></span>: <span class="current_market"></span> - Current and Previous Month Map</h5>
                                                                ...
                                                                <div id="Quad3_tab5">                                                            
                                                                    ...
                                                                    <div id="salesmapdiv_tab5"></div>
                                                                    <br />
                                                                    <div id="Recent_Sales_Detail_tab5">
                                                                        <%--<div id="Sales_Detail_tab52" ></div>--%>
                                                                        <table id="Sales_Detail_tab5" class="table compact" style="width: 100%; height: 100%; font-size: 12px; white-space: nowrap; text-align: center; color: black; visibility: visible">
                                                                            <thead>
                                                                                <tr>
                                                                                    <th bgcolor="#87CEFA">Category</th>
                                                                                    <th bgcolor="#87CEFA">PACE Number</th>
                                                                    ...
                                                                    <button type="button" class="btn btn-primary" id="HideMapTableButton_tab5" onclick="HideMap_Table('_tab5')">Hide Job Details</button>
                                                                    <button type="button" class="btn btn-primary" id="ShowMapTableButton_tab5" onclick="ShowMap_Table('_tab5')">Show Job Details</button>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12" id="RecentDiv8_tab5">
                                                        ...
                                                        <div id="buttonrowcenterTP_tab5" style="visibility: visible;">
                                                            <div style="text-align: center; color: #343a40">
                                                                <h5><span class="ProgramTitle_tab5"></span> - <span class="current_geo"></span>: <span class="current_market"></span> - <span class="current_year"></span> Task Progression</h5>
    ...
    <script>
        ...
        if (IEDetected == 'No') {
            ...
            ///
            // tabinfo is where we store all the information that is needed for the tabs. We want to only access and change these values. 
            //// Note that tabinfo.length will be one more than the number of tabs
            ...
            tabinfo[4] = {
                ProgramLong: '5G mmWave',
                ProgramShort: '5GmmWave',
                Exists: 1,
                Loaded: 0,
                Active: 0,
                pptp1: '5G mmWave ALL',
            ...
            for (i = 1; i < tabinfo.length; i++) {
                if (tabinfo[i].Exists == 1) {
                    document.getElementById('tabname_tab' + i).innerHTML = tabinfo[i].ProgramLong;
                    var classlist = document.getElementsByClassName('ProgramTitle_tab' + i);
                    for (var j = 0; j < classlist.length; j++) {
                        classlist[j].innerHTML = tabinfo[i].ProgramShort;
                    }
                    
                }
            }
            
            console.log(tabinfo[1]);
            console.log(tabinfo[1].ProgramLong);

            var curmonthspan = 'Jan';       // give curmonthspan global scope and default to Jan
            var curmonthlongspan = 'January';
            var curyearspan = '2020';       // give curyearspan global scope and default to 2020
            var showcolumn = true;          // give showcolumn global scope and default to true
            var executedon = '2020-01-01';  // give curyearspan global scope and default to 1/1/2020
            ...
            $(document).ready(function () {
                ...
                //loop to set up active tabs by making tabs active or not based on the initial tabinfo active and exists settings

                for (i = 1; i < tabinfo.length; i++) {
                    if (tabinfo[i].Exists == 1) {
                        if (tabinfo[i].Active == 1) {
                            var tabpane = document.getElementById("m_tabs_1_tab" + i);
                ...
                //loop to hide the elements initially and show the loading gifs for the active tab
                ...
                for (i = 1; i < tabinfo.length; i++) {
                    if (tabinfo[i].Exists == 1) {
                        ...
                        $('#ShowPCMapButton_tab' + i).hide();  // temp hide of button
                        $('#ShowTaskProgressionChart2Button_tab' + i).hide();  // temp hide of button
                        $('#Quad1_tab' + i).hide();
                        $('#Quad2_tab' + i).hide();
                        $('#Quad3_tab' + i).hide();
                        $('#Quad4_tab' + i).hide();
                        $('#Recent_Sales_Detail_tab' + i).hide();
                        $('#HidePCTableButton_tab' + i).hide();
                        $('#HideMapTableButton_tab' + i).hide();
                        //$('#ShowMapTableButton_tab' + i).hide();  //take out when wanting to show table button
                        $('#HideTaskProgressionChart2Button_tab' + i).hide();
                        $('#ProductionChartTable_tab' + i).hide();
                        $('#TaskProductionChart2_tab' + i).hide();

                        if (tabinfo[i].Active == 1) {
                            $('#LOADING_Quad1_tab' + i).show();
                            $('#LOADING_Quad2_tab' + i).show();
                            $('#LOADING_Quad3_tab' + i).show();
                            $('#LOADING_Quad4_tab' + i).show();
                        }
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "Production_Insights_2020_Testing.aspx/GetDATADATE",
                    data: JSON.stringify({}),
                    dataType: "json",
            ...
            function SubmitButtonClick() {
                ...
                if (geoTypeStored == $('#<%= ddlGeo.ClientID %> option:selected').text()
                    ...
                    for (i = 1; i < tabinfo.length; i++) {
                        if (tabinfo[i].Exists == 1) {
                           ...
                           //reset tabloaded
                            ...
                            //figure out which tab is active during submit
                            if (document.getElementById("m_tabs_1_tab" + i).classList == 'tab-pane show active') {
                                submitButtonActiveTab = i;
                                tabinfo[i].Active = 1;
                            }
                    ...
                    var pptp1Submit = tabinfo[submitButtonActiveTab].pptp1;
                    var pptp2Submit = tabinfo[submitButtonActiveTab].pptp2;
                    var pptp3Submit = tabinfo[submitButtonActiveTab].pptp3;
                    var pptp4Submit = tabinfo[submitButtonActiveTab].pptp4;
                    var pptp5Submit = tabinfo[submitButtonActiveTab].pptp5;
                    var pptpType = tabinfo[submitButtonActiveTab].ProgramShort;
                    ...
                    var selected_month_long = selected_month;
            ...
            function getFilterCriteria(activeTabNumber, pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, pptpType, market, time, market_long) {
                ...
                var activeTabLoaded = tabinfo[activeTabNumber].Loaded;  //grab the loaded status of the active tab
                ...
                for (i = 1; i < tabinfo.length; i++) {
                    if (tabinfo[i].Exists == 1) {
                        console.log('before tab ' + i + ' loaded: ' + tabinfo[i].Loaded);                       
                    }
                }
                ...
                if (activeTabLoaded == 0) {
                    ...
                    //since the data isn't loaded we are going to trigger new data pull, set active tab to loaded
                    ...
                    for (i = 1; i < tabinfo.length; i++) {
                        if (tabinfo[i].Exists == 1) {
                            console.log('after tab ' + i + ' loaded: ' + tabinfo[i].Loaded);
                        }
                    }
            ...
            function mainClickOnce(tabnumber) {
                if (tabinfo[tabnumber].Exists == 1) {
                    $('#tab' + tabnumber).on('click', function (e) {
                        console.log('mainClickOnce_tab' + tabnumber + ' Triggered');
                        getFilterCriteria(tabnumber, tabinfo[tabnumber].pptp1, tabinfo[tabnumber].pptp2, tabinfo[tabnumber].pptp3, tabinfo[tabnumber].pptp4, tabinfo[tabnumber].pptp5, tabinfo[tabnumber].ProgramShort);
                    });
                }
            }

            //can we put the below main click function creations inside a for loop? can we variabalize the function to have it only be one function?
            //function mainClickOnce_tab1() {
            //    $('#tab1').on('click', function (e) {
            //        console.log('mainClickOnce_tab1 Triggered');
            //        getFilterCriteria(1, tabinfo[1].pptp1, tabinfo[1].pptp2, tabinfo[1].pptp3, tabinfo[1].pptp4, tabinfo[1].pptp5, tabinfo[1].ProgramShort);
            //    });
            //}
            ...
            //        getFilterCriteria(2, tabinfo[2].pptp1, tabinfo[2].pptp2, tabinfo[2].pptp3, tabinfo[2].pptp4, tabinfo[2].pptp5, tabinfo[2].ProgramShort);
            //    });
            //}
            ...
            //        getFilterCriteria(3, tabinfo[3].pptp1, tabinfo[3].pptp2, tabinfo[3].pptp3, tabinfo[3].pptp4, tabinfo[3].pptp5, tabinfo[3].ProgramShort);
            //    });
            //}
            ...
            //        getFilterCriteria(4, tabinfo[4].pptp1, tabinfo[4].pptp2, tabinfo[4].pptp3, tabinfo[4].pptp4, tabinfo[4].pptp5, tabinfo[4].ProgramShort);
            //    });
            //}
            ...
            //        getFilterCriteria(5, tabinfo[5].pptp1, tabinfo[5].pptp2, tabinfo[5].pptp3, tabinfo[5].pptp4, tabinfo[5].pptp5, tabinfo[5].ProgramShort);
            //    });
            //}
            ...
            //        getFilterCriteria(6, tabinfo[6].pptp1, tabinfo[6].pptp2, tabinfo[6].pptp3, tabinfo[6].pptp4, tabinfo[6].pptp5, tabinfo[6].ProgramShort);
            //    });
            //}

            //function mainClickOnce_tab7() {
            //    $('#tab7').on('click', function (e) {
            //        console.log('mainClickOnce_tab7 Triggered');
            //        getFilterCriteria(7, tabinfo[7].pptp1, tabinfo[7].pptp2, tabinfo[7].pptp3, tabinfo[7].pptp4, tabinfo[7].pptp5, tabinfo[7].ProgramShort);
            //    });
            //}

            //function mainClickOnce_tab8() {
            //    $('#tab8').on('click', function (e) {
            //        console.log('mainClickOnce_tab8 Triggered');
            //        getFilterCriteria(8, tabinfo[8].pptp1, tabinfo[8].pptp2, tabinfo[8].pptp3, tabinfo[8].pptp4, tabinfo[8].pptp5, tabinfo[8].ProgramShort);
            //    });
            //}
            ...
            function HidePC_Table(tabtext) {
                //tabtext is _tab1 or _tab2 etc
                var tabnumber = tabtext.substring(4);
                //console.log(tabnumber);
                if (tabinfo[tabnumber].Exists == 1) {
                    $('#HidePCTableButton_tab' + tabnumber).hide();
                    $('#ShowPCTableButton_tab' + tabnumber).show();
                    $('#ProductionChartTable_tab' + tabnumber).hide();
                }
            }
            ...
            function ShowPC_Table(tabtext) {
                //tabtext is _tab1 or _tab2 etc
                var tabnumber = tabtext.substring(4);
                //console.log(tabnumber);
                if (tabinfo[tabnumber].Exists == 1) {
                    $('#HidePCTableButton_tab' + tabnumber).show();
                    $('#ShowPCTableButton_tab' + tabnumber).hide();
                    $('#ProductionChartTable_tab' + tabnumber).show();
                }
            }
            ...
            function HideMap_Table(tabtext) {
                //tabtext is _tab1 or _tab2 etc
                var tabnumber = tabtext.substring(4);
                //console.log(tabnumber);
                if (tabinfo[tabnumber].Exists == 1) {
                    $('#HideMapTableButton_tab' + tabnumber).hide();
                    $('#ShowMapTableButton_tab' + tabnumber).show();
                    $('#Recent_Sales_Detail_tab' + tabnumber).hide();     
                }
            }



            function ShowMap_Table(tabtext) {
                //tabtext is _tab1 or _tab2 etc
                var tabnumber = tabtext.substring(4);
                //console.log(tabnumber);
                if (tabinfo[tabnumber].Exists == 1) {
                    $('#HideMapTableButton_tab' + tabnumber).show();
                    $('#ShowMapTableButton_tab' + tabnumber).hide();
                    $('#Recent_Sales_Detail_tab' + tabnumber).show();
                    //$(window).resize();
                    ...
                    //}, 3000);
                    //$('#Sales_Detail_tab' + tabnumber).DataTable().columns.adjust();
                    //$('#Sales_Detail_tab' + tabnumber).DataTable().draw();
                    //$('#Sales_Detail_tab' + tabnumber).DataTable().scroller.measure();
                    $(window).resize();
                }
            ...
            //        //    $($.fn.dataTable.tables(true)).DataTable().columns.adjust();
            //        //}, 3000);
            //        //$('#Sales_Detail_tab1').DataTable().columns.adjust();
            //        //$('#Sales_Detail_tab1').DataTable().draw();
            //        //$('#Sales_Detail_tab1').DataTable().scroller.measure();
            //    $(window).resize();
            //}
            ...
            function ShowPushPullMap(tabtext) {
                //tabtext is _tab1 or _tab2 etc
                var tabnumber = tabtext.substring(4);
                //console.log(tabnumber);
                if (tabinfo[tabnumber].Exists == 1) {
                    Modal3_Click_RYG();
                    //reset the pptp 'ALL' values to '%' for sql purposes
                    if (tabinfo[tabnumber].pptp1 == 'ALL') { var sqlpptp1 = '%'; } else { var sqlpptp1 = tabinfo[tabnumber].pptp1; }
                    if (tabinfo[tabnumber].pptp2 == 'ALL') { var sqlpptp2 = '%'; } else { var sqlpptp2 = tabinfo[tabnumber].pptp2; }
                    if (tabinfo[tabnumber].pptp3 == 'ALL') { var sqlpptp3 = '%'; } else { var sqlpptp3 = tabinfo[tabnumber].pptp3; }
                    if (tabinfo[tabnumber].pptp4 == 'ALL') { var sqlpptp4 = '%'; } else { var sqlpptp4 = tabinfo[tabnumber].pptp4; }
                    if (tabinfo[tabnumber].pptp5 == 'ALL') { var sqlpptp5 = '%'; } else { var sqlpptp5 = tabinfo[tabnumber].pptp5; }

                    updateRYG_Modal3("Month", "ONAIR", "PULL", sqlpptp1, sqlpptp2, sqlpptp3, sqlpptp4, sqlpptp5, tabtext, tabinfo[tabnumber].ProgramShort);
                }
            }
            ...
            function ShowQuad1(tabString) {
                if (document.getElementById('Quad1ShowHide' + tabString).innerHTML == 'Show More') { document.getElementById('Quad1ShowHide' + tabString).innerHTML = 'Show Less'; }
                else if (document.getElementById('Quad1ShowHide' + tabString).innerHTML == 'Show Less') { document.getElementById('Quad1ShowHide' + tabString).innerHTML = 'Show More'; }

                
                $('#Quad1BottomTableDiv' + tabString).toggle();
               //$('#PlanFcstActTable2' + tabString).toggle();
                $(window).resize();
                //console.log('Show Quad 1 Clicked: ' + tabString);
            ...
            function loadDATADATE(data) {
                ...
                if (executedon.substring(5, 6) == 0) {
                    stringmonthnum = executedon.substring(6, 7);
                }

                else {
                    stringmonthnum = executedon.substring(5, 7);
                }
                ...
                curmonthspan = month[stringmonthnum - 1];
                curmonthlongspan = monthlong[stringmonthnum - 1];
                ...
                //should replace thses classes with current_month
                var selectedMonthClasses = document.getElementsByClassName('selected_month');
                for (var i = 0; i < selectedMonthClasses.length; i++) {
                    selectedMonthClasses[i].innerHTML = curmonthspan;
                }
                ...
                console.log("loadDataDate function: " + curmonthspan);
        ...
        <%--function Month_Fake_Click(source, eventArgs) {
            ...
            function updateProductionNumbers(activeTabNumber, pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabCategory) {
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "Production_Insights_2020_Testing.aspx/GetProductionNumbers",
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "Production_Insights_2020_Testing.aspx/GetForecastBar",
                    data: JSON.stringify({ 'groupVariable': groupGeo, 'marketVariable': marketGeo, 'monthVariable': monthSelected, 'pptpOneVariable': pptp_custom_one, 'pptpTwoVariable': pptp_custom_two, 'pptpThreeVariable': pptp_custom_three, 'pptpFourVariable': pptp_custom_four, 'pptpFiveVariable': pptp_custom_five }),
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
            ...
            */
            ...
            function updateSalesChart(activeTabNumber, pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabCategory, market, time, market_long) {
                ...
                //var geturl1 = "Production_Insights_2020_Testing.aspx/Get_Recent_Sales_Detail";
                //var times = 6;
                //var async_request = [];
                //var responses = [];
                ...
                $.when(
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Production_Insights_2020_Testing.aspx/Get_Recent_Sales_Detail_1",
                        data: JSON.stringify({ 'groupVariable': groupGeo, 'marketVariable': marketGeo, 'timeVariable': monthSelected, 'RecentMSVariable': RecentMS, 'pptpOneVariable': pptp_custom_one, 'pptpTwoVariable': pptp_custom_two, 'pptpThreeVariable': pptp_custom_three, 'pptpFourVariable': pptp_custom_four, 'pptpFiveVariable': pptp_custom_five }),
                        dataType: "json",
                        contentType: "application/json; charset=utf-8",
                        success: function (data) {
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Production_Insights_2020_Testing.aspx/Get_Recent_Sales_Detail_2",
                        data: JSON.stringify({ 'groupVariable': groupGeo, 'marketVariable': marketGeo, 'timeVariable': monthSelected, 'RecentMSVariable': RecentMS, 'pptpOneVariable': pptp_custom_one, 'pptpTwoVariable': pptp_custom_two, 'pptpThreeVariable': pptp_custom_three, 'pptpFourVariable': pptp_custom_four, 'pptpFiveVariable': pptp_custom_five }),
                        dataType: "json",
                        contentType: "application/json; charset=utf-8",
                        success: function (data) {
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Production_Insights_2020_Testing.aspx/Get_Recent_Sales_Detail_3",
                        data: JSON.stringify({ 'groupVariable': groupGeo, 'marketVariable': marketGeo, 'timeVariable': monthSelected, 'RecentMSVariable': RecentMS, 'pptpOneVariable': pptp_custom_one, 'pptpTwoVariable': pptp_custom_two, 'pptpThreeVariable': pptp_custom_three, 'pptpFourVariable': pptp_custom_four, 'pptpFiveVariable': pptp_custom_five }),
                        dataType: "json",
                        contentType: "application/json; charset=utf-8",
                        success: function (data) {
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Production_Insights_2020_Testing.aspx/Get_Recent_Sales_Detail_4",
                        data: JSON.stringify({ 'groupVariable': groupGeo, 'marketVariable': marketGeo, 'timeVariable': monthSelected, 'RecentMSVariable': RecentMS, 'pptpOneVariable': pptp_custom_one, 'pptpTwoVariable': pptp_custom_two, 'pptpThreeVariable': pptp_custom_three, 'pptpFourVariable': pptp_custom_four, 'pptpFiveVariable': pptp_custom_five }),
                        dataType: "json",
                        contentType: "application/json; charset=utf-8",
                        success: function (data) {
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Production_Insights_2020_Testing.aspx/Get_Recent_Sales_Detail_5",
                        data: JSON.stringify({ 'groupVariable': groupGeo, 'marketVariable': marketGeo, 'timeVariable': monthSelected, 'RecentMSVariable': RecentMS, 'pptpOneVariable': pptp_custom_one, 'pptpTwoVariable': pptp_custom_two, 'pptpThreeVariable': pptp_custom_three, 'pptpFourVariable': pptp_custom_four, 'pptpFiveVariable': pptp_custom_five }),
                        dataType: "json",
                        contentType: "application/json; charset=utf-8",
                        success: function (data) {
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Production_Insights_2020_Testing.aspx/Get_Recent_Sales_Detail_6",
                        data: JSON.stringify({ 'groupVariable': groupGeo, 'marketVariable': marketGeo, 'timeVariable': monthSelected, 'RecentMSVariable': RecentMS, 'pptpOneVariable': pptp_custom_one, 'pptpTwoVariable': pptp_custom_two, 'pptpThreeVariable': pptp_custom_three, 'pptpFourVariable': pptp_custom_four, 'pptpFiveVariable': pptp_custom_five }),
                        dataType: "json",
                        contentType: "application/json; charset=utf-8",
                        success: function (data) {
            ...
            function loadSalesData(data, market, time, market_long, RecentMS, tabName, tabCategory) {
                ...
                var monthSelected = curmonthlongspan;
                ...
                if (data == '[]') {
                    ...
                    //    var table = new Tabulator("#Sales_Detail_tab12", {
                    //        data: data,
                    //        height: "311px",
                    //        columns: [
                    //            { title: "CATEGORY", field: "CATEGORY" },
                    //            { title: "PACE_NUMBER", field: "PACE_NUMBER" },
                    //            { title: "PACE_NAME_SHORT", field: "PACE_NAME_SHORT" },
                    //            { title: "PROGRAM", field: "PROGRAM" },
                    //            { title: "SUBPROGRAM", field: "SUBPROGRAM" },
                    //            { title: "SUBPROGRAM2", field: "SUBPROGRAM2" },
                    //        ],
                    //    });
            ...
            function salesMap(market, time, market_long, RecentMS, MarketBoundaryData, groupGeo, marketGeo, tabName, tabCategory) {
                ...
                var month_current = monthlong[stringmonthnum - 1];

                var previous_month = "N/A";

                if (stringmonthnum - 2 >= 0) {
                    previous_month = monthlong[stringmonthnum - 2];
                }
                ...
                for (i = 0; i < recentSelectedCount; i++) {
                    ...
                    previousOnAirTable[previousindex] = [];
                    ...
                    else if (previous_month != "N/A") {
                        if ($('#Sales_Detail' + tabName).get(0).lastChild.childNodes[i].childNodes[0].innerHTML == 'PREVIOUS ACTUAL') {

                            for (l = 0; l < recentDetailColCount; l++) {
                                previousOnAirTable[previousindex][l] = $('#Sales_Detail' + tabName).get(0).lastChild.childNodes[i].childNodes[l].innerHTML;
                            }
                ...
                if (previous_month != "N/A") {
                    console.log('previous month not NA: ' + previous_month);
                    if (previousOnAirTable[previousOnAirTable.length - 1].length == 0) {
                        previousOnAirTable.splice(-1, 1);
                    }
                }
                ...
                var series3name = '';
                if (previous_month != "N/A") { series3name = previous_month + ' Actual(' + previousOnAirTable.length + ')';}

                var OApoints = new L.layerGroup();
                var Uppoints = new L.layerGroup();
                if (previous_month != "N/A") { var PApoints = new L.layerGroup(); }
                ...
                if (previous_month != "N/A") {
                    for (i = 0; i < previousOnAirTable.length; i++) {

                        var popup = '<b>On-Air Date:</b> ' + previousOnAirTable[i][22] + ' (Actual)' +
                            '<br/><b>PACE Number:</b> ' + previousOnAirTable[i][1] +
                            '<br/><b>PACE Name:</b> ' + previousOnAirTable[i][28] +
                            '<br/><b>Program:</b> ' + previousOnAirTable[i][3] +
                            '<br/><b>Subprogram:</b> ' + previousOnAirTable[i][4] +
                            '<br/><b>Sales Region:</b> ' + previousOnAirTable[i][8] +
                            '<br/><b>Sales VPGM Market:</b> ' + previousOnAirTable[i][9] +
                            '<br/><b>ACE Region - AVP:</b> ' + previousOnAirTable[i][11] +
                            '<br/><b>ACE Market:</b> ' + previousOnAirTable[i][12] +
                            '<br/><b>ACE Submarket:</b> ' + previousOnAirTable[i][13] +
                            '<br/><b>City, State:</b> ' + previousOnAirTable[i][16] + ', ' + previousOnAirTable[i][14] +
                            '<br/><b>Zip Code:</b> ' + previousOnAirTable[i][17] +
                            '<br/><b>County:</b> ' + previousOnAirTable[i][15] +
                            '<br/><b>Issued Date:</b> ' + previousOnAirTable[i][20] +
                            '<br/><b>' + RecentMS + ' Plan:</b> ' + previousOnAirTable[i][21] +
                            '<br/><b>' + RecentMS + ' Forecast:</b> ' + previousOnAirTable[i][22] +
                            '<br/><b>' + RecentMS + ' Actual:</b> ' + previousOnAirTable[i][23] +
                            '<br/><b>USID:</b> ' + previousOnAirTable[i][24] +
                            '<br/><b>FA Code:</b> ' + previousOnAirTable[i][25] +
                            '<br/><b>Latitude:</b> ' + previousOnAirTable[i][recent_lat_index] +
                            '<br/><b>Longitude:</b> ' + previousOnAirTable[i][recent_long_index],

                            loc = [parseFloat(previousOnAirTable[i][recent_lat_index]), parseFloat(previousOnAirTable[i][recent_long_index])],            //position found
                            previousOnAirTableoptions = {
                                iconShape: 'doughnut',
                                iconSize: [12, 12],
                                borderWidth: 4,
                                borderColor: '#00cc00'
                        ...
                        marker = new L.Marker(new L.latLng(loc), { icon: L.BeautifyIcon.icon(previousOnAirTableoptions) });
                        marker.setOpacity(.7);
                        marker.bindPopup(popup, { 'maxWidth': '250', 'maxHeight': '120' });
                        PApoints.addLayer(marker);
                    }
                }
                ...
                var map = L.map('salesmapid' + tabName, {
                    ...
                    center: [39.73, -104.99],
                    zoom: 10,
                    layers: [streets, Uppoints, OApoints, PApoints],
                ...
                if (previous_month != "N/A") { overlays[series3name] = PApoints; }
                ...
                function getColor(d) {
                    return d === series1name ? "#003300" :
                        d === series2name ? "#0066cc" :
                            d === series3name ? "#00cc00" :
                            "#6bd16b";
                }
                ...
                legend.onAdd = function (map) {
                    ...
                    categories = [series2name, series1name, series3name];
            ...
            function updatePC_Modal(pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, monthSelected, RecentMS, tabCategory) {
                ...
                //var geturl1 = "Production_Insights_2020_Testing.aspx/GetPRODUCTION_CURVE_MODAL";
                //var times = 6;
                //var async_request = [];
                //var responses = [];
                //for (var i = 1; i <= times; i++) {
                ...
                $.when(
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Production_Insights_2020_Testing.aspx/GetPRODUCTION_CURVE_MODAL_1",
                        data: JSON.stringify({ 'groupVariable': groupGeo, 'marketVariable': marketGeo, 'monthVariable': monthSelected, 'pptpOneVariable': pptp_custom_one, 'pptpTwoVariable': pptp_custom_two, 'pptpThreeVariable': pptp_custom_three, 'pptpFourVariable': pptp_custom_four, 'pptpFiveVariable': pptp_custom_five, 'RecentMSVariable': RecentMS }),
                        dataType: "json",
                        contentType: "application/json; charset=utf-8",
                        success: function (data) {
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Production_Insights_2020_Testing.aspx/GetPRODUCTION_CURVE_MODAL_2",
                        data: JSON.stringify({ 'groupVariable': groupGeo, 'marketVariable': marketGeo, 'monthVariable': monthSelected, 'pptpOneVariable': pptp_custom_one, 'pptpTwoVariable': pptp_custom_two, 'pptpThreeVariable': pptp_custom_three, 'pptpFourVariable': pptp_custom_four, 'pptpFiveVariable': pptp_custom_five, 'RecentMSVariable': RecentMS }),
                        dataType: "json",
                        contentType: "application/json; charset=utf-8",
                        success: function (data) {
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Production_Insights_2020_Testing.aspx/GetPRODUCTION_CURVE_MODAL_3",
                        data: JSON.stringify({ 'groupVariable': groupGeo, 'marketVariable': marketGeo, 'monthVariable': monthSelected, 'pptpOneVariable': pptp_custom_one, 'pptpTwoVariable': pptp_custom_two, 'pptpThreeVariable': pptp_custom_three, 'pptpFourVariable': pptp_custom_four, 'pptpFiveVariable': pptp_custom_five, 'RecentMSVariable': RecentMS }),
                        dataType: "json",
                        contentType: "application/json; charset=utf-8",
                        success: function (data) {
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Production_Insights_2020_Testing.aspx/GetPRODUCTION_CURVE_MODAL_4",
                        data: JSON.stringify({ 'groupVariable': groupGeo, 'marketVariable': marketGeo, 'monthVariable': monthSelected, 'pptpOneVariable': pptp_custom_one, 'pptpTwoVariable': pptp_custom_two, 'pptpThreeVariable': pptp_custom_three, 'pptpFourVariable': pptp_custom_four, 'pptpFiveVariable': pptp_custom_five, 'RecentMSVariable': RecentMS }),
                        dataType: "json",
                        contentType: "application/json; charset=utf-8",
                        success: function (data) {
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Production_Insights_2020_Testing.aspx/GetPRODUCTION_CURVE_MODAL_5",
                        data: JSON.stringify({ 'groupVariable': groupGeo, 'marketVariable': marketGeo, 'monthVariable': monthSelected, 'pptpOneVariable': pptp_custom_one, 'pptpTwoVariable': pptp_custom_two, 'pptpThreeVariable': pptp_custom_three, 'pptpFourVariable': pptp_custom_four, 'pptpFiveVariable': pptp_custom_five, 'RecentMSVariable': RecentMS }),
                        dataType: "json",
                        contentType: "application/json; charset=utf-8",
                        success: function (data) {
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Production_Insights_2020_Testing.aspx/GetPRODUCTION_CURVE_MODAL_6",
                        data: JSON.stringify({ 'groupVariable': groupGeo, 'marketVariable': marketGeo, 'monthVariable': monthSelected, 'pptpOneVariable': pptp_custom_one, 'pptpTwoVariable': pptp_custom_two, 'pptpThreeVariable': pptp_custom_three, 'pptpFourVariable': pptp_custom_four, 'pptpFiveVariable': pptp_custom_five, 'RecentMSVariable': RecentMS }),
                        dataType: "json",
                        contentType: "application/json; charset=utf-8",
                        success: function (data) {
            ...
            // ********** RYG MODAL START ********** Modal for Monthly maps from Quad 1
            ...
            function updateRYG_Modal(monthOffset, RecentMS, cellSelected, PlanFcst, pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory) {
                ...
                var stringyearnum = executedon.substring(0, 4);

                if (executedon.substring(5, 6) == 0) {
                    stringmonthnum = executedon.substring(6, 7) - monthOffset;
                }

                else {
                    stringmonthnum = executedon.substring(5, 7) - monthOffset;
                }
                ...
                document.getElementById('Modal_Month_Title').innerHTML = " - " + monthSelected;
                ...
                $.when(
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Production_Insights_2020_Testing.aspx/Get_RYG_Modal",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Production_Insights_2020_Testing.aspx/Get_RYG_Modal_2",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'marketVariable': marketGeo, 'monthVariable': monthSelected, 'MonthNumber': stringmonthnum, 'RecentMSVariable': RecentMS, 'PlanFcstVariable': PlanFcst, 'colSelected': cellSelected,
                            'pptpOneVariable': pptp_custom_one, 'pptpTwoVariable': pptp_custom_two, 'pptpThreeVariable': pptp_custom_three, 'pptpFourVariable': pptp_custom_four, 'pptpFiveVariable': pptp_custom_five
                        }),
            ...
            function recent_RYG_Modal_Map(RecentMS, RecentMStext, RecentGroup, rowSelected, days, monthSelected, stringmonthnum, cellSelected, PlanFcst, MarketBoundaryData, groupGeo, marketGeo, tabName, tabCategory) {
                ...
                var MSSelected = "RECENT " + RecentMS;
                var salesGeo = $('#<%= ddlMarket.ClientID %> option:selected').text();
                var selectedMonthName = monthSelected;
            ...
            // ********** RYG MODAL2 START ********** Modal for Quad 1 when use clicks on Full Year
            ...
            function updateRYG_Modal2(monthSelected, RecentMS, cellSelected, PlanFcst, pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory) {
                ...
                console.log("executedon: " + executedon);
                ...
                if (cellSelected == 'ACT') {
                    ...
                    //var geturl1 = "Production_Insights_2020_Testing.aspx/Get_RYG_Modal2_ACT";
                    //var times = 6;
                    //var async_request = [];
                    //var responses = [];
                    //for (var i = 1; i <= times; i++) {
                    ...
                    $.when(
                        $.ajax({
                            type: "POST",
                            async: true,
                            url: "Production_Insights_2020_Testing.aspx/Get_RYG_Modal2_ACT_1",
                            data: JSON.stringify({ 'groupVariable': groupGeo, 'marketVariable': marketGeo, 'MonthNumber': stringmonthnum, 'RecentMSVariable': RecentMS, 'PlanFcstVariable': PlanFcst, 'pptpOneVariable': pptp_custom_one, 'pptpTwoVariable': pptp_custom_two, 'pptpThreeVariable': pptp_custom_three, 'pptpFourVariable': pptp_custom_four, 'pptpFiveVariable': pptp_custom_five }),
                            dataType: "json",
                            contentType: "application/json; charset=utf-8",
                            success: function (data) {
                        ...
                        $.ajax({
                            type: "POST",
                            async: true,
                            url: "Production_Insights_2020_Testing.aspx/Get_RYG_Modal2_ACT_2",
                            data: JSON.stringify({ 'groupVariable': groupGeo, 'marketVariable': marketGeo, 'MonthNumber': stringmonthnum, 'RecentMSVariable': RecentMS, 'PlanFcstVariable': PlanFcst, 'pptpOneVariable': pptp_custom_one, 'pptpTwoVariable': pptp_custom_two, 'pptpThreeVariable': pptp_custom_three, 'pptpFourVariable': pptp_custom_four, 'pptpFiveVariable': pptp_custom_five }),
                            dataType: "json",
                            contentType: "application/json; charset=utf-8",
                            success: function (data) {
                        ...
                        $.ajax({
                            type: "POST",
                            async: true,
                            url: "Production_Insights_2020_Testing.aspx/Get_RYG_Modal2_ACT_3",
                            data: JSON.stringify({ 'groupVariable': groupGeo, 'marketVariable': marketGeo, 'MonthNumber': stringmonthnum, 'RecentMSVariable': RecentMS, 'PlanFcstVariable': PlanFcst, 'pptpOneVariable': pptp_custom_one, 'pptpTwoVariable': pptp_custom_two, 'pptpThreeVariable': pptp_custom_three, 'pptpFourVariable': pptp_custom_four, 'pptpFiveVariable': pptp_custom_five }),
                            dataType: "json",
                            contentType: "application/json; charset=utf-8",
                            success: function (data) {
                        ...
                        $.ajax({
                            type: "POST",
                            async: true,
                            url: "Production_Insights_2020_Testing.aspx/Get_RYG_Modal2_ACT_4",
                            data: JSON.stringify({ 'groupVariable': groupGeo, 'marketVariable': marketGeo, 'MonthNumber': stringmonthnum, 'RecentMSVariable': RecentMS, 'PlanFcstVariable': PlanFcst, 'pptpOneVariable': pptp_custom_one, 'pptpTwoVariable': pptp_custom_two, 'pptpThreeVariable': pptp_custom_three, 'pptpFourVariable': pptp_custom_four, 'pptpFiveVariable': pptp_custom_five }),
                            dataType: "json",
                            contentType: "application/json; charset=utf-8",
                            success: function (data) {
                        ...
                        $.ajax({
                            type: "POST",
                            async: true,
                            url: "Production_Insights_2020_Testing.aspx/Get_RYG_Modal2_ACT_5",
                            data: JSON.stringify({ 'groupVariable': groupGeo, 'marketVariable': marketGeo, 'MonthNumber': stringmonthnum, 'RecentMSVariable': RecentMS, 'PlanFcstVariable': PlanFcst, 'pptpOneVariable': pptp_custom_one, 'pptpTwoVariable': pptp_custom_two, 'pptpThreeVariable': pptp_custom_three, 'pptpFourVariable': pptp_custom_four, 'pptpFiveVariable': pptp_custom_five }),
                            dataType: "json",
                            contentType: "application/json; charset=utf-8",
                            success: function (data) {
                        ...
                        $.ajax({
                            type: "POST",
                            async: true,
                            url: "Production_Insights_2020_Testing.aspx/Get_RYG_Modal2_ACT_6",
                            data: JSON.stringify({ 'groupVariable': groupGeo, 'marketVariable': marketGeo, 'MonthNumber': stringmonthnum, 'RecentMSVariable': RecentMS, 'PlanFcstVariable': PlanFcst, 'pptpOneVariable': pptp_custom_one, 'pptpTwoVariable': pptp_custom_two, 'pptpThreeVariable': pptp_custom_three, 'pptpFourVariable': pptp_custom_four, 'pptpFiveVariable': pptp_custom_five }),
                            dataType: "json",
                            contentType: "application/json; charset=utf-8",
                            success: function (data) {
                    ...
                    //var geturl1 = "Production_Insights_2020_Testing.aspx/Get_RYG_Modal2";
                    //var times = 6;
                    //var async_request = [];
                    //var responses = [];
                    //for (var i = 1; i <= times; i++) {
                    ...
                    $.when(
                        $.ajax({
                            type: "POST",
                            async: true,
                            url: "Production_Insights_2020_Testing.aspx/Get_RYG_Modal2_1",
                            data: JSON.stringify({ 'groupVariable': groupGeo, 'marketVariable': marketGeo, 'MonthNumber': stringmonthnum, 'RecentMSVariable': RecentMS, 'PlanFcstVariable': PlanFcst, 'pptpOneVariable': pptp_custom_one, 'pptpTwoVariable': pptp_custom_two, 'pptpThreeVariable': pptp_custom_three, 'pptpFourVariable': pptp_custom_four, 'pptpFiveVariable': pptp_custom_five }),
                            dataType: "json",
                            contentType: "application/json; charset=utf-8",
                            success: function (data) {
                        ...
                        $.ajax({
                            type: "POST",
                            async: true,
                            url: "Production_Insights_2020_Testing.aspx/Get_RYG_Modal2_2",
                            data: JSON.stringify({ 'groupVariable': groupGeo, 'marketVariable': marketGeo, 'MonthNumber': stringmonthnum, 'RecentMSVariable': RecentMS, 'PlanFcstVariable': PlanFcst, 'pptpOneVariable': pptp_custom_one, 'pptpTwoVariable': pptp_custom_two, 'pptpThreeVariable': pptp_custom_three, 'pptpFourVariable': pptp_custom_four, 'pptpFiveVariable': pptp_custom_five }),
                            dataType: "json",
                            contentType: "application/json; charset=utf-8",
                            success: function (data) {
                        ...
                        $.ajax({
                            type: "POST",
                            async: true,
                            url: "Production_Insights_2020_Testing.aspx/Get_RYG_Modal2_3",
                            data: JSON.stringify({ 'groupVariable': groupGeo, 'marketVariable': marketGeo, 'MonthNumber': stringmonthnum, 'RecentMSVariable': RecentMS, 'PlanFcstVariable': PlanFcst, 'pptpOneVariable': pptp_custom_one, 'pptpTwoVariable': pptp_custom_two, 'pptpThreeVariable': pptp_custom_three, 'pptpFourVariable': pptp_custom_four, 'pptpFiveVariable': pptp_custom_five }),
                            dataType: "json",
                            contentType: "application/json; charset=utf-8",
                            success: function (data) {
                        ...
                        $.ajax({
                            type: "POST",
                            async: true,
                            url: "Production_Insights_2020_Testing.aspx/Get_RYG_Modal2_4",
                            data: JSON.stringify({ 'groupVariable': groupGeo, 'marketVariable': marketGeo, 'MonthNumber': stringmonthnum, 'RecentMSVariable': RecentMS, 'PlanFcstVariable': PlanFcst, 'pptpOneVariable': pptp_custom_one, 'pptpTwoVariable': pptp_custom_two, 'pptpThreeVariable': pptp_custom_three, 'pptpFourVariable': pptp_custom_four, 'pptpFiveVariable': pptp_custom_five }),
                            dataType: "json",
                            contentType: "application/json; charset=utf-8",
                            success: function (data) {
                        ...
                        $.ajax({
                            type: "POST",
                            async: true,
                            url: "Production_Insights_2020_Testing.aspx/Get_RYG_Modal2_5",
                            data: JSON.stringify({ 'groupVariable': groupGeo, 'marketVariable': marketGeo, 'MonthNumber': stringmonthnum, 'RecentMSVariable': RecentMS, 'PlanFcstVariable': PlanFcst, 'pptpOneVariable': pptp_custom_one, 'pptpTwoVariable': pptp_custom_two, 'pptpThreeVariable': pptp_custom_three, 'pptpFourVariable': pptp_custom_four, 'pptpFiveVariable': pptp_custom_five }),
                            dataType: "json",
                            contentType: "application/json; charset=utf-8",
                            success: function (data) {
                        ...
                        $.ajax({
                            type: "POST",
                            async: true,
                            url: "Production_Insights_2020_Testing.aspx/Get_RYG_Modal2_6",
                            data: JSON.stringify({ 'groupVariable': groupGeo, 'marketVariable': marketGeo, 'MonthNumber': stringmonthnum, 'RecentMSVariable': RecentMS, 'PlanFcstVariable': PlanFcst, 'pptpOneVariable': pptp_custom_one, 'pptpTwoVariable': pptp_custom_two, 'pptpThreeVariable': pptp_custom_three, 'pptpFourVariable': pptp_custom_four, 'pptpFiveVariable': pptp_custom_five }),
                            dataType: "json",
                            contentType: "application/json; charset=utf-8",
                            success: function (data) {
            ...
            function updateRYG_Modal3(monthSelected, RecentMS, cellSelected, pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory) {
               ...
               <%-- var monthSelected = $('#<%= ddlMonth.ClientID %> option:selected').val();--%>
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "Production_Insights_2020_Testing.aspx/Get_RYG_Modal3",  //use a function from C# , change this for different data return
            ...
            function recent_RYG_Modal3_Map(RecentMS, RecentMStext, RecentGroup, rowSelected, monthSelected, stringmonthnum, cellSelected, MarketBoundaryData, groupGeo, marketGeo, tabName, tabCategory) {
                ...
                function getColor(d) {
                    return d === '2020 Pull Ins Complete (' + RYG3PullActTable.length + ')' ? "#aa00ff" :
                        d === '2020 Pull Ins Forecast (' + RYG3PullFcstTable.length + ')' ? "#cc66ff" :
                            d === '2020 Push Outs (' + RYG3PushTable.length + ')' ? "#ffb366" :
                                "#ff7f00";
                }
                ...
                legend.onAdd = function (map) {
                    ...
                    categories = ['2020 Pull Ins Complete (' + RYG3PullActTable.length + ')', '2020 Pull Ins Forecast (' + RYG3PullFcstTable.length + ')', '2020 Push Outs (' + RYG3PushTable.length + ')'];
            ...
            var monthSelected = $('#<%= ddlMonth.ClientID %> option:selected').val();--%>
               ...
               <%-- var monthSelected = $('#<%= ddlMonth.ClientID %> option:selected').val();--%>
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "Production_Insights_2020_Testing.aspx/GetTASK_PRODUCTION_CHART",
                    data: JSON.stringify({ 'groupVariable': groupGeo, 'marketVariable': marketGeo, 'monthVariable': monthSelected, 'pptpOneVariable': pptp_custom_one, 'pptpTwoVariable': pptp_custom_two, 'pptpThreeVariable': pptp_custom_three, 'pptpFourVariable': pptp_custom_four, 'pptpFiveVariable': pptp_custom_five }),
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
            ...
            function updateProductionCurve(activeTabNumber, pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabCategory, chartDiv, chartTitle, chartSubtitle, SVNum) {
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "Production_Insights_2020_Testing.aspx/GetPRODUCTION_CHART",
                    data: JSON.stringify({ 'groupVariable': groupGeo, 'marketVariable': marketGeo, 'monthVariable': monthSelected, 'pptpOneVariable': pptp_custom_one, 'pptpTwoVariable': pptp_custom_two, 'pptpThreeVariable': pptp_custom_three, 'pptpFourVariable': pptp_custom_four, 'pptpFiveVariable': pptp_custom_five }),
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "Production_Insights_2020_Testing.aspx/GetPRODUCTION_CHART_TABLE", //v5 updated
                    data: JSON.stringify({ 'groupVariable': groupGeo, 'marketVariable': marketGeo, 'monthVariable': monthSelected, 'pptpOneVariable': pptp_custom_one, 'pptpTwoVariable': pptp_custom_two, 'pptpThreeVariable': pptp_custom_three, 'pptpFourVariable': pptp_custom_four, 'pptpFiveVariable': pptp_custom_five }),
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "Production_Insights_2020_Testing.aspx/GetQuad1", //v5 updated
                    ...
                    success: function (data) {
                       <%-- var pulldown_month = $('#<%= ddlMonth.ClientID %> option:selected').text();--%>
                        var pulldown_month = curmonthlongspan;
            ...
            function loadQuad1_Month(PC_data, month, pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory) {
                ...
                // Create two data tables off of the one set of PC_data. A top table which has Year, Current Month, and Current Month -1, and a bottom table which has all older previous months in the year (CM -2 etc)

                var topTableData = [];
                var bottomTableData = [];

                var NumberOfRows = PC_data.length;

                document.getElementById('Quad1ShowHide' + tabName).innerHTML = 'Show More';

                for (var i = 0; i < PC_data.length; i++) {

                    if (PC_data[i]["TABLE_PLAN"] == 0) {

                        PC_data[i].ACT_PER_OF_POE = "-";

                    }

                    else {
                        PC_data[i].ACT_PER_OF_POE = ((PC_data[i]["TABLE_ACTUAL"] / PC_data[i]["TABLE_PLAN"]) * 100).toFixed(0) + "%";
                    }
                ...
                for (var i = 0; i < 3; i++) {
                     topTableData[i] = {
                         MONTHTEXT: PC_data[i]["MONTHTEXT"],
                         TABLE_PLAN: PC_data[i]["TABLE_PLAN"],
                         TABLE_FORECAST: PC_data[i]["TABLE_FORECAST"],
                         TABLE_ACTUAL: PC_data[i]["TABLE_ACTUAL"],
                         ACT_PER_OF_POE: PC_data[i]["ACT_PER_OF_POE"]
                    };
                }


                for (var i = 0; i < PC_data.length - 3; i++) {
                     bottomTableData[i] = {
                        MONTHTEXT: PC_data[i + 3]["MONTHTEXT"],
                         TABLE_PLAN: PC_data[i + 3]["TABLE_PLAN"],
                         TABLE_FORECAST: PC_data[i + 3]["TABLE_FORECAST"],
                         TABLE_ACTUAL: PC_data[i + 3]["TABLE_ACTUAL"],
                         ACT_PER_OF_POE: PC_data[i + 3]["ACT_PER_OF_POE"]
                    };
                }
                ...
                //bottom table
                $('#PlanFcstActTable2' + tabName).dataTable().fnDestroy();
                $.fn.dataTable.moment('MM-DD-YYYY');
                $('#PlanFcstActTable2' + tabName).DataTable({ //build new table
                    orderCellsTop: false,
                    fixedHeader: false,
                    paging: false,
                    sort: false,
                ...
                //User clicks on the Year counts, top row of Quad 1 Table
                ...
                //User clicks on the Current Month counts
                $('#PlanFcstActTable' + tabName + ' tr td:eq(6)').off().on('click', function () {
                    Modal_Click_RYG();
                    updateRYG_Modal(0, "ONAIR", "PLAN", "PLAN", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                });
                $('#PlanFcstActTable' + tabName + ' tr td:eq(7)').off().on('click', function () {
                    Modal_Click_RYG();
                    updateRYG_Modal(0, "ONAIR", "FCST", "FORECAST", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                });
                $('#PlanFcstActTable' + tabName + ' tr td:eq(8)').off().on('click', function () {
                    Modal_Click_RYG();
                    updateRYG_Modal(0, "ONAIR", "ACT", "FORECAST", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                });
                ...
                //User clicks on the Previous Month counts

                if (NumberOfRows >= 3) {

                    $('#PlanFcstActTable' + tabName + ' tr td:eq(11)').off().on('click', function () {
                        Modal_Click_RYG();
                        updateRYG_Modal(1, "ONAIR", "PLAN", "PLAN", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                    });
                    $('#PlanFcstActTable' + tabName + ' tr td:eq(12)').off().on('click', function () {
                        Modal_Click_RYG();
                        updateRYG_Modal(1, "ONAIR", "FCST", "FORECAST", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                    });
                    $('#PlanFcstActTable' + tabName + ' tr td:eq(13)').off().on('click', function () {
                        Modal_Click_RYG();
                        updateRYG_Modal(1, "ONAIR", "ACT", "FORECAST", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                    });


                    $('#PlanFcstActTable' + tabName + ' tr td:eq(11)').hover(function () {
                        $(this).addClass('DT_highlight DT_pointer');
                    }, function () {
                        $(this).removeClass('DT_highlight DT_pointer');
                    }
                    );
                    $('#PlanFcstActTable' + tabName + ' tr td:eq(12)').hover(function () {
                        $(this).addClass('DT_highlight DT_pointer');
                    }, function () {
                        $(this).removeClass('DT_highlight DT_pointer');
                    }
                    );
                    $('#PlanFcstActTable' + tabName + ' tr td:eq(13)').hover(function () {
                        $(this).addClass('DT_highlight DT_pointer');
                    }, function () {
                        $(this).removeClass('DT_highlight DT_pointer');
                    }
                ...
                //First row in bottom table, aka CM - 2
                if (NumberOfRows >= 4) {
                    //Modal triggers on click
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(1)').off().on('click', function () {
                        Modal_Click_RYG();
                        updateRYG_Modal(2, "ONAIR", "PLAN", "PLAN", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                    });
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(2)').off().on('click', function () {
                        Modal_Click_RYG();
                        updateRYG_Modal(2, "ONAIR", "FCST", "FORECAST", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                    });
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(3)').off().on('click', function () {
                        Modal_Click_RYG();
                        updateRYG_Modal(2, "ONAIR", "ACT", "FORECAST", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                    });


                    //Make the button change style on hover
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(1)').hover(function () {
                        $(this).addClass('DT_highlight DT_pointer');
                    }, function () {
                        $(this).removeClass('DT_highlight DT_pointer');
                    }
                    );
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(2)').hover(function () {
                        $(this).addClass('DT_highlight DT_pointer');
                    }, function () {
                        $(this).removeClass('DT_highlight DT_pointer');
                    }
                    );
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(3)').hover(function () {
                        $(this).addClass('DT_highlight DT_pointer');
                    }, function () {
                        $(this).removeClass('DT_highlight DT_pointer');
                    }
                ...
                if (NumberOfRows >= 5) {
                    ...
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(6)').off().on('click', function () {
                        Modal_Click_RYG();
                        updateRYG_Modal(3, "ONAIR", "PLAN", "PLAN", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                    });
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(7)').off().on('click', function () {
                        Modal_Click_RYG();
                        updateRYG_Modal(3, "ONAIR", "FCST", "FORECAST", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                    });
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(8)').off().on('click', function () {
                        Modal_Click_RYG();
                        updateRYG_Modal(3, "ONAIR", "ACT", "FORECAST", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                    });


                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(6)').hover(function () {
                        $(this).addClass('DT_highlight DT_pointer');
                    }, function () {
                        $(this).removeClass('DT_highlight DT_pointer');
                    }
                    );
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(7)').hover(function () {
                        $(this).addClass('DT_highlight DT_pointer');
                    }, function () {
                        $(this).removeClass('DT_highlight DT_pointer');
                    }
                    );
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(8)').hover(function () {
                        $(this).addClass('DT_highlight DT_pointer');
                    }, function () {
                        $(this).removeClass('DT_highlight DT_pointer');
                    }
                ...
                if (NumberOfRows >= 6) {
                    ...
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(11)').off().on('click', function () {
                        Modal_Click_RYG();
                        updateRYG_Modal(4, "ONAIR", "PLAN", "PLAN", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                    });
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(12)').off().on('click', function () {
                        Modal_Click_RYG();
                        updateRYG_Modal(4, "ONAIR", "FCST", "FORECAST", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                    });
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(13)').off().on('click', function () {
                        Modal_Click_RYG();
                        updateRYG_Modal(4, "ONAIR", "ACT", "FORECAST", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                    });


                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(11)').hover(function () {
                        $(this).addClass('DT_highlight DT_pointer');
                    }, function () {
                        $(this).removeClass('DT_highlight DT_pointer');
                    }
                    );
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(12)').hover(function () {
                        $(this).addClass('DT_highlight DT_pointer');
                    }, function () {
                        $(this).removeClass('DT_highlight DT_pointer');
                    }
                    );
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(13)').hover(function () {
                        $(this).addClass('DT_highlight DT_pointer');
                    }, function () {
                        $(this).removeClass('DT_highlight DT_pointer');
                    }
                ...
                if (NumberOfRows >= 7) {
                    ...
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(16)').off().on('click', function () {
                        Modal_Click_RYG();
                        updateRYG_Modal(5, "ONAIR", "PLAN", "PLAN", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                    });
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(17)').off().on('click', function () {
                        Modal_Click_RYG();
                        updateRYG_Modal(5, "ONAIR", "FCST", "FORECAST", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                    });
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(18)').off().on('click', function () {
                        Modal_Click_RYG();
                        updateRYG_Modal(5, "ONAIR", "ACT", "FORECAST", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                    });


                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(16)').hover(function () {
                        $(this).addClass('DT_highlight DT_pointer');
                    }, function () {
                        $(this).removeClass('DT_highlight DT_pointer');
                    }
                    );
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(17)').hover(function () {
                        $(this).addClass('DT_highlight DT_pointer');
                    }, function () {
                        $(this).removeClass('DT_highlight DT_pointer');
                    }
                    );
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(18)').hover(function () {
                        $(this).addClass('DT_highlight DT_pointer');
                    }, function () {
                        $(this).removeClass('DT_highlight DT_pointer');
                    }
                ...
                if (NumberOfRows >= 8) {
                    ...
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(21)').off().on('click', function () {
                        Modal_Click_RYG();
                        updateRYG_Modal(6, "ONAIR", "PLAN", "PLAN", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                    });
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(22)').off().on('click', function () {
                        Modal_Click_RYG();
                        updateRYG_Modal(6, "ONAIR", "FCST", "FORECAST", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                    });
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(23)').off().on('click', function () {
                        Modal_Click_RYG();
                        updateRYG_Modal(6, "ONAIR", "ACT", "FORECAST", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                    });


                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(21)').hover(function () {
                        $(this).addClass('DT_highlight DT_pointer');
                    }, function () {
                        $(this).removeClass('DT_highlight DT_pointer');
                    }
                    );
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(22)').hover(function () {
                        $(this).addClass('DT_highlight DT_pointer');
                    }, function () {
                        $(this).removeClass('DT_highlight DT_pointer');
                    }
                    );
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(23)').hover(function () {
                        $(this).addClass('DT_highlight DT_pointer');
                    }, function () {
                        $(this).removeClass('DT_highlight DT_pointer');
                    }
                ...
                if (NumberOfRows >= 9) {
                    ...
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(26)').off().on('click', function () {
                        Modal_Click_RYG();
                        updateRYG_Modal(7, "ONAIR", "PLAN", "PLAN", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                    });
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(27)').off().on('click', function () {
                        Modal_Click_RYG();
                        updateRYG_Modal(7, "ONAIR", "FCST", "FORECAST", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                    });
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(28)').off().on('click', function () {
                        Modal_Click_RYG();
                        updateRYG_Modal(7, "ONAIR", "ACT", "FORECAST", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                    });


                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(26)').hover(function () {
                        $(this).addClass('DT_highlight DT_pointer');
                    }, function () {
                        $(this).removeClass('DT_highlight DT_pointer');
                    }
                    );
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(27)').hover(function () {
                        $(this).addClass('DT_highlight DT_pointer');
                    }, function () {
                        $(this).removeClass('DT_highlight DT_pointer');
                    }
                    );
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(28)').hover(function () {
                        $(this).addClass('DT_highlight DT_pointer');
                    }, function () {
                        $(this).removeClass('DT_highlight DT_pointer');
                    }
                ...
                if (NumberOfRows >= 10) {
                    ...
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(31)').off().on('click', function () {
                        Modal_Click_RYG();
                        updateRYG_Modal(8, "ONAIR", "PLAN", "PLAN", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                    });
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(32)').off().on('click', function () {
                        Modal_Click_RYG();
                        updateRYG_Modal(8, "ONAIR", "FCST", "FORECAST", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                    });
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(33)').off().on('click', function () {
                        Modal_Click_RYG();
                        updateRYG_Modal(8, "ONAIR", "ACT", "FORECAST", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                    });


                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(31)').hover(function () {
                        $(this).addClass('DT_highlight DT_pointer');
                    }, function () {
                        $(this).removeClass('DT_highlight DT_pointer');
                    }
                    );
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(32)').hover(function () {
                        $(this).addClass('DT_highlight DT_pointer');
                    }, function () {
                        $(this).removeClass('DT_highlight DT_pointer');
                    }
                    );
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(33)').hover(function () {
                        $(this).addClass('DT_highlight DT_pointer');
                    }, function () {
                        $(this).removeClass('DT_highlight DT_pointer');
                    }
                ...
                if (NumberOfRows >= 11) {
                    ...
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(36)').off().on('click', function () {
                        Modal_Click_RYG();
                        updateRYG_Modal(9, "ONAIR", "PLAN", "PLAN", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                    });
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(37)').off().on('click', function () {
                        Modal_Click_RYG();
                        updateRYG_Modal(9, "ONAIR", "FCST", "FORECAST", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                    });
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(38)').off().on('click', function () {
                        Modal_Click_RYG();
                        updateRYG_Modal(9, "ONAIR", "ACT", "FORECAST", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                    });


                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(36)').hover(function () {
                        $(this).addClass('DT_highlight DT_pointer');
                    }, function () {
                        $(this).removeClass('DT_highlight DT_pointer');
                    }
                    );
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(37)').hover(function () {
                        $(this).addClass('DT_highlight DT_pointer');
                    }, function () {
                        $(this).removeClass('DT_highlight DT_pointer');
                    }
                    );
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(38)').hover(function () {
                        $(this).addClass('DT_highlight DT_pointer');
                    }, function () {
                        $(this).removeClass('DT_highlight DT_pointer');
                    }
                ...
                if (NumberOfRows >= 12) {
                    ...
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(41)').off().on('click', function () {
                        Modal_Click_RYG();
                        updateRYG_Modal(10, "ONAIR", "PLAN", "PLAN", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                    });
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(42)').off().on('click', function () {
                        Modal_Click_RYG();
                        updateRYG_Modal(10, "ONAIR", "FCST", "FORECAST", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                    });
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(43)').off().on('click', function () {
                        Modal_Click_RYG();
                        updateRYG_Modal(10, "ONAIR", "ACT", "FORECAST", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                    });


                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(41)').hover(function () {
                        $(this).addClass('DT_highlight DT_pointer');
                    }, function () {
                        $(this).removeClass('DT_highlight DT_pointer');
                    }
                    );
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(42)').hover(function () {
                        $(this).addClass('DT_highlight DT_pointer');
                    }, function () {
                        $(this).removeClass('DT_highlight DT_pointer');
                    }
                    );
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(43)').hover(function () {
                        $(this).addClass('DT_highlight DT_pointer');
                    }, function () {
                        $(this).removeClass('DT_highlight DT_pointer');
                    }
                ...
                if (NumberOfRows >= 13) {
                    ...
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(46)').off().on('click', function () {
                        Modal_Click_RYG();
                        updateRYG_Modal(11, "ONAIR", "PLAN", "PLAN", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                    });
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(47)').off().on('click', function () {
                        Modal_Click_RYG();
                        updateRYG_Modal(11, "ONAIR", "FCST", "FORECAST", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                    });
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(48)').off().on('click', function () {
                        Modal_Click_RYG();
                        updateRYG_Modal(11, "ONAIR", "ACT", "FORECAST", pptp_custom_one, pptp_custom_two, pptp_custom_three, pptp_custom_four, pptp_custom_five, tabName, tabCategory);
                    });


                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(46)').hover(function () {
                        $(this).addClass('DT_highlight DT_pointer');
                    }, function () {
                        $(this).removeClass('DT_highlight DT_pointer');
                    }
                    );
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(47)').hover(function () {
                        $(this).addClass('DT_highlight DT_pointer');
                    }, function () {
                        $(this).removeClass('DT_highlight DT_pointer');
                    }
                    );
                    $('#PlanFcstActTable2' + tabName + ' tr td:eq(48)').hover(function () {
                        $(this).addClass('DT_highlight DT_pointer');
                    }, function () {
                        $(this).removeClass('DT_highlight DT_pointer');
                    }
                ...
                $('#Quad1BottomTableDiv' + tabName).hide();
                document.getElementById('Quad1ShowHide' + tabName).innerHTML = 'Show More';
