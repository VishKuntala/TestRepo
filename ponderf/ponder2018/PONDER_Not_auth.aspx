<%@ Page Title="PONDER - User Not Authorized" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="PONDER_Not_auth.aspx.cs" Inherits="About" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2><%: Title %>.</h2>
    <h3>You are not authorized to view the page requested.</h3>
    <p>If you feel you need access to this page, please email PONDER admin support at the link below. Thank you.</p>
	<br />
	<br />
	<div class="row">
											...
											<div class="kt-iconbox__body">
												...
												<div class="kt-iconbox__desc">
													...
													<div class="kt-iconbox__content">
														Email support - Please include the page you are trying to access and the business reason why you need access. Blank requests will be denied.
													</div>
												</div>
											</div>
										</div>
