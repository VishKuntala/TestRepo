<%@ Page Title="Webphone Dashboard" Language="C#" MasterPageFile="~/MasterPageWebphone.master" AutoEventWireup="true" CodeFile="webphone_dashboard.aspx.cs" Inherits="_webphone_dashboard" %>
        ...
        <div class="mr-auto">            
            ...
            <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                ...
                <li class="m-nav__item">
                    <a href="/webphone/webphone_dashboard.aspx" class="m-nav__link">
    ...
    <script>
        ...
        function attachClickHandlers() {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "webphone_dashboard.aspx/GetCURRYEAR",
                data: JSON.stringify({}),
                dataType: "json",
        ...
        function Getmarketdata(market) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "webphone_dashboard.aspx/GetDATADATE",
                data: JSON.stringify({}),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
