...
public partial class _Default_OLD : System.Web.UI.Page
{
    ...
    public static string GetSearchAll(string name)
    {
        string sql = @"SELECT DISTINCT TO_CHAR(PONDER.PLAN_BASE.USID) AS USID, PONDER.PLAN_BASE.FA_CODE, PONDER.PLAN_BASE.SITE_NAME, PONDER.PLAN_BASE.JOB_NUMBER, PONDER.PLAN_BASE.STATUS AS IPLAN_STATUS, 
            ...
            PONDER.PLAN_BASE.REGION, PONDER.PLAN_BASE.IPLAN_RAN_MARKET AS MARKET, PONDER.PACE_POE.SUBMARKET, PONDER.PLAN_BASE.ADDRESS, PONDER.PLAN_BASE.CITY, PONDER.PLAN_BASE.ZIP, PONDER.PACE_POE.ORACLE_PTN
...
";
    ...
    [WebMethod]
    public static string GetPREV_YR_ALLIN(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')-1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
TO_CHAR(IPLAN_ORIGINAL_ISSUED_DATE, 'MM-DD-YYYY') AS ISSUED_DATE, TO_CHAR(CURRENT_NEED_BY_DATE, 'MM-DD-YYYY') AS CURRENT_NEED_BY_DATE,
TO_CHAR(ONAIR_PLAN, 'MM-DD-YYYY') AS ONAIR_PLAN,
TO_CHAR(ONAIR_FORECAST, 'MM-DD-YYYY') AS ONAIR_FORECAST,
TO_CHAR(ONAIR_ACTUAL, 'MM-DD-YYYY') AS ONAIR_ACTUAL,
...
";
    ...
    [WebMethod]
    public static string GetPREV_YR_ALLIN_2(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')-1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetPREV_YR_ALLIN_3(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')-1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetPREV_YR_ALLIN_4(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')-1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetPREV_YR_ALLIN_5(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')-1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetPREV_YR_ALLIN_6(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')-1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetPREV_YR_ALLIN_7(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')-1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetPREV_YR_ALLIN_8(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')-1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetPREV_YR_ALLIN_9(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')-1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetPREV_YR_ALLIN_10(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')-1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetPREV_YR_ALLIN_11(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')-1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetPREV_YR_ALLIN_12(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')-1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetPREV_YR_ALLIN_13(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')-1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetPREV_YR_ALLIN_14(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')-1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetPREV_YR_ALLIN_15(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')-1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetPREV_YR_ALLIN_16(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')-1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetPREV_YR_ALLIN_17(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')-1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetPREV_YR_ALLIN_18(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')-1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetPREV_YR_ALLIN_19(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')-1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetPREV_YR_ALLIN_20(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')-1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS1_ALLIN(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS1_ALLIN_2(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS1_ALLIN_3(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS1_ALLIN_4(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS1_ALLIN_5(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS1_ALLIN_6(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS1_ALLIN_7(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS1_ALLIN_8(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS1_ALLIN_9(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS1_ALLIN_10(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS1_ALLIN_11(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS1_ALLIN_12(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS1_ALLIN_13(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS1_ALLIN_14(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS1_ALLIN_15(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS1_ALLIN_16(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS1_ALLIN_17(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS1_ALLIN_18(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS1_ALLIN_19(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS1_ALLIN_20(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+1 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS2_ALLIN(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+2 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
TO_CHAR(IPLAN_ORIGINAL_ISSUED_DATE, 'MM-DD-YYYY') AS ISSUED_DATE, TO_CHAR(CURRENT_NEED_BY_DATE, 'MM-DD-YYYY') AS CURRENT_NEED_BY_DATE,
TO_CHAR(ONAIR_PLAN, 'MM-DD-YYYY') AS ONAIR_PLAN,
TO_CHAR(ONAIR_FORECAST, 'MM-DD-YYYY') AS ONAIR_FORECAST,
TO_CHAR(ONAIR_ACTUAL, 'MM-DD-YYYY') AS ONAIR_ACTUAL,
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS2_ALLIN_2(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+2 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS2_ALLIN_3(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+2 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS2_ALLIN_4(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+2 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS2_ALLIN_5(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+2 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS2_ALLIN_6(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+2 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS2_ALLIN_7(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+2 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS2_ALLIN_8(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+2 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS2_ALLIN_9(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+2 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS2_ALLIN_10(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+2 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS2_ALLIN_11(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+2 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS2_ALLIN_12(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+2 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS2_ALLIN_13(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+2 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS2_ALLIN_14(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+2 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS2_ALLIN_15(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+2 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS3_ALLIN(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+3 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
TO_CHAR(IPLAN_ORIGINAL_ISSUED_DATE, 'MM-DD-YYYY') AS ISSUED_DATE, TO_CHAR(CURRENT_NEED_BY_DATE, 'MM-DD-YYYY') AS CURRENT_NEED_BY_DATE,
TO_CHAR(ONAIR_PLAN, 'MM-DD-YYYY') AS ONAIR_PLAN,
TO_CHAR(ONAIR_FORECAST, 'MM-DD-YYYY') AS ONAIR_FORECAST,
TO_CHAR(ONAIR_ACTUAL, 'MM-DD-YYYY') AS ONAIR_ACTUAL,
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS3_ALLIN_2(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+3 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS3_ALLIN_3(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+3 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS3_ALLIN_4(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+3 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS3_ALLIN_5(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+3 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS3_ALLIN_6(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+3 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS3_ALLIN_7(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+3 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS3_ALLIN_8(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+3 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS3_ALLIN_9(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+3 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    [WebMethod]
    public static string GetCUR_YR_PLUS3_ALLIN_10(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * FROM (
SELECT PACE_NUMBER, PACE_NAME, STATUS, CE_CUSTOM_ONE AS PROGRAM, TO_CHAR(SYSDATE, 'YYYY')+3 AS FORECAST_YEAR, SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
...
";
    ...
    public static string GetProject_AllIn(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * 
            FROM PONDER.MKT_DRILL_ALLIN_V4 
            WHERE CE_CUSTOM_ONE = 'ALL' AND CE_CUSTOM_TWO = 'ALL' 
            AND (RAN_REGION = '" + marketVariable + @"' OR RAN_MARKET = '" + marketVariable + @"')
            AND RAN_SUBMARKET = 'ALL'                
            AND RAN_MARKET = (CASE WHEN RAN_MARKET = 'ALL' THEN RAN_SUBMARKET
                WHEN RAN_REGION != RAN_MARKET AND RAN_MARKET = '" + marketVariable + @"' AND RAN_SUBMARKET = 'ALL' THEN RAN_MARKET END)
            ORDER BY ALLIN DESC";
    ...
    public static string GetProject_AllIn_FA(string marketVariable)
    {
        //Construction Started
        string sql = @"SELECT * 
            FROM PONDER.MKT_DRILL_ALLIN_FA_V4 
            WHERE CE_CUSTOM_ONE = 'ALL' AND CE_CUSTOM_TWO = 'ALL' 
            AND (RAN_REGION = '" + marketVariable + @"' OR RAN_MARKET = '" + marketVariable + @"')
            AND RAN_SUBMARKET = 'ALL'                
            AND RAN_MARKET = (CASE WHEN RAN_MARKET = 'ALL' THEN RAN_SUBMARKET
    ...
    {
        //Construction Started
        string sql = @"SELECT * FROM PONDER.MARKET_DRILL_CHART_V4 
            WHERE PROJECT = 'ALL_IN_JOBS' 
            AND (RAN_REGION = '" + marketVariable + @"' OR RAN_MARKET = '" + marketVariable + @"')
            AND RAN_MARKET = (CASE WHEN RAN_REGION = '" + marketVariable + @"' AND RAN_MARKET = 'ALL' THEN RAN_MARKET
                WHEN RAN_MARKET = '" + marketVariable + @"' AND RAN_REGION != RAN_MARKET THEN RAN_MARKET END)
    ...
    public static string GetDashboardMARKET(string marketVariable)
    {
        ...
        string sql = @"SELECT t1.* FROM            
            (SELECT i.*, CASE WHEN i.RAN_SUBMARKET = 'ALL' AND i.RAN_MARKET = 'ALL' THEN i.RAN_REGION
              WHEN i.RAN_SUBMARKET = 'ALL' AND i.RAN_MARKET != 'ALL' THEN i.RAN_MARKET
              ELSE i.RAN_SUBMARKET END AS SUBMARKET2
            FROM PONDER.MKT_DASH_SUBMARKET_V4 i
            WHERE i.PLANYEAR = TO_CHAR(sysdate, 'YYYY')+0
            AND (RAN_REGION = '" + marketVariable + @"' OR RAN_MARKET = '" + marketVariable + @"')        
              AND RAN_SUBMARKET = (CASE WHEN RAN_REGION = '" + marketVariable + @"' AND RAN_MARKET != 'ALL' AND RAN_SUBMARKET = 'ALL' THEN RAN_SUBMARKET
                WHEN RAN_REGION = '" + marketVariable + @"' AND RAN_MARKET = 'ALL' THEN RAN_SUBMARKET
                WHEN RAN_REGION = RAN_MARKET AND RAN_SUBMARKET != 'ALL' THEN RAN_SUBMARKET
                WHEN RAN_REGION != RAN_MARKET AND RAN_MARKET = '" + marketVariable + @"' THEN RAN_SUBMARKET END)
            ORDER BY N_TO_S, RAN_SUBMARKET)t1
            WHERE ROWNUM <= (CASE WHEN RAN_REGION = 'LOS ANGELES' THEN 1 
            WHEN RAN_REGION = 'NORTHERN CALIFORNIA' THEN 3 
            WHEN RAN_MARKET = 'PUERTO RICO' AND RAN_SUBMARKET = 'PUERTO RICO' THEN 1 
            WHEN RAN_MARKET = 'HAWAII' AND RAN_SUBMARKET = 'HAWAII' THEN 1 ELSE 20 END)";
    ...
    public static string GetDashboardMARKET_2(string marketVariable)
    {
        ...
        string sql = @"SELECT t1.* FROM            
            (SELECT i.*, CASE WHEN i.RAN_SUBMARKET = 'ALL' AND i.RAN_MARKET = 'ALL' THEN i.RAN_REGION
              WHEN i.RAN_SUBMARKET = 'ALL' AND i.RAN_MARKET != 'ALL' THEN i.RAN_MARKET
              ELSE i.RAN_SUBMARKET END AS SUBMARKET2
            FROM PONDER.MKT_DASH_SUBMARKET2_V4 i
            WHERE i.PLANYEAR = TO_CHAR(sysdate, 'YYYY')+0
            AND (RAN_REGION = '" + marketVariable + @"' OR RAN_MARKET = '" + marketVariable + @"')        
              AND RAN_SUBMARKET = (CASE WHEN RAN_REGION = '" + marketVariable + @"' AND RAN_MARKET != 'ALL' AND RAN_SUBMARKET = 'ALL' THEN RAN_SUBMARKET
                WHEN RAN_REGION = '" + marketVariable + @"' AND RAN_MARKET = 'ALL' THEN RAN_SUBMARKET
    ...
    {
        //Construction Started
        string sql = @"SELECT * FROM PONDER.DASH_DONUT_V4 WHERE PLANYEAR = TO_CHAR(sysdate, 'YYYY')+0 
    ...
    {
        //Construction Started
        string sql = @"SELECT * FROM PONDER.DASH_DONUT_V4 WHERE PLANYEAR = TO_CHAR(sysdate, 'YYYY')+1 
                AND CE_CUSTOM_ONE = 'NSB ALL' AND CE_CUSTOM_TWO = 'ALL' 
                AND (RAN_REGION = '" + marketVariable + @"' OR RAN_MARKET = '" + marketVariable + @"')
                AND RAN_SUBMARKET = 'ALL'                
                AND RAN_MARKET = (CASE WHEN RAN_MARKET = 'ALL' THEN RAN_SUBMARKET
    ...
    {
        //Construction Started
        string sql = @"SELECT * FROM PONDER.DASH_DONUT_V4 WHERE PLANYEAR = TO_CHAR(sysdate, 'YYYY')+2 
                AND CE_CUSTOM_ONE = 'NSB ALL' AND CE_CUSTOM_TWO = 'ALL' 
                AND (RAN_REGION = '" + marketVariable + @"' OR RAN_MARKET = '" + marketVariable + @"')
                AND RAN_SUBMARKET = 'ALL'                
                AND RAN_MARKET = (CASE WHEN RAN_MARKET = 'ALL' THEN RAN_SUBMARKET
    ...
    {
        //Construction Started
        string sql = @"SELECT * FROM PONDER.DASH_DONUT_V4 WHERE PLANYEAR = TO_CHAR(sysdate, 'YYYY')+3 
                AND CE_CUSTOM_ONE = 'NSB ALL' AND CE_CUSTOM_TWO = 'ALL' 
                AND (RAN_REGION = '" + marketVariable + @"' OR RAN_MARKET = '" + marketVariable + @"')
                AND RAN_SUBMARKET = 'ALL'                
                AND RAN_MARKET = (CASE WHEN RAN_MARKET = 'ALL' THEN RAN_SUBMARKET
    ...
    public void ExportToExcel_prevyr(object sender, EventArgs e)
    {
        if (ddlMarket.SelectedItem.Value == "ALL")
        {
            ...
            SOURCE_JOB_NUMBER, RAN_REGION, MARKET, SUBMARKET, LATITUDE, LONGITUDE, PRODUCT_GROUP, PRODUCT_SUBGROUP, NATIONAL_PROGRAM, USID, FA_LOCATION_CODE, 
            TO_CHAR(IPLAN_ORIGINAL_ISSUED_DATE, 'MM-DD-YYYY') AS ISSUED_DATE, TO_CHAR(CURRENT_NEED_BY_DATE, 'MM-DD-YYYY') AS CURRENT_NEED_BY_DATE,
            TO_CHAR(ONAIR_PLAN, 'MM-DD-YYYY') AS ONAIR_PLAN,
            TO_CHAR(ONAIR_FORECAST, 'MM-DD-YYYY') AS ONAIR_FORECAST,
            TO_CHAR(ONAIR_ACTUAL, 'MM-DD-YYYY') AS ONAIR_ACTUAL,
        ...
        else
        {
            ...
            WHERE STATUS IN ('Active', 'Complete')
                AND TO_CHAR(ONAIR_ACTUAL, 'YYYY') = TO_CHAR(SYSDATE, 'YYYY')-1
                AND (RAN_REGION = '" + ddlMarket.SelectedItem.Value + @"' OR MARKET = '" + ddlMarket.SelectedItem.Value + @"')
            ORDER BY FA_LOCATION_CODE)";
