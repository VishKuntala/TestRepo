<%@ Page Title="CR Dashboard Overview" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Default - Copy.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="d-flex align-items-center">
        <div class="mr-auto">
            <h3 class="m-subheader__title m-subheader__title--separator">RAN Central Region 2018 Capital Plan
            </h3>
                                ...
                                <div class="m-portlet__body">
                                    ...
                                    <div class="row" id="titlerow1" style="height: 35%; width: 100%; overflow: auto; display: flex;">
                                        ...
                                        <div class="col-md-2" id="ALLIN_1" style="text-align: center; color: black">
                                            <button type="button" class="btn btn-primary" id="ALLIN" data-toggle="modal" data-target="#myModal">
                                            </button>
                                        </div>
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <h6 class="m-subheader__title m-subheader__title--separator">Total Projects Issued: <span id="MODAL_ALLIN"></span></h6>
                            <h6 class="m-subheader__title m-subheader__title--separator">Bandwidth Expansion: <span id="MODAL_BWESW"></span></h6>
                            Line 3
    ...
    <script>
        ...
        function loadProject_AllIn(data) {
            ...
            var value = score[0]["ALLIN"];
            document.getElementById('MODAL_ALLIN').innerHTML = value;
            var value = score[0]["BWESW"];
            document.getElementById('MODAL_BWESW').innerHTML = value;
        }
    ...
    $('#container').highcharts({
        ...
        /* sunburst1 chart data */

        function loadSunburst1(data) {
            var data = JSON.parse(data.d); //parse your data  
            var sb_chart_title = "Project Breakdown";

            sunburstcharting101('Sunburst1', data, sb_chart_title); //call my chart building function
        }

        /* SUNBURST CHART CREATER */
        function sunburstcharting101(container, data, sb_chart_title) {
            ...
            $(function () {              
                ...
                Highcharts.chart(container, { //define the Highchart
                    ...
                    tooltip: {
                        headerFormat: "",
                        pointFormat: 'The count of <b>{point.name}</b> jobs is <b>{point.value}</b>'
                    }
