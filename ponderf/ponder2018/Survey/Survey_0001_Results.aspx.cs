...
public partial class _Survey_0001_Results : System.Web.UI.Page
{
    ...
    [WebMethod]
    public static string GetQuestion1Results(string geoVariable)
    {
        if (geoVariable == "ALL")
        {
            string sql = @"SELECT DISTINCT RESPONSE1, COUNT(*)
                FROM PONDER.SURVEY_0001_TABLE
                GROUP BY RESPONSE1";
    ...
    [WebMethod]
    public static string GetQuestion2Results(string geoVariable)
    {
        if (geoVariable == "ALL")
        {
            string sql = @"SELECT DISTINCT RESPONSE2, COUNT(*)
                FROM PONDER.SURVEY_0001_TABLE
                GROUP BY RESPONSE2";
