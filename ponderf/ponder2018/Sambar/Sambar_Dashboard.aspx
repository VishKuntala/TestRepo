<%@ Page Title="Sambar Dashboard" Language="C#" MasterPageFile="~/MasterPageSambar.master" AutoEventWireup="true" CodeFile="Sambar_Dashboard.aspx.cs" Inherits="Sambar_Sambar_Dashboard" %>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12" id="RecentDiv2">
                                                        <div style="text-align: center; color: #343a40">
                                                            <h5>NSB Green Yellow Red Score Card Quadrant - SAMPLE</h5>
                                                            ...
                                                            <div id="NSB_div2" class="m-section__content" style="height: 200px; width: 100%;">
                                                                ...
                                                                <table id="NSB_Table3" class="table compact cell-border" style="width: 100%; height: 100%; font-size: 12px; white-space: nowrap; text-align: center; color: black;">
                                                                    <thead>
                                                                        <tr>
                                            ...
                                            <div class="col-lg-6" id="RecentDiv3">
                                                <div class="row">
                                                    <div class="col-lg-12" id="RecentDiv4">
                                                        <div style="text-align: center; color: #343a40">
                                                            <h5>NSB Production Curve Quadrant - SAMPLE</h5>
                                            ...
                                            <div class="col-lg-6" id="RecentDiv5">
                                                <div class="row">
                                                    <div class="col-lg-12" id="RecentDiv6">
                                                        <div style="text-align: center; color: #343a40">
                                                            <h5>NSB Daily Forecast History/Accuracy Quadrant - SAMPLE</h5>
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div id="histCountShow">
                                                                    ...
                                                                    <table id="NSB_HistCountSummary" class="table compact cell-border" style="width: 100%; height: 100%; font-size: 14px; white-space: nowrap; text-align: center; color: black;">
                                                                    <thead>
                                                                        <tr>                                                                            
                                                                            <th bgcolor="#87CEFA" > Month</th>
                                                                            <th bgcolor="#87CEFA" > Actual</th>
                                                                            <th bgcolor="#87CEFA" > F1 Forecast</th>
                                                                            <th bgcolor="#87CEFA" > F1 Accuracy</th>
                                                                            <th bgcolor="#87CEFA" > F2 Forecast</th>
                                                                            <th bgcolor="#87CEFA" > F2 Accuracy</th>
                                            ...
                                            <div class="col-lg-6" id="RecentDiv7">
                                                <div class="row">
                                                    <div class="col-lg-12" id="RecentDiv8">
                                                        <div style="text-align: center; color: #343a40">
                                                            <h5>NSB Recent and Upcoming Map Quadrant - SAMPLE</h5>
                                            ...
                                            <div class="col-lg-6" id="RecentDiv_CRAN">
                                                <div class="row">
                                                    <div class="col-lg-12" id="RecentDiv2_CRAN">
                                                        <div style="text-align: center; color: #343a40">
                                                            <h2>CRAN Green Yellow Red Score Card Quadrant - SAMPLE</h2>
                                                            Place Content Here
                                                            <br />
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-lg-6" id="RecentDiv3_CRAN">
                                                <div class="row">
                                                    <div class="col-lg-12" id="RecentDiv4_CRAN">
                                                        <div style="text-align: center; color: #343a40">
                                                            <h2>CRAN Production Curve Quadrant - SAMPLE</h2>
                                                            Place Content Here
                                                            <br />
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-lg-6" id="RecentDiv5_CRAN">
                                                <div class="row">
                                                    <div class="col-lg-12" id="RecentDiv6_CRAN">
                                                        <div style="text-align: center; color: #343a40">
                                                            <h2>CRAN Daily Forecast History Quadrant - SAMPLE</h2>
                                                            Place Content Here
                                                            <br />
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12" id="RecentDiv8_CRAN">
                                                        ...
                                                        <div id="salesmapShow_CRAN">
                                                            <div style="text-align: center; color: #343a40">
                                                                <h2>CRAN Recent and Upcoming Map Quadrant - SAMPLE</h2>
                                                                <br />
                                            ...
                                            <div class="col-lg-6" id="RecentDiv_MMW">
                                                <div class="row">
                                                    <div class="col-lg-12" id="RecentDiv2_MMW">
                                                        <div style="text-align: center; color: #343a40">
                                                            <h2>mmWave Green Yellow Red Score Card Quadrant - SAMPLE</h2>
                                                            Place Content Here
                                                            <br />
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-lg-6" id="RecentDiv3_MMW">
                                                <div class="row">
                                                    <div class="col-lg-12" id="RecentDiv4_MMW">
                                                        <div style="text-align: center; color: #343a40">
                                                            <h2>mmWave Production Curve Quadrant - SAMPLE</h2>
                                                            Place Content Here
                                                            <br />
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-lg-6" id="RecentDiv5_MMW">
                                                <div class="row">
                                                    <div class="col-lg-12" id="RecentDiv6_MMW">
                                                        <div style="text-align: center; color: #343a40">
                                                            <h2>mmWave Daily Forecast History Quadrant - SAMPLE</h2>
                                                            Place Content Here
                                                            <br />
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12" id="RecentDiv8_MMW">
                                                        <div id="salesmapShow_MMW">
                                                            <div style="text-align: center; color: #343a40">
                                                                <h2>mmWave Recent and Upcoming Map Quadrant - SAMPLE</h2>
                                                                <br />
                        ...
                        <div class="row" id="DisplayInfoRow_RYG">
                            ...
                            <div class="col-md-8" id="RYG_InfoCol1_2">
                                <div id="recentRYG_ModalDetailSection1">
                                    ...
                                    <div id="RYG_Modal_mapdiv" style="height: 350px;"></div>
    ...
    <script>
        ...
        function updateHistCountchart() {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Sambar_Dashboard.aspx/Get_HistCountSummary",  //use a function from C# , change this for different data return
        ...
        function loadHistCountSummary(data) {
            ...
            for (var i = 0; i < executedonmonthnum; i++) {
                historytable[i] = new Array(6);
                historytable[i][0] = month[i];
                historytable[i][1] = data[0]['ACT_' + month[i]];
                historytable[i][2] = data[0]['LOCK_' + month[i] + '_FCST'];
                historytable[i][3] = (100 * data[0]['ACT_' + month[i]] / data[0]['LOCK_' + month[i] + '_FCST']).toFixed(0) + '%';
                historytable[i][4] = data[0]['BEGINNING_' + month[i] + '_FCST'];
                historytable[i][5] = (100 * data[0]['ACT_' + month[i]] / data[0]['BEGINNING_' + month[i] + '_FCST']).toFixed(0) + '%';
            }

            historytable[0][4] = '-'; //get rid of F2 for January
            historytable[0][5] = '-';
            historytable[executedonmonthnum - 1][1] += ' (so far)'; // add the so far onto the end of current month actuals
            historytable[executedonmonthnum - 1][3] = '-'; // get rid of percentage calculation for current month
            historytable[executedonmonthnum - 1][5] = '-';

            if (executedondaynum < 5) {
                historytable[executedonmonthnum][4] = '-'; // if you are before the 5th day of the month, dont show F2
            }
            ...
            if (data.length <= 0) {
                ...
                $('#NSB_HistCountSummary').DataTable({ //build new table
                    ...
                    dom: 'Bfrtip',
                    buttons: [{ extend: 'csv', title: 'NSB_Export' }, { extend: 'excelHtml5', title: 'NSB_Export' }],
                    columnDefs: [{ width: '16.7%', targets: [0, 1, 2, 3, 4, 5] }],
        ...
        function loadHistCountStock(data, data2, container, columnname) {
            ...
            if (monthselected != "Jan") {
                fcstFlagDate = Date.UTC(2020, stringmonthnum - 1, 5);
        ...
        */
        ...
        function loadQuad1_Month(PC_data) {
            ...
            $('#NSB_Table3').DataTable({ //build new table
                ...
                rowCallback: function (row, data, index) {
                    ...
                    if (data['PROJECTS_ONAIR_ACTUAL'] / data['PROJECTS_PLAN_ONAIR'] >= 1) {
                        $(row).find('td:eq(4)').css('background', 'LightGreen');
                    }
                    else if (data['PROJECTS_ONAIR_ACTUAL'] / data['PROJECTS_PLAN_ONAIR'] < .8) {
                        $(row).find('td:eq(4)').css('background', 'LightCoral');
                    }
                    else {
                        $(row).find('td:eq(4)').css('background', 'Khaki');
                    }
            ...
            $('#NSB_Table3 tr td:eq(0)').off().on('click', function () {
                Modal_Click_RYG();
                updateRYG_Modal("Month", "ONAIR");
                console.log("click");
            });
            ...
            $('#NSB_Table3 tr td:eq(0)').hover(function () {
                    $(this).addClass('DT_highlight DT_pointer');
                }, function () {
                    $(this).removeClass('DT_highlight DT_pointer');
                }
        ...
        function updateRYG_Modal(monthSelected, RecentMS) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Sambar_Dashboard.aspx/Get_RYG_Modal",  //use a function from C# , change this for different data return
                data: JSON.stringify({ 'geoVariable': salesGeo, 'monthVariable': monthSelected, 'RecentMSVariable': RecentMS }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
                    load_RYG_Modal_Detail(data, RecentMS, RecentMStext, RecentGroup, rowSelected, days, monthSelected); //function in frontpage below, 
                },
                error: function (data) {
        ...
        function load_RYG_Modal_Detail(data, RecentMS, RecentMStext, RecentGroup, rowSelected, days, monthSelected) {  // Recent and Upcoming Detail after user clicks on a row
            ...
            if (data.length <= 0) {
                ...
                $('#RYG_Modal_Recent_Detail').DataTable({ //build new table                
                    ...
                    buttons: [{ extend: 'csv', title: 'RecentDetail_Export' }, { extend: 'excel', title: 'RecentDetail_Export' }, {
                        ...
                        titleAttr: 'Update Map to apply the filters from the bottom of the table below',
                        action: function (e, dt, node, config) {
                            recent_RYG_Modal_Map(RecentMS, RecentMStext, RecentGroup, rowSelected, days, DATE1, DATE2, DATE3, DATE4, monthSelected);
                        }
                    }],
                    //columnDefs: [{ visible: false, targets: 8 }],
                    columns: [ //define columns, you can hard code them like this, or build them dynamically with a loop based on your parsed JSON data
        ...
        function recent_RYG_Modal_Map(RecentMS, RecentMStext, RecentGroup, rowSelected, days, days1, days2, days3, days4, monthSelected) {
            ...
            document.getElementById('RYG_Modal_mapcounttitle').innerHTML = salesGeo + ' Production Curve NSB Map';
            document.getElementById('RYG_Modal_mapcountsubtitle').innerHTML = monthSelectedtext + ' Actual and Remaining Forecasted';
            ...
            document.getElementById('RYG_Modal_mapcountfooter').innerHTML = 'Job Count: ' + recentSelectedCount + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Unique Lat/Long Pairs: ' + latlongdistinctcount + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' + NaNcountMessage;
            ...
            document.getElementById('RYG_Modal_mapdiv').innerHTML = "<div id='RYG_Modal_mapid' style='height: 350px;'></div>";
