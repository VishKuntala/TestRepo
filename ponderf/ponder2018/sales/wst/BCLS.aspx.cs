...
public partial class sales_scoring_BCLS : System.Web.UI.Page
    {
        ...
        private static string BuildWhereClause(string vpgm, string archetype, string dmaName, string zipcode, string indoorCovScore, string fiveg,
             ...
             string popDensity, string medIncome, string hypergig)
        {
            string sql = "1=1";
     ...
     string valueColumn, string nameColumn, string sortColumn, string sortDirection = "ASC")
        {
            ...
            if (string.IsNullOrEmpty(searchString))
            {
                ...
                sql = sql + BuildWhereClause(vpgm, archetype, dmaName, zipcode, indoorCovScore, fiveg, band14, awbCapText, awbSpecEff, attRankGws, gponStatus, attOoklaQ, tmoRatioOokla, vznRatioOokla, popDensity, medIncome, hypergig);
            }
            else
            {
        ...
        [WebMethod]
        public static List<Dictionary<string, object>> TableData(string vpgm, string archetype, string dmaName, string zipcode, string indoorCovScore, string fiveg,
            string band14, string awbCapText, string awbSpecEff, string attRankGws, string gponStatus, string attOoklaQ, string tmoRatioOokla, string vznRatioOokla,
            string popDensity, string medIncome, string hypergig,
            string sortCriteria, string limit, string sortDirection, bool buildSortColumns)
        {

            string sql = @"SELECT ROWNUM, A.* FROM(SELECT VPGM, ARCHETYPE, DMA_NM, MIKEY, SIMPLE_COVERAGE_SCORE, FIVEG, BAND_14, AWB_CAPACITY_TEXT,
            ...
            sql = sql + BuildWhereClause(vpgm, archetype, dmaName, zipcode, indoorCovScore, fiveg, band14, awbCapText, awbSpecEff, attRankGws,
                    gponStatus, attOoklaQ, tmoRatioOokla, vznRatioOokla, popDensity, medIncome, hypergig);
        ...
        [WebMethod]
        public static List<Dictionary<string, object>> MapData(string vpgm, string archetype, string dmaName, string zipcode, string indoorCovScore, string fiveg,
            string band14, string awbCapText, string awbSpecEff, string attRankGws, string gponStatus, string attOoklaQ, string tmoRatioOokla, string vznRatioOokla,
            string popDensity, string medIncome, string hypergig,
        ...
        [WebMethod]
        public static List<Dictionary<string, object>> ChartData(string vpgm, string archetype, string dmaName, string zipcode, string indoorCovScore, string fiveg,
            string band14, string awbCapText, string awbSpecEff, string attRankGws, string gponStatus, string attOoklaQ, string tmoRatioOokla, string vznRatioOokla,
            string popDensity, string medIncome, string hypergig,
            string sortCriteria, string limit, string attribute)
        {
        ...
        {
            string sql = @"SELECT VPGM, ARCHETYPE, DMA_NM, MIKEY, SIMPLE_COVERAGE_SCORE, FIVEG, BAND_14, AWB_CAPACITY_TEXT,
                AWB_SPECTRUM_EFFICIENCY, GPON_STATUS, GPON_CUSTOMERS, HYPERGIG, ATT_RANK_GWS, TMO_RANK_GWS, VZ_RANK_GWS, ATT_OOKLA_QUANTILE, TMO_RATIO_OOKLA_LTE, VERIZON_RATIO_OOKLA_LTE,
                POP_DENSITY_TEXT, HH_MEDIAN_INCOME_TEXT, ADDR, CITY, ST, ZIP, CONTACT_FIRST_NM, CONTACT_LAST_NM, CONTACT_PHONE1, LATITUDE, LONGITUDE
