...
export const wirelessPenColors = ['#ffe6cc', '#ffff99', '#b3d9ff', '#b3ffb3'];
export const wirelessPenMax = [.1, 30, 40, 100];
const wirelessPenDataKey = 'wireless_percentage';
...
export const heatmapConfig = Object.freeze({
    [CONSTANTS.HEATMAP_WIRELESS_PENETRATION]: {
        name: 'Wireless Penetration',
        filters: [
            { color: wirelessPenColors[0], heading: 'No Wireless', max: wirelessPenMax[0]  },
            { color: wirelessPenColors[1], heading: '<30% Wireless', max: wirelessPenMax[1] },
            { color: wirelessPenColors[2], heading: '30-40% Wireless', max: wirelessPenMax[2] },
            { color: wirelessPenColors[3], heading: '>40% Wireless'}
        ],
        dataKey: wirelessPenDataKey,
        fillColorExpression: [
            'step',
            ['get', wirelessPenDataKey],
            wirelessPenColors[0], 
            wirelessPenMax[0], wirelessPenColors[1], 
            wirelessPenMax[1], wirelessPenColors[2], 
            wirelessPenMax[2], wirelessPenColors[3]
        ],
        fillOpacityExpression: [
            'case', ['==', ['get', wirelessPenDataKey], 0],
            0,
            0.5
        ],
    ...
    [CONSTANTS.HEATMAP_FIBER_PENETRATION]: {
        ...
        fillColorExpression: [
            ...
            ['get', fiberPenDataKey],
            fiberPenColors[0], 
            fiberPenMax[0], fiberPenColors[1], 
            fiberPenMax[1], fiberPenColors[2], 
            fiberPenMax[2], fiberPenColors[3]
        ],
        fillOpacityExpression: [
    ...
    [CONSTANTS.HEATMAP_WIRELESS_SCORING]: {
        ...
        fillColorExpression: [
            ...
            wirelessScoringMax[0], wirelessScoringColors[1], 
            wirelessScoringMax[1], wirelessScoringColors[2], 
            wirelessScoringMax[2], wirelessScoringColors[3]
        ],
        fillOpacityExpression: [
    ...
    [CONSTANTS.HEATMAP_NONE]: {
        ...
        fillColorExpression: [
            ...
            aveCoverageScoreColors[0], 
            aveCoverageScoreMax[0], aveCoverageScoreColors[1], 
            aveCoverageScoreMax[1], aveCoverageScoreColors[2], 
            aveCoverageScoreMax[2], aveCoverageScoreColors[3], 
            aveCoverageScoreMax[3], aveCoverageScoreColors[4], 
            aveCoverageScoreMax[4], aveCoverageScoreColors[5]
        ],
        fillOpacityExpression: [
    ...
    [CONSTANTS.HEATMAP_LOCATION_DENSITY]: {
        ...
        fillColorExpression: [
            ...
            locationDensityColors[0], 
            locationDensityMax[0], locationDensityColors[1], 
            locationDensityMax[1], locationDensityColors[2], 
            locationDensityMax[2], locationDensityColors[3]
        ],
        fillOpacityExpression: [
            'case', ['==', ['get', locationDensityDataKey], 0],
            0,
            0.55
        ],
        fillOpacityHoverExpression: [
