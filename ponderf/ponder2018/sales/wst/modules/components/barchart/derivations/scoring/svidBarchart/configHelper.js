const config = {
    ...
    fiber_status_report_rows_id: {
        ...
        "NEARFIBER1000ft(NotLit)": {
            name: 'NEAR FIBER 1,000ft (Not Lit)', color: '#e6b800', dbLabel: 'NEAR FIBER 1,000ft (Not Lit)'
        },
        "GPONSERVINGAREA(NotLit)": {
            name: 'GPON SERVING AREA (Not Lit)', color: '#ffff00', dbLabel: 'GPON SERVING AREA (Not Lit)'
        },
        "FIBERTHERE(NotLit)": {
            name: 'FIBER THERE (Not Lit)', color: '#33ff33', dbLabel: 'FIBERTHERE(NotLit)'
        },
        "GPONLIT": {
            name: 'GPON LIT', color: '#00ff00', dbLabel: 'GPON LIT'
        },
        "SINGLECUSTOMERNTECELLLEGACY": {
            name: 'SINGLE CUSTOMER NTE/CELL/LEGACY', color: '#00cc00', dbLabel: 'SINGLE CUSTOMER NTE/CELL/LEGACY'
        },
        "MULTICUSTOMERNTE": {
            name: 'MULTI CUSTOMER NTE', color: '#006600', dbLabel: 'MULTI CUSTOMER NTE'
        },
        "EMT": {
            name: 'EMT', color: '#003300', dbLabel: 'EMT'
        },
