...
const top25PSAPointLayer = ({ instance, beforeLayerId }) => {
    ...
    const markerClicked = async event => {
        ...
        try {
            const { data } = await instance.getData(
                `${store.baseApiUrl}/point/top25psas/${properties.zip_co_psa}`,
            );
            ...
            popup.setHTML(
                `
                  <div style="text-align: center">
                   ...
                   <br/><b>Indoor Coverage Score:</b> ${popUpData.market_rank}
                   <br/><b>Fiber Locations:</b> ${popUpData.fiber_available}
                   <br/><b>Fiber Customers:</b> ${popUpData.fiber_customers} (${popUpData.fiber_penetration})
