...
const fibCustAddressLayer = ({ instance, beforeLayerId }) => {
    ...
    const {
        ...
        imgUrl,        
        minShapeSize        
    } = pointsLayers.ATT_FIBER_CUSTOMERS;

    map.loadImage(`${store.rootUrl}sales/opportunity/${imgUrl}`, function (error, image) {
        if (error) throw error;

        map.addImage("fibCustAddressIcon", image, { sdf: true });
            ...
            popup.setHTML(
                `
                  <div style="text-align: center">                   
                   ...
                   <br/><div style = "align:center"></div><a href="#" class="fibCustAddressLayerPSAFilterLink">Click To Show Fiber Addresses within PSA ${popUpData.zip_co_psa}</a>
                  </div>
                `
            );
            $('.fibCustAddressLayerPSAFilterLink').click(function () {
...
export default fibCustAddressLayer;
