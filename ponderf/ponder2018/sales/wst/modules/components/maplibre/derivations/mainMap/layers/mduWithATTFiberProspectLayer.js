...
const mduWithATTFiberProspectLayer = ({ instance, beforeLayerId }) => {
    ...
    const {        
        ...
        imgUrl,
        minShapeSize,
    } = pointsLayers.MDU_WITH_ATT_FIBER_PROSPECTS;

    map.loadImage(`${store.rootUrl}sales/opportunity/${imgUrl}`, function (error, image) {
        if (error) throw error;

        map.addImage("mduWithATTFiberProspectIcon", image, { sdf: true });
        ...
        map.addLayer(
            {
                ...
                layout: {
                    visibility: visibility,
                    "icon-image": "mduWithATTFiberProspectIcon",
    ...
    const markerClicked = async event => {
        ...
        try {
            ...
            popup.setHTML(
                `
                  <div style="text-align: center">                   
                   ...
                   <br/><div style = "align:center"></div><a href="#" class="mduWithATTFiberProspectLayerPSAFilterLink">Click To Show Fiber Addresses within PSA ${popUpData.zip_co_psa}</a>
                   <br/><div style = "align:center"></div><a href="#" class="mduWithATTFiberProspectLayerExportUnitNumbers">Click to Export Unit Numbers</a>
                  </div>
                `
            );
            $('.mduWithATTFiberProspectLayerPSAFilterLink').click(function () {
            ...
            $('.mduWithATTFiberProspectLayerExportUnitNumbers').click(function () {                
...
export default mduWithATTFiberProspectLayer;
