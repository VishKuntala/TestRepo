...
const ch7SledTable = ({ adminUser, instance }) => {


    const updateTable = async d => {
        const tableConfiguration = config.tables.ch7Sled;
        const {
            dataKeys,
            headers,
            frozenDataKeys,
    ...
    return {
        ...
        frozenDataKeys: config.tables.ch7Sled.frozenDataKeys,
        hiddenColumns: config.tables.ch7Sled.hiddenColumns,
        dataKeys: config.tables.ch7Sled.dataKeys,
        headers: config.tables.ch7Sled.headers,
        prependColumns: [{
            title: 'Zoom Map',
        ...
        dataTableConfig: {
            ...
            pagination: config.tables.ch7Sled.pagination,
            paginationSize: 12,
