...
const ch4FiberTable = ({ adminUser, instance }) => {


    const updateTable = async d => {
        const tableConfiguration = config.tables.ch4Fiber;
        const {
            dataKeys,
            headers,
            frozenDataKeys,
    ...
    return {
        ...
        frozenDataKeys: config.tables.ch4Fiber.frozenDataKeys,
        hiddenColumns: config.tables.ch4Fiber.hiddenColumns,
        dataKeys: config.tables.ch4Fiber.dataKeys,
        headers: config.tables.ch4Fiber.headers,
        prependColumns: [{
            title: 'Zoom Map',
        ...
        dataTableConfig: {
            ...
            pagination: config.tables.ch4Fiber.pagination,
            paginationSize: 12,
