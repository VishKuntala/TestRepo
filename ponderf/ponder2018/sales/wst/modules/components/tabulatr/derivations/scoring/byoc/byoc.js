...
const byocTable = ({ adminUser, instance }) => {
    ...
    const updateTable = async d => {
        const tableConfiguration = config.tables.byoc;
        const {
            dataKeys,
            headers,
            frozenDataKeys,
    ...
    return {
        frozenDataKeys: config.tables.byoc.frozenDataKeys,
        hiddenColumns: config.tables.byoc.hiddenColumns,
        dataKeys: config.tables.byoc.dataKeys,
        headers: config.tables.byoc.headers,
        dataTableConfig: {
            ...
            pagination: config.tables.byoc.pagination,
            paginationSize: 8,
            ...
            rowClick: function (e, row) {
                ...
                config.tables.byoc.rowClick(instance, data);
            },
            footerElement: config.tables.byoc.footerElement,
        },
        initSubscriptions,
        getAjaxParams,
        getAjaxUrl,
