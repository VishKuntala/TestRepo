...
const ch9FiberStoresTable = ({ adminUser, instance }) => {


    const updateTable = async d => {
        const tableConfiguration = config.tables.ch9FiberStores;
        const {
            dataKeys,
            headers,
            frozenDataKeys,
    ...
    return {
        ...
        frozenDataKeys: config.tables.ch9FiberStores.frozenDataKeys,
        hiddenColumns: config.tables.ch9FiberStores.hiddenColumns,
        dataKeys: config.tables.ch9FiberStores.dataKeys,
        headers: config.tables.ch9FiberStores.headers,
        prependColumns: [{
            title: 'Zoom Map',
        ...
        dataTableConfig: {
            ...
            pagination: config.tables.ch9FiberStores.pagination,
            paginationSize: 12,
...
export default ch9FiberStoresTable;
