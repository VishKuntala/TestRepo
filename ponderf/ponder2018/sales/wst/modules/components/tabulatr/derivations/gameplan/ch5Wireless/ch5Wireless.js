...
const ch5WirelessTable = ({ adminUser, instance }) => {


    const updateTable = async d => {
        const tableConfiguration = config.tables.ch5Wireless;
        const {
            dataKeys,
            headers,
            frozenDataKeys,
    ...
    return {
        ...
        frozenDataKeys: config.tables.ch5Wireless.frozenDataKeys,
        hiddenColumns: config.tables.ch5Wireless.hiddenColumns,
        dataKeys: config.tables.ch5Wireless.dataKeys,
        headers: config.tables.ch5Wireless.headers,
        prependColumns: [{
            title: 'Zoom Map',
        ...
        dataTableConfig: {
            ...
            pagination: config.tables.ch5Wireless.pagination,
            paginationSize: 12,
...
export default ch5WirelessTable;
