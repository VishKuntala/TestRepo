...
const ch2FiberTable = ({ adminUser, instance }) => {


    const updateTable = async d => {
        const tableConfiguration = config.tables.ch2Fiber;
        const {
            dataKeys,
            headers,
            frozenDataKeys,
    ...
    return {
        ...
        frozenDataKeys: config.tables.ch2Fiber.frozenDataKeys,
        hiddenColumns: config.tables.ch2Fiber.hiddenColumns,
        dataKeys: config.tables.ch2Fiber.dataKeys,
        headers: config.tables.ch2Fiber.headers,
        prependColumns: [{
            title: 'Zoom Map',
        ...
        dataTableConfig: {
            ...
            pagination: config.tables.ch2Fiber.pagination,
            paginationSize: 12,
