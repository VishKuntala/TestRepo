...
const ch3WirelessTable = ({ adminUser, instance }) => {


    const updateTable = async d => {
        const tableConfiguration = config.tables.ch3Wireless;
        const {
            dataKeys,
            headers,
            frozenDataKeys,
    ...
    return {
        ...
        frozenDataKeys: config.tables.ch3Wireless.frozenDataKeys,
        hiddenColumns: config.tables.ch3Wireless.hiddenColumns,
        dataKeys: config.tables.ch3Wireless.dataKeys,
        headers: config.tables.ch3Wireless.headers,
        prependColumns: [{
            title: 'Zoom Map',
        ...
        dataTableConfig: {
            ...
            pagination: config.tables.ch3Wireless.pagination,
            paginationSize: 12,
...
export default ch3WirelessTable;
