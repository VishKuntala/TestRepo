...
const midmarketFiberTable = ({ adminUser, instance }) => {


    const updateTable = async d => {
        const tableConfiguration = config.tables.midmarketFiber;
        const {
            dataKeys,
            headers,
            frozenDataKeys,
    ...
    return {
        ...
        frozenDataKeys: config.tables.midmarketFiber.frozenDataKeys,
        hiddenColumns: config.tables.midmarketFiber.hiddenColumns,
        dataKeys: config.tables.midmarketFiber.dataKeys,
        headers: config.tables.midmarketFiber.headers,
        prependColumns: [{
            title: 'Zoom Map',
        ...
        dataTableConfig: {
            ...
            pagination: config.tables.midmarketFiber.pagination,
            paginationSize: 12,
...
export default midmarketFiberTable;
