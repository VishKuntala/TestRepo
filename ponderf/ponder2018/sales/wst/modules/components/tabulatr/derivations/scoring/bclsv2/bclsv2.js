...
const bclsv2Table = ({ adminUser, instance }) => {


    const updateTable = async d => {
        const tableConfiguration = config.tables.bclsv2;
        const {
            dataKeys,
            headers,
            frozenDataKeys,
    ...
    return {
        frozenDataKeys: config.tables.bclsv2.frozenDataKeys,
        hiddenColumns: config.tables.bclsv2.hiddenColumns,
        dataKeys: config.tables.bclsv2.dataKeys,
        headers: config.tables.bclsv2.headers,
        dataTableConfig: {
            ...
            pagination: config.tables.bclsv2.pagination,
            paginationSize: 12,
            ...
            rowClick: function (e, row) {
                ...
                config.tables.bclsv2.rowClick(instance, data);
            },
