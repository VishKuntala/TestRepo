...
const ch2FiberQvTable = ({ adminUser, instance }) => {


    const updateTable = async d => {
        const tableConfiguration = config.tables.ch2FiberQv;
        const {
            dataKeys,
            headers,
            frozenDataKeys,
    ...
    return {
        ...
        frozenDataKeys: config.tables.ch2FiberQv.frozenDataKeys,
        hiddenColumns: config.tables.ch2FiberQv.hiddenColumns,
        dataKeys: config.tables.ch2FiberQv.dataKeys,
        headers: config.tables.ch2FiberQv.headers,
        prependColumns: [{
            title: 'Zoom Map',
        ...
        dataTableConfig: {
            ...
            pagination: config.tables.ch2FiberQv.pagination,
            paginationSize: 12,
...
export default ch2FiberQvTable;
