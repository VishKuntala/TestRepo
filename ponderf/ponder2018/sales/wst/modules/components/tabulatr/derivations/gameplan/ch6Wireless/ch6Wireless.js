...
const ch6WirelessTable = ({ adminUser, instance }) => {


    const updateTable = async d => {
        const tableConfiguration = config.tables.ch6Wireless;
        const {
            dataKeys,
            headers,
            frozenDataKeys,
    ...
    return {
        ...
        frozenDataKeys: config.tables.ch6Wireless.frozenDataKeys,
        hiddenColumns: config.tables.ch6Wireless.hiddenColumns,
        dataKeys: config.tables.ch6Wireless.dataKeys,
        headers: config.tables.ch6Wireless.headers,
        prependColumns: [{
            title: 'Zoom Map',
        ...
        dataTableConfig: {
            ...
            pagination: config.tables.ch6Wireless.pagination,
            paginationSize: 12,
...
export default ch6WirelessTable;
