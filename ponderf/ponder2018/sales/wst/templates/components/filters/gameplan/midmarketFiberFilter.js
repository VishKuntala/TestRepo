        ...
        <div class="column">
            <div  class="ui fluid filter form">
                ...
                <div class="four fields">
                    ...
                    <div class="field">
                        <label>Fiber PID</label>
                        <ponder-search-dd remoteUrl="${config.baseUrl}/filter/FiberPids?q={query}"
                                        defaultText="Select Fiber PIDs..." searchable="true"
                                        datakey="fiberPid" pillspriority="zb"
                                        derivation="filterMultiselectDropdown/filterMultiselectDropdown.js"
                                        allowMultipleSelection="true"  pillslabel="Fiber PID" pillsvaluesource="text"
                                        searchDropdownId="fiberPids-${id}">
                        </ponder-search-dd>
                    </div>
                </div>
                ...
                <div class="four fields">
                    <div class="field">
                        <label>Owning Segment/Channel Name</label>
                        <ponder-search-dd remoteUrl="${config.baseUrl}/filter/OwningSegNames?q={query}"
                                        defaultText="Select Owning Segment/Channel Name..." searchable="true"
                                        datakey="owningSegName" pillspriority="zb"
                                        derivation="filterMultiselectDropdown/filterMultiselectDropdown.js"
                                        allowMultipleSelection="true"  pillslabel="Owning Segment/Channel Name" pillsvaluesource="text"
