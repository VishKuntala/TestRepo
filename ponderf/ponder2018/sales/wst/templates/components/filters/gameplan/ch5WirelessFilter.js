        ...
        <div class="column">
            <div  class="ui fluid filter form">
                ...
                <div class="four fields">
                    ...
                    <div class="field">
                        <label>Building First Lit Date</label>
                ...
                <div class="four fields">
                    ...
                    <div class="field">
                        <label>Building Occupancy Count</label>
                        <ponder-search-dd remoteUrl="${config.baseUrl}/filter/TotalEmployeesHeres?q="
                                        defaultText="Select Building Occupancy Count..." searchable="true"
                                        datakey="totalEmployeesHere" pillspriority="u"
                                        derivation="filterMultiselectDropdown/filterMultiselectDropdown.js"
                                        allowMultipleSelection="true"  pillslabel="Building Occupancy Count" pillsvaluesource="text"
                                        searchDropdownId="totalEmployeesHere-${id}">
                        </ponder-search-dd>
                    </div>
                </div>
                ...
                <div class="four fields">
                    ...
                    <div class="field">
                        <label class="blueLabel">Active Mobility FAN - No Spend</label>
                        <ponder-search-dd remoteUrl="${config.baseUrl}/filter/NoSpends?q="
                                        defaultText="Select Active Mobility FAN - No Spend..." searchable="true"
                                        datakey="noSpend" pillspriority="z"
                                        derivation="filterMultiselectDropdown/filterMultiselectDropdown.js"
                                        allowMultipleSelection="true"  pillslabel="Active Mobility FAN - No Spend" pillsvaluesource="text"
                                        searchDropdownId="nospend-${id}">
                        </ponder-search-dd>
                    </div>
                </div>
                <div class="four fields">
                    <div class="field">
                        <label class="blueLabel">Business Employees</label>
                        <ponder-search-dd remoteUrl="${config.baseUrl}/filter/BusinessEmployees?q="
                                defaultText="Select Business Employees..." searchable="true"
                                datakey="businessEmployees" pillspriority="za"
                                derivation="filterMultiselectDropdown/filterMultiselectDropdown.js"
                                allowMultipleSelection="true"  pillslabel="Business Employees" pillsvaluesource="text"
                                searchDropdownId="businessEmployees-${id}">
                        </ponder-search-dd>
                    </div>
                    <div class="field">
                        <label class="blueLabel">SIC Code - Group</label>
                        <ponder-search-dd remoteUrl="${config.baseUrl}/filter/SicCdGrps?q={query}"
                                defaultText="Select SIC Code - Group..." searchable="true" 
                                datakey="sicCdGrp" pillspriority="zb"
                                derivation="filterMultiselectDropdown/filterMultiselectDropdown.js"
                                allowMultipleSelection="true"  pillslabel="SIC Code - Group" pillsvaluesource="text"
                                searchDropdownId="sicCdGrp-${id}">
                        </ponder-search-dd>
                    </div>
                </div>
