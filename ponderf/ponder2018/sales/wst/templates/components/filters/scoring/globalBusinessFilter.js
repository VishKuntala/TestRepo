            ...
            <div  class="ui fluid filter form">
                <div class="four fields">
                    <div class="required field">
                        ...
                        <ponder-search-dd remoteUrl="${config.baseUrl}/filter/Industries?q={query}"
                    ...
                    <div class="field">
                        ...
                        <ponder-search-dd remoteUrl="${config.baseUrl}/filter/CompanyNames?q={query}"
                    ...
                    <div class="field">
                        ...
                        <ponder-search-dd remoteUrl="${config.baseUrl}/filter/NoLowAccounts?q={query}"
                ...
                <div class="four fields">
                    ...
                    <div class="field">
                        ...
                        <ponder-search-dd remoteUrl="${config.baseUrl}/filter/CoverageScores?q={query}"
                                        ...
                                        datakey="indoorCovScore" pillspriority="g"
                                        derivation="filterMultiselectDropdown/filterMultiselectDropdown.js"
