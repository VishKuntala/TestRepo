const config = {
    ...
    fiveg_plus_mmwave: {
        ...
        'Hotspot': {
            name: 'Hotspot', color: '#00cc00', dbLabel: 'Hotspot'
        },
        'Yes': {
            name: 'Yes', color: '#003300', dbLabel: 'Yes'
        }
    ...
    avail_capacity: {
        ...
        "VeryLowAvailCapacity": {
            name: 'Very Low Avail Capacity', color: '#e6b800', dbLabel: 'VeryLowAvailCapacity'
        },
        "LowAvailCapacity": {
            name: 'Low Avail Capacity', color: '#ffff00', dbLabel: 'LowAvailCapacity'
        },
        "MediumAvailCapacity": {
            name: 'Medium Avail Capacity', color: '#00cc00', dbLabel: 'MediumAvailCapacity'
        },
        "HighAvailCapacity": {
            name: 'High Avail Capacity', color: '#008000', dbLabel: 'HighAvailCapacity'
        },
        "VeryHighAvailCapacity": {
            name: 'Very High Avail Capacity', color: '#003300', dbLabel: 'VeryHighAvailCapacity'
        }
    },
    speed_experience: {
        "Unknown": {
    ...
    fiber_status: {
        ...
        "7-NEARFIBER1000ft(NotLit)": {
            name: '7 - NEAR FIBER 1000ft (Not Lit)', color: '#ff9933', dbLabel: '7-NEARFIBER1000ft(NotLit)'
        },
        "6-GPONSERVINGAREA(NotLit)": {
            name: '6 - GPON SERVING AREA (Not Lit)', color: '#e6b800', dbLabel: '6-GPONSERVINGAREA(NotLit)'
        },
        "5-FIBERTHERE(NotLit)": {
            name: '5 - FIBER THERE (Not Lit)', color: '#ffff00', dbLabel: '5-FIBERTHERE(NotLit)'
        },
        "4-GPONLIT": {
            name: '4 - GPON LIT', color: '#00cc00', dbLabel: '4-GPONLIT'
        },
