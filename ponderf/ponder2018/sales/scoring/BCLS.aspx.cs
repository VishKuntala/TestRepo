...
public partial class sales_scoring_BCLS : System.Web.UI.Page
    {
        ...
        private static string BuildWhereClause(string vpgm, string archetype, string dmaName, string zipcode, string covScore, string fiveg,
     ...
     string valueColumn, string nameColumn, string sortColumn, string sortDirection = "ASC")
        {
            ...
            if (string.IsNullOrEmpty(searchString))
            {
                ...
                sql = sql + BuildWhereClause(vpgm, archetype, dmaName, zipcode, covScore, fiveg, band14, awbCapText, awbSpecEff, attRankGws, gponStatus, attOoklaQ, tmoRatioOokla, vznRatioOokla, popDensity, medIncome, hypergig);
            }
            else
            {
        ...
        [WebMethod]
        public static List<Dictionary<string, object>> TableData(string vpgm, string archetype, string dmaName, string zipcode, string covScore, string fiveg,
            string band14, string awbCapText, string awbSpecEff, string attRankGws, string gponStatus, string attOoklaQ, string tmoRatioOokla, string vznRatioOokla,
            string popDensity, string medIncome, string hypergig,
            string sortCriteria, string limit, string sortDirection, bool buildSortColumns)
        {
            ...
            sql = sql + BuildWhereClause(vpgm, archetype, dmaName, zipcode, covScore, fiveg, band14, awbCapText, awbSpecEff, attRankGws,
        ...
        [WebMethod]
        public static List<Dictionary<string, object>> MapData(string vpgm, string archetype, string dmaName, string zipcode, string covScore, string fiveg,
            string band14, string awbCapText, string awbSpecEff, string attRankGws, string gponStatus, string attOoklaQ, string tmoRatioOokla, string vznRatioOokla,
            string popDensity, string medIncome, string hypergig,
        ...
        [WebMethod]
        public static List<Dictionary<string, object>> ChartData(string vpgm, string archetype, string dmaName, string zipcode, string covScore, string fiveg,
            string band14, string awbCapText, string awbSpecEff, string attRankGws, string gponStatus, string attOoklaQ, string tmoRatioOokla, string vznRatioOokla,
            string popDensity, string medIncome, string hypergig,
            string sortCriteria, string limit, string attribute)
        {
