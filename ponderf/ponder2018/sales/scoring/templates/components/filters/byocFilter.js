            ...
            <div  class="ui fluid filter form">
                ...
                <div class="five fields">                    
                    ...
                    <div class="field">
                        ...
                        <ponder-search-dd remoteUrl="${config.baseUrl}/FiveGmmWaves?q={query}"
                                        defaultText="Select 5G+ mmWave..."
                                        datakey="fiveg_mmwave" pillspriority="g"
                                        derivation="filterMultiselectDropdown/filterMultiselectDropdown.js"
                                        allowMultipleSelection="true"  pillslabel="5G+ mmWave" pillsvaluesource="text"
                                        searchDropdownId="fiveg_mmwave-${id}">
                        </ponder-search-dd>
                    </div>
                    <div class="field">
                        <label>5G+ CBand</label>
                        <ponder-search-dd remoteUrl="${config.baseUrl}/FiveGCBands?q={query}"
                                        defaultText="Select 5G+ CBand..."
                                        datakey="fiveg_cband" pillspriority="h"
                                        derivation="filterMultiselectDropdown/filterMultiselectDropdown.js"
                                        allowMultipleSelection="true"  pillslabel="5G+ CBand" pillsvaluesource="text"
                                        searchDropdownId="fiveg_cband-${id}">
                        </ponder-search-dd>
                    </div>
                    <div class="field">
                        <label>FNET</label>
                ...
                <div class="five fields">
                    ...
                    <div class="field">
                        ...
                        <ponder-search-dd remoteUrl="${config.baseUrl}/Suitabilities?q={query}"
                                        ...
                                        datakey="suitability" pillspriority="l"
                                        derivation="filterMultiselectDropdown/filterMultiselectDropdown.js"
