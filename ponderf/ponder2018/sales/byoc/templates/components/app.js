...
//    <div class="header">
//        Ponder Select - Sales has been updated!
//    </div>
//    <p>We have improved our methodology to provide more accurate results and added C-Band availability to the output.
//        <br>Please re-run any existing clusters for your current projects to take advantage of the updates.</p>
//            </div>
...
<div class="ui sixteen column centered stackable grid">
    ...
    <div>
        <ponder-datatable tableid="tblClusters"
                            remoteurl="/sales/byoc/BYOC.aspx/Clusters"
