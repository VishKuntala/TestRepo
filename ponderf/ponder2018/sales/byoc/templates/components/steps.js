...
const template = ({ handleClick, navigateNext, navigatePrev, saveCluster, generateExceptionFile, downloadTemplateFile, sendSupportEmail }) => html`<div class="ui two top attached steps">
...
<div class="ui attached segment">
    <div class="ui eight column centered padded grid">
        <div class="row">
            <div class="description">Maximum of 10,000 locations can be submited at once.</div>
        </div>
        <div class="row">
                <div class="eight wide center aligned column">
                    ...
                    <div class="ui small message">
                        <div>
                            ** Template has recently changed. Please download and use new template for submissions. **
                        </div>                        
                    </div>
                    <div class="ui small message">
                        <div>
