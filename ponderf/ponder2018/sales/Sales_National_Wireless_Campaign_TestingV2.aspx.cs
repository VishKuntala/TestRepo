...
public partial class sales_Sales_National_Wireless_Campaign_TestingV2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!(Page.IsPostBack)) //stops page from reloading on selection or button click
        {
            ...
            if (ATTUID == "wc5172" | ATTUID == "na768n" | ATTUID == "kj390r" | ATTUID == "ys460u" | ATTUID == "hm403c" | ATTUID == "eh569u" | ATTUID == "tl246s" | ATTUID == "kk5880" | ATTUID == "hb4894")
    ...
    public void ExportToExcel_All_Filtered(object sender, EventArgs e)
    {
        ...
        string sql = @"SELECT ROWNUM, TBL1.RECORDID, TBL1.CAMPAIGN_ID, TBL1.COVERAGE_SCORE, TBL1.FIVEG AS ""5G"", TBL1.FIVEG_PLUS AS ""5G+"", TBL1.TPUT_TEXT AS ""SPEED AND LOAD"", TBL1.ROAM_TEXT AS ""ROAMING"", TBL1.FIRST_NET AS ""FNET"", TBL1.BAND_14, TBL1.FIBER_CUST, TBL1.CONTACT_COMPANY_NM, TBL1.CONTACT_FIRST_NM, TBL1.CONTACT_LAST_NM,
                ...
                FROM PONDER.SALES_CAMPAIGN_WIRELESS_V4 
    ...
    protected void ddlInitial_Filter(object sender, EventArgs e)
    {
        ...
        String strConnString = ConfigurationManager.ConnectionStrings["AXIOM"].ConnectionString;
        String strQuery1 = "select distinct CAMPAIGN_ID from PONDER.SALES_CAMP_WIRELESS_FILTER_V4 WHERE CAMPAIGN_ID !='ALL' ORDER BY CAMPAIGN_ID";
        String strQuery2 = "select distinct COVERAGE_SCORE, CASE WHEN COVERAGE_SCORE = 5 THEN '5 - Best' WHEN COVERAGE_SCORE = 4 THEN '4 - Very Strong' WHEN COVERAGE_SCORE = 3 THEN '3 - Strong' WHEN COVERAGE_SCORE = 2 THEN" + 
            " '2 - Weak' WHEN COVERAGE_SCORE = 1 THEN '1 - Very Weak' ELSE 'n/a' END AS COVERAGE_SCORE_TEXT from PONDER.SALES_CAMP_WIRELESS_FILTER_V4 WHERE COVERAGE_SCORE != 'ALL' ORDER BY COVERAGE_SCORE DESC";
        String strQuery3 = "select distinct FIVEG from PONDER.SALES_CAMP_WIRELESS_FILTER_V4 WHERE FIVEG != 'ALL' ORDER BY FIVEG";
        String strQuery4 = "select distinct TPUT_TEXT from PONDER.SALES_CAMP_WIRELESS_FILTER_V4 WHERE TPUT_TEXT != 'ALL' ORDER BY CASE WHEN TPUT_TEXT = 'ALL' THEN 1 WHEN TPUT_TEXT = 'High Speed/Very High Avail Capacity' THEN 2 WHEN TPUT_TEXT = 'Medium Speed/High Avail Capacity' THEN 3" +
        ...
        //String strQuery5 = "select distinct PRIMARY_COMPETITOR_NAME from PONDER.SALES_CAMP_WIRELESS_FILTER_V4 WHERE PRIMARY_COMPETITOR_NAME != 'ALL' ORDER BY PRIMARY_COMPETITOR_NAME";
        String strQuery6 = "select distinct ROAM_TEXT from PONDER.SALES_CAMP_WIRELESS_FILTER_V4 WHERE ROAM_TEXT != 'ALL' ORDER BY CASE WHEN ROAM_TEXT = 'ALL' THEN 1 WHEN ROAM_TEXT = 'No' THEN 2 WHEN ROAM_TEXT = 'Medium roaming' THEN 3" +
            " WHEN ROAM_TEXT = 'Heavy roaming' THEN 4 WHEN ROAM_TEXT = 'No Data' THEN 5 ELSE 6 END";
        String strQuery7 = "select distinct FIBER_CUST from PONDER.SALES_CAMP_WIRELESS_FILTER_V4 WHERE FIBER_CUST != 'ALL' ORDER BY CASE WHEN FIBER_CUST = 'High' then 6  WHEN FIBER_CUST = 'Medium' then 5 WHEN FIBER_CUST = 'Low' then 4 ELSE 1 END";
        String strQuery8 = "select distinct STATE from PONDER.SALES_CAMP_WIRELESS_FILTER_V4 where STATE != 'ALL' ORDER BY STATE";
        String strQuery9 = "select distinct ZIP from PONDER.SALES_CAMP_WIRELESS_FILTER_V4 where ZIP != 'ALL' ORDER BY ZIP";
        String strQuery10 = "select distinct BAND_14 from PONDER.SALES_CAMP_WIRELESS_FILTER_V4 where BAND_14 != 'ALL' ORDER BY BAND_14";
    ...
    protected void ddlCampaign_Filter(object sender, EventArgs e)
    {
        ...
        String strConnString = ConfigurationManager.ConnectionStrings["AXIOM"].ConnectionString;
        String strQuery1 = "select distinct CAMPAIGN_ID from PONDER.SALES_CAMP_WIRELESS_FILTER_V4 WHERE CAMPAIGN_ID != 'ALL' AND COVERAGE_SCORE >=:COVERAGE_SCORE AND FIVEG=:FIVEG" +
    ...
    protected void ddlCoverageScore_Filter(object sender, EventArgs e)
    {
        ...
        String strQuery2 = "select distinct COVERAGE_SCORE, CASE WHEN COVERAGE_SCORE = 5 THEN '5 - Best' WHEN COVERAGE_SCORE = 4 THEN '4 - Very Strong' WHEN COVERAGE_SCORE = 3 THEN '3 - Strong'" +
            ...
            " from PONDER.SALES_CAMP_WIRELESS_FILTER_V4 WHERE CAMPAIGN_ID=:CAMPAIGN_ID AND COVERAGE_SCORE != 'ALL' AND FIVEG=:FIVEG" +
            " AND TPUT_TEXT=:TPUT_TEXT AND ROAM_TEXT=:ROAM AND BAND_14=:B14" +
    ...
    protected void ddl5G_Filter(object sender, EventArgs e)
    {
        ...
        String strConnString = ConfigurationManager.ConnectionStrings["AXIOM"].ConnectionString;
        String strQuery2 = "select distinct FIVEG from PONDER.SALES_CAMP_WIRELESS_FILTER_V4 WHERE CAMPAIGN_ID=:CAMPAIGN_ID AND COVERAGE_SCORE >=:COVERAGE_SCORE AND FIVEG != 'ALL'" +
            " AND TPUT_TEXT=:TPUT_TEXT AND ROAM_TEXT=:ROAM AND BAND_14=:B14" +
    ...
    protected void ddlTPUT_TEXT_Filter(object sender, EventArgs e)
    {
        ...
        String strConnString = ConfigurationManager.ConnectionStrings["AXIOM"].ConnectionString;
        String strQuery3 = "select distinct TPUT_TEXT from PONDER.SALES_CAMP_WIRELESS_FILTER_V4 WHERE CAMPAIGN_ID=:CAMPAIGN_ID AND COVERAGE_SCORE >=:COVERAGE_SCORE AND FIVEG=:FIVEG" +
    ...
    //    String strConnString = ConfigurationManager.ConnectionStrings["AXIOM"].ConnectionString;
    //    String strQuery4 = "select distinct PRIMARY_COMPETITOR_NAME from PONDER.SALES_CAMP_WIRELESS_FILTER_V4 WHERE COVERAGE_SCORE=:COVERAGE_SCORE AND FIVEG=:FIVEG AND TPUT_TEXT=:TPUT_TEXT" +
    ...
    protected void ddlROAM_Filter(object sender, EventArgs e)
    {
        ...
        String strConnString = ConfigurationManager.ConnectionStrings["AXIOM"].ConnectionString;
        String strQuery5 = "select distinct ROAM_TEXT from PONDER.SALES_CAMP_WIRELESS_FILTER_V4 WHERE COVERAGE_SCORE >=:COVERAGE_SCORE AND FIVEG=:FIVEG AND TPUT_TEXT=:TPUT_TEXT" +
            " AND ROAM_TEXT != 'ALL' AND BAND_14=:B14 AND CAMPAIGN_ID=:CAMPAIGN_ID AND FIBER_CUST=:FIBER_CUST AND STATE=:STATE" +
    ...
    protected void ddlB14_Filter(object sender, EventArgs e)
    {
        ...
        String strConnString = ConfigurationManager.ConnectionStrings["AXIOM"].ConnectionString;
        String strQuery5 = "select distinct BAND_14 from PONDER.SALES_CAMP_WIRELESS_FILTER_V4 WHERE COVERAGE_SCORE >=:COVERAGE_SCORE AND FIVEG=:FIVEG AND TPUT_TEXT=:TPUT_TEXT" +
            " AND BAND_14 != 'ALL' AND ROAM_TEXT=:ROAM AND CAMPAIGN_ID=:CAMPAIGN_ID AND FIBER_CUST=:FIBER_CUST AND STATE=:STATE" +
    ...
    protected void ddlFiberCust_Filter(object sender, EventArgs e)
    {
        ...
        String strConnString = ConfigurationManager.ConnectionStrings["AXIOM"].ConnectionString;
        String strQuery7 = "select distinct FIBER_CUST from PONDER.SALES_CAMP_WIRELESS_FILTER_V4 WHERE COVERAGE_SCORE >=:COVERAGE_SCORE AND FIVEG=:FIVEG AND TPUT_TEXT=:TPUT_TEXT" +
            " AND ROAM_TEXT=:ROAM AND BAND_14=:B14 AND CAMPAIGN_ID=:CAMPAIGN_ID AND FIBER_CUST != 'ALL' AND STATE=:STATE" +
    ...
    protected void ddlState_Filter(object sender, EventArgs e)
    {
        ...
        String strConnString = ConfigurationManager.ConnectionStrings["AXIOM"].ConnectionString;
        String strQuery7 = "select distinct STATE from PONDER.SALES_CAMP_WIRELESS_FILTER_V4 WHERE COVERAGE_SCORE >=:COVERAGE_SCORE AND FIVEG=:FIVEG AND TPUT_TEXT=:TPUT_TEXT" +
            " AND ROAM_TEXT=:ROAM AND BAND_14=:B14 AND CAMPAIGN_ID=:CAMPAIGN_ID AND FIBER_CUST=:FIBER_CUST AND STATE != 'ALL'" +
    ...
    protected void ddlZip_Filter(object sender, EventArgs e)
    {
        ...
        String strConnString = ConfigurationManager.ConnectionStrings["AXIOM"].ConnectionString;
        String strQuery8 = "select distinct Zip from PONDER.SALES_CAMP_WIRELESS_FILTER_V4 WHERE COVERAGE_SCORE =:COVERAGE_SCORE AND FIVEG=:FIVEG AND TPUT_TEXT=:TPUT_TEXT" +
            " AND ROAM_TEXT=:ROAM AND BAND_14=:B14 AND CAMPAIGN_ID=:CAMPAIGN_ID AND FIBER_CUST=:FIBER_CUST AND " +
