...
public partial class sales_Sales_National_Wireless_Campaign_QA_TestingV3 : System.Web.UI.Page
{
    ...
    protected void ddlSeller_Filter(object sender, EventArgs e)
    {
        ...
        String strQuery1 = "SELECT DISTINCT SELLER FROM (" +
            " SELECT * FROM (" +
            " SELECT t1.*, OWNING_ATTUID AS SELLER FROM PONDER.SALES_MIDMARKET_V2 t1 " +
            " UNION ALL" +
            " SELECT t2.*, SM_ATTUID AS SELLER FROM PONDER.SALES_MIDMARKET_V2 t2) data" +
            " WHERE SELLER != 'ALL'" +
    ...
    protected void ddlBusinessName_Filter(object sender, EventArgs e)
    {
        ...
        String strConnString = ConfigurationManager.ConnectionStrings["AXIOM"].ConnectionString;
        String strQuery1 = "select distinct SVID_NAME from PONDER.SALES_MIDMARKET_V2 WHERE SVID_NAME != 'ALL'" +
    ...
    protected void ddlCoverageScore_Filter(object sender, EventArgs e)
    {
        ...
        if (ddlChannel.SelectedItem.Value == "nationalBusinessWireless") { 
            table1 = "PONDER.SALES_CAMP_WIRELESS_SUM_V5";
        ...
        String strQuery2 = "select distinct COVERAGE_SCORE, CASE WHEN COVERAGE_SCORE = 5 THEN '5 - Best' WHEN COVERAGE_SCORE = 4 THEN '4 - Very Strong' WHEN COVERAGE_SCORE = 3 THEN '3 - Strong'" +
            ...
            " AND (TPUT_TEXT LIKE :TPUT_TEXT OR TPUT_TEXT LIKE :TPUT_TEXT2 OR TPUT_TEXT LIKE :TPUT_TEXT3 OR TPUT_TEXT LIKE :TPUT_TEXT4 OR TPUT_TEXT LIKE :TPUT_TEXT5)" +
            " AND ROAM_TEXT LIKE :ROAM AND BAND_14 LIKE :B14" +
            " AND FIBER_CUST LIKE :FIBER_CUST AND STATE_Y LIKE :STATE AND ZIPCODE LIKE :ZIP " + seller1 + business1 + " ORDER BY COVERAGE_SCORE DESC";
    ...
    protected void ddl5G_Filter(object sender, EventArgs e)
    {
        ...
        String strQuery2 = "select distinct FIVEG from " + table1 + " WHERE " + campaign1 + " COVERAGE_SCORE >= :COVERAGE_SCORE AND FIVEG != 'ALL'" +
            " AND (TPUT_TEXT LIKE :TPUT_TEXT OR TPUT_TEXT LIKE :TPUT_TEXT2 OR TPUT_TEXT LIKE :TPUT_TEXT3 OR TPUT_TEXT LIKE :TPUT_TEXT4 OR TPUT_TEXT LIKE :TPUT_TEXT5)" +
            " AND ROAM_TEXT LIKE :ROAM AND BAND_14 LIKE :B14" +
            " AND FIBER_CUST LIKE :FIBER_CUST AND STATE_Y LIKE :STATE AND ZIPCODE LIKE :ZIP " + seller1 + business1 + " ORDER BY FIVEG";
    ...
    protected void ddlTPUT_TEXT_Filter(object sender, EventArgs e)
    {
        ...
        String strQuery3 = "select distinct TPUT_TEXT from " + table1 + " WHERE " + campaign1 + " COVERAGE_SCORE >= :COVERAGE_SCORE AND FIVEG LIKE :FIVEG" +
            " AND TPUT_TEXT != 'ALL' " +
            " AND ROAM_TEXT LIKE :ROAM AND BAND_14 LIKE :B14" +
            " AND FIBER_CUST LIKE :FIBER_CUST AND STATE_Y LIKE :STATE AND ZIPCODE LIKE :ZIP " + seller1 + business1 + " ORDER BY CASE WHEN TPUT_TEXT = 'ALL' THEN 1 WHEN TPUT_TEXT = 'High Speed/Very High Avail Capacity' THEN 2 WHEN TPUT_TEXT = 'Medium Speed/High Avail Capacity' THEN 3" +
    ...
    protected void ddlROAM_Filter(object sender, EventArgs e)
    {
        ...
        String strQuery5 = "select distinct ROAM_TEXT from " + table1 + " WHERE COVERAGE_SCORE >=:COVERAGE_SCORE AND FIVEG LIKE :FIVEG" +
            ...
            " AND ZIPCODE LIKE :ZIP " + seller1 + business1 + " ORDER BY CASE WHEN ROAM_TEXT = 'ALL' THEN 1 WHEN ROAM_TEXT = 'No' THEN 2 WHEN ROAM_TEXT = 'Medium roaming' THEN 3" +
    ...
    protected void ddlB14_Filter(object sender, EventArgs e)
    {
        ...
        String strQuery5 = "select distinct BAND_14 from " + table1 + " WHERE COVERAGE_SCORE >=:COVERAGE_SCORE AND FIVEG LIKE :FIVEG" +
            ...
            " AND ZIPCODE LIKE :ZIP " + seller1 + business1 + " ORDER BY BAND_14";
    ...
    protected void ddlFiberCust_Filter(object sender, EventArgs e)
    {
        ...
        String strQuery7 = "select distinct FIBER_CUST from " + table1 + " WHERE COVERAGE_SCORE >=:COVERAGE_SCORE AND FIVEG LIKE :FIVEG" +
            ...
            " AND ZIPCODE LIKE :ZIP " + seller1 + business1 + " ORDER BY CASE WHEN FIBER_CUST = 'High' then 6  WHEN FIBER_CUST = 'Medium' then 5 WHEN FIBER_CUST = 'Low' then 4 ELSE 1 END";
    ...
    protected void ddlState_Filter(object sender, EventArgs e)
    {
        ...
        String strQuery7 = "select distinct STATE_Y from " + table1 + " WHERE COVERAGE_SCORE >=:COVERAGE_SCORE AND FIVEG LIKE :FIVEG" +
            ...
            " AND ZIPCODE LIKE :ZIP " + seller1 + business1 + " ORDER BY STATE_Y";
    ...
    protected void ddlZip_Filter(object sender, EventArgs e)
    {
        ...
        String strQuery8 = "SELECT DISTINCT ZIPCODE FROM " + table1 + " WHERE COVERAGE_SCORE >=:COVERAGE_SCORE AND FIVEG LIKE :FIVEG" +
            ...
            "STATE_Y LIKE :STATE AND ZIPCODE != 'ALL' " + seller1 + business1 + " ORDER BY ZIPCODE";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National1(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        ...
        string sql = @"SELECT CAMPAIGN_ID, CONTACT_COMPANY_NM, LOCATION_ID, CONTACT_FIRST_NM, CONTACT_LAST_NM, CONTACT_EMAIL, CONTACT_PHONE1, ADDR_LINE1, CITY_NM, STATE_Y, POSTL_CD, COVERAGE_SCORE, FIVEG, FIVEG_PLUS, TPUT_TEXT, ROAM_TEXT, PRIMARY_COMPETITOR_NAME, FIRST_NET, BAND_14, TPUT, FIBER_CUST, LATITUDE, LONGITUDE, NUMBER_OF_EMPLOYEES, COVERAGE_SCORE_RANK
                    FROM (" + SelectSql + @" FROM " + TableSql + @" WHERE " + CampaignSql + @" 
                    ...
                    AND ROAM_TEXT LIKE '" + ROAMVariable + @"'
                    AND BAND_14 LIKE '" + B14Variable + @"'
                    AND (FIBER_CUST LIKE '" + FiberCustVariable + @"' OR FIBER_CUST IS NULL) " + SellerSql + BusinessSql + @")
    ...
    [WebMethod]
    public static string Get_Location_Detail_National2(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National3(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National4(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National5(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National6(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National7(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National8(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National9(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National10(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National11(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National12(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National13(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National14(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National15(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National16(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National17(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National18(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National19(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National20(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National21(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National22(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National23(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National24(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National25(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National26(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National27(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National28(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National29(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National30(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National31(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National32(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National33(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National34(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National35(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National36(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National37(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National38(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National39(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National40(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National41(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National42(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National43(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National44(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
    ...
    [WebMethod]
    public static string Get_Location_Detail_National45(string groupVariable, string ChannelVariable, string CampaignVariable, string StateVariable, string ZipVariable, string CoverageScoreVariable, string FiveGVariable,
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string SellerVariable, string BusinessVariable)
    {
        var SelectSql = "";
        var TableSql = "";
                            ...
                            string TPUT_TEXTVariable, string CompetitorVariable, string ROAMVariable, string B14Variable, string FiberCustVariable, string SortVariable, string ChannelVariable, string SellerVariable, string BusinessVariable)
    {
        ...
        else if (ChannelVariable == "midMarket")
        {
            SelectSql = "SELECT 'Mid Market' AS CAMPAIGN_ID, SVID_NAME AS CAMPAIGN_NAME, " +
                ...
                "'na' AS LOCATION_ID, 'na' AS CONTACT_PHONE1, 'na' AS CONTACT_EMAIL, 'na' AS CONTACT_FIRST_NM, 'na' AS CONTACT_LAST_NM, COVERAGE_SCORE_RANK, 'na' AS NUMBER_OF_EMPLOYEES ";
            TableSql = "PONDER.SALES_MIDMARKET_V2 ";
        }
        var CampaignSql = "";
        if (ChannelVariable == "nationalBusinessWireless")
    ...
    public void ExportToExcel_MidMarket(object sender, EventArgs e)
    {
        ...
        string sql = @"SELECT ROWNUM, TBL1.* FROM (SELECT OWNING_ATTUID, SM_ATTUID, SVID_NAME,
                        COVERAGE_SCORE, FIVEG, FIVEG_PLUS, TPUT_TEXT, ROAM_TEXT, FIRST_NET, BAND_14, FIBER_CUST AS LEGACY_DEVICE_PENETRATION, ADDR, CITY, STATE_Y, ZIPCODE, LATITUDE, LONGITUDE
                        FROM PONDER.SALES_MIDMARKET_V2 
                    WHERE 
                    (OWNING_ATTUID LIKE '" + SellerVariable + @"' OR SM_ATTUID LIKE '" + SellerVariable + @"') AND 
                    SVID_NAME LIKE '" + BusinessVariable + @"' AND 
                    ...
                    BAND_14 LIKE '" + B14Variable + @"' AND 
                    (FIBER_CUST LIKE '" + FiberCustVariable + @"' OR FIBER_CUST IS NULL) 
                ORDER BY " + SortVariable + @" DESC)TBL1 WHERE COVERAGE_SCORE IS NOT NULL";
    ...
    public void ExportToExcel_MidMarketTop500(object sender, EventArgs e)
    {
        ...
        string sql = @"SELECT ROWNUM, TBL1.* FROM (SELECT OWNING_ATTUID, SM_ATTUID, SVID_NAME,
                    ...
                    BAND_14 LIKE '" + B14Variable + @"' AND 
                    (FIBER_CUST LIKE '" + FiberCustVariable + @"' OR FIBER_CUST IS NULL) 
                ORDER BY " + SortVariable + @" DESC)TBL1 WHERE(ROWNUM <= 500) AND COVERAGE_SCORE IS NOT NULL";
