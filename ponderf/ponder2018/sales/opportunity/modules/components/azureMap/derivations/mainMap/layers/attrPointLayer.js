...
const arPointLayer = ({ instance, beforeLayerId, pointMinShapeSize }) => {
    ...
    //const iconPromises = [map.imageSprite.createFromTemplate(`attrIcon`, 'ellipse-outline', color)];
    ...
    instance.getData(
        //`${store.baseApiUrl}/point/stores?category=ATTR&randomize=${Date.now().toString()}`,
        //`${store.baseApiUrl}/point/stores?category=ATTR&marketType=${instance.store.marketType}&market=${instance.store.market}`,
