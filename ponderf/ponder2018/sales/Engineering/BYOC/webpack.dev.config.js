...
module.exports = {
 ...
 output: {
     publicPath: '/sales/Engineering/BYOC/local/',
 ...
 plugins: [
   ...
   new CopyPlugin({
      patterns: [
        ...
        { from: path.join(__dirname, "/semantic/dist/responsive.semanticui.min.css"), to: path.join(__dirname, "/local/responsive.semanticui.min.css") },
        { from: path.join(__dirname, "/dataTables.semanticui.min.css"), to: path.join(__dirname, "/local/dataTables.semanticui.min.css") },
