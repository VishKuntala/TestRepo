const toolConfig = {
    "midmarket": {
        ...
        baseUrl: '/sales/Engineering/scoring/MidMarket.aspx',
        filter: {
    ...
    "omni": {
        ...
        toolName: 'Omni',
        startingSortCriteria: 'COVERAGE_SCORE',
        baseUrl: '/sales/Engineering/scoring/Omni.aspx',
        filter: {
    ...
    "nbwc": {
        ...
        startingSortCriteria: 'COVERAGE_SCORE',
        baseUrl: '/sales/Engineering/scoring/WirelessCampaign.aspx',
        filter: {
    ...
    "globalBusiness": {
        ...
        startingSortCriteria: 'COVERAGE_SCORE',
        baseUrl: '/sales/Engineering/scoring/GlobalBusiness.aspx',
        filter: {
    ...
    "byoc": {
        ...
        baseUrl: '/sales/Engineering/scoring/BYOC.aspx',
        filter: {
            dataKeys: ['accessType', 'clusterId', 'statecode', 'zipcode', 'covScore', 'fiveg', 'fivegplus', 'cband', 'band14', 'fnet', 'suitability', 'ranCause', 'speedExperience', 'weightedAvgTputGrp', 'availCapacity', 'roamText', 'cqiGrp', 'spectrumEff12Pl', 'cbandScs', 'weightedAvgMcepPrbUtlGrp'],
        ...
        sortCriteriaData: [
            ...
            { "name": "WBB High Speed Suitability", "value": "SUITABILITY_SORT_COLUMN" },
        ...
        tableRecordsLimit: 5000,
        dataTableHeaders: "Rank,Location ID,Company Name,Address,City,State,Zip,Simple Coverage Score,5G,5G Plus mmWave,5G Plus Speed,5G Plus C-Band,C-Band Simple Coverage Score,C-Band Speed,FNET Band 14,FNET,WBB High Speed Suitability,RAN Suitability Cause,Speed Experience,Weighted Avg Tput,Tput Min,Tput Max,Available Capacity,CQI,Spectrum Efficiency,Average MCEP PRB Utilization,Roaming,Roaming Rate,Coverage Radius,Best Servers,Azimuth,USID",
        dataTableDataKeys: "rownum,location_id,company_name,address,city,state,zipcode,simple_coverage_score,fiveg,fiveg_plus_mmwave,fiveg_plus_speed,fiveg_plus_cband,cband_scs,cband_speed,band_14,first_net,sales_high_speed_suitability,ran_suitability_cause,speed_experience,weighted_avg_tput,tput_min,tput_max,avail_capacity,cqi,spectrum_efficiency_12_pl,weighted_avg_mcep_prbutl,roam_text,roaming_rate,coverage_radius,best_servers,azimuth,usid",
        dataTableExportOmitKeys: "roam_text_sort_column,tput_text_sort_column,fiber_cust_sort_column,band_14_sort_column,fiveg_sort_column,fiveg_plus_sort_column,first_net_sort_column",
        ...
        barchart: {
            categoryDataValues: 'Unknown,No,Partial,Yes,Very Weak,Uneven,Strong,Very Strong,Best,High,Medium,Low,Low Speed/Very Low Avail Capacity,Medium Speed/Low Avail Capacity,Medium Speed/Medium Avail Capacity,Medium Speed/High Avail Capacity,High Speed/Very High Avail Capacity,No AWB - Check with RAN,No WBB - Check with RAN,Low Speed Failover Only,Low TPUT Failover Only,Insufficient Coverage,Insufficient Capacity,Insuff Cap MCEP Only,Feasible,Feasible Low TPUT,Feasible Low Spect Eff,Feasible Med Spect Eff,Good,Very Good,Excellent,Low Speed,Medium Speed,High Speed,Hotspot,Outdoor Only,Indoor',
            ...
            categoryDataKeys: "simple_coverage_score,fiveg,fiveg_plus_mmwave,fiveg_plus_cband,band_14,first_net,ran_suitability_cause,speed_experience"
        }
    },
    "englite": {
        tool: 'englite',
        toolName: 'Engineering Lite',
        startingSortCriteria: 'SIMPLE_COVERAGE_SCORE',
        baseUrl: '/sales/Engineering/scoring/englite.aspx',
        filter: {
            dataKeys: ['accessType', 'clusterId', 'statecode', 'zipcode', 'covScore', 'fiveg', 'fivegplus', 'cband', 'band14', 'fnet', 'suitability', 'ranCause', 'speedExperience', 'weightedAvgTputGrp', 'availCapacity', 'roamText', 'cqiGrp', 'spectrumEff12Pl', 'cbandScs', 'weightedAvgMcepPrbUtlGrp'],
            requiredDataKeys: ['accessType', 'clusterId'],
            requiredBooleanOperator: "all",
        ...
        tableRecordsLimit: 5000,
        dataTableHeaders: "Rank,Location ID,Company Name,Address,City,State,Zip,Simple Coverage Score,5G,5G Plus mmWave,5G Plus C-Band,FNET Band 14,FNET,Speed Experience,WBB High Speed Suitability,Roaming,Available Capacity",
        dataTableDataKeys: "rownum,location_id,company_name,address,city,state,zipcode,simple_coverage_score,fiveg,fiveg_plus_mmwave,fiveg_plus_cband,band_14,first_net,speed_experience,sales_high_speed_suitability,roam_text,avail_capacity",
        dataTableExportOmitKeys: "roam_text_sort_column,tput_text_sort_column,fiber_cust_sort_column,band_14_sort_column,fiveg_sort_column,fiveg_plus_sort_column,first_net_sort_column",
        charts: ['simple_coverage_score', 'fiveg', 'fiveg_plus_mmwave', 'fiveg_plus_cband', 'band_14', 'first_net', 'sales_high_speed_suitability', 'speed_experience'],
        barchart: {
            categoryDataValues: 'Unknown,No,Partial,Yes,Very Weak,Uneven,Strong,Very Strong,Best,High,Medium,Low,Low Speed/Very Low Avail Capacity,Medium Speed/Low Avail Capacity,Medium Speed/Medium Avail Capacity,Medium Speed/High Avail Capacity,High Speed/Very High Avail Capacity,No AWB - Check with RAN,No WBB - Check with RAN,Low Speed Failover Only,Low TPUT Failover Only,Insufficient Coverage,Insufficient Capacity,Insuff Cap MCEP Only,Feasible,Feasible Low TPUT,Feasible Low Spect Eff,Feasible Med Spect Eff,Good,Very Good,Excellent,Low Speed,Medium Speed,High Speed,Hotspot,Outdoor Only,Indoor',
            categoryLabels: "Simple Coverage Score,5G,5G Plus mmWave,5G Plus C-Band,FNET Band 14,FNET,Speed Experience, WBB High Speed Suitability",
            categoryDataKeys: "simple_coverage_score,fiveg,fiveg_plus_mmwave,fiveg_plus_cband,band_14,first_net,speed_experience,sales_high_speed_suitability"
        }
    },
    "nationalLUs": {
        tool: 'nationalLUs',
        ...
        baseUrl: '/sales/Engineering/scoring/NationalLUs.aspx',
        filter: {
    ...
    "bcls": {
        ...
        toolName: 'BCLS',
        startingSortCriteria: 'SIMPLE_COVERAGE_SCORE',
        baseUrl: '/sales/Engineering/scoring/BCLS.aspx',
        filter: {            
