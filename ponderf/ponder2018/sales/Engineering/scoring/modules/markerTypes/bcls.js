  ...
  `);
    ...
    const locationData = response.d[0];
        popup.setContent(`
                        ...
                        <br/><b>Sales Force MQO Match ID:</b> ${locationData.sales_force_mqo_campaign_id}
                        ...
                        <br/><b>Pop Density:</b> ${locationData.pop_density_text} - <b>Median Income:</b> ${locationData.hh_median_income_text} - <b>Zip Demographics:</b> ${locationData.zip_pct_hispanic_text}
                                                `);
