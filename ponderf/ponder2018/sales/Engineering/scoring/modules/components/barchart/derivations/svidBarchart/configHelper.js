const config = {
    ...
    ran_suitability_cause: {
        'InsufficientTPUT': {
            name: 'Insufficient TPUT', color: '#661a00', dbLabel: 'InsufficientTPUT'
        },
        'InsufficientCoverage': {
            name: 'Insufficient Coverage', color: '#e63900', dbLabel: 'InsufficientCoverage'
        },
        'InsufficientCapacity': {
            name: 'Insufficient Capacity', color: '#ff8c66', dbLabel: 'InsufficientCapacity'
        },
        'InsuffCapMCEPOnly': {
            name: 'Insuff Cap MCEP Only', color: '#ff8c66', dbLabel: 'InsuffCapMCEPOnly'
        },
        'Feasible': {
            name: 'Feasible', color: '#664d00', dbLabel: 'Feasible'
        },
        'FeasibleLow TPUT': {
            name: 'Feasible Low TPUT', color: '#cc9900', dbLabel: 'FeasibleLowTPUT'
        },
        'FeasibleLowSpectEff': {
            name: 'Feasible Low Spect Eff', color: '#ffcc33', dbLabel: 'FeasibleLowSpectEff'
        },
        'FeasibleMedSpectEff': {
            name: 'Feasible Med Spect Eff', color: '#ffe699', dbLabel: 'FeasibleMedSpectEff'
        },
        'Good': {
            name: 'Good', color: '#00cc00', dbLabel: 'Good'
        },
