...
public partial class sales_AWB_scoring_WirelessCampaign : System.Web.UI.Page
    {
        ...
        private static List<Dictionary<string, object>> FetchCampaignData(NameValueCollection queryStringCollection)
        {
            ...
            if (string.IsNullOrEmpty(searchString))
            {
                ...
                sql = sql + BuildWhereClause(campaignIds, zipcode, statecode, covScore, fiveg, band14, tputText, roamingDependency, legacyPen);
