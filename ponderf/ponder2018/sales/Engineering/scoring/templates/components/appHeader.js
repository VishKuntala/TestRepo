    ...
    <div class="ui sixteen column padded stackable grid">
        <div class="row">
            <div class="five wide left aligned column">
                        <h3  class="ui header">
                            <img  class="logo" src="images/ponder_logo.jpg" />&nbsp;<span style="vertical-align:middle;">Engineering Wireless Scoring</span>
                        </h3>
            </div>
            ...
            <div style="margin-top:10px;" class="five wide right aligned column">
                <button @click="${navigateToByoc}" class="ui mini blue button">Engineering Cluster Creation</button>
