...
public partial class sales_scoring_MidMarket : System.Web.UI.Page
    {
        ...
        private static string BuildWhereClause(string avpId, string smId, string salesRepId, string mobSellerId, string svIds,
            string zipcode, string statecode, string covScore, string fiveg, string band14, string tputText, string roamingDependency, string legacyPen, string fiberStatus)
        {
            string sql = "1=1";
             ...
             string valueColumn, string nameColumn, string sortColumn, string sortDirection = "ASC")
        {
            ...
            if (string.IsNullOrEmpty(searchString))
            {
                ...
                sql = sql + BuildWhereClause(avpId, smId, salesRepId, mobSellerId, svIds, zipcode, statecode, covScore, fiveg, band14, tputText, roamingDependency, legacyPen, fiberStatus);
            }
            else
            {
