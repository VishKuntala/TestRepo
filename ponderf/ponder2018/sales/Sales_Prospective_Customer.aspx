<%@ Page Title="Sales Prospective Customer" Language="C#" MasterPageFile="~/MasterPageProspectiveCustomer.master" AutoEventWireup="true" CodeFile="Sales_Prospective_Customer.aspx.cs" Inherits="sales_Sales_Prospective_Customer" %>
            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline mr-5">
                        <!--begin::Page Title-->
                        <h5 class="text-dark font-weight-bold my-2 mr-5">Prospective Customer - Wireless Scoring</h5>
                        ...
                        <%--<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item">
                                <a href="/sales/Sales_Prospective_Customer.aspx" class="text-muted">National Retail - Store Wireless Scoring</a>
                            </li>                            
                        </ul>--%>
                        <!--end::Breadcrumb-->
                    </div>                    
                ...
                <div style="text-align: right; float: right;" class="m-demo__preview m-demo__preview--btn">                                                                    
                    ...
                    <a class="btn btn-primaryClassification btn-sm" href="mailto:wc5172@att.com;kj390r@att.com;tl246s@att.com;eh569u@att.com?subject=PONDER - Prospective Customer Feedback">&nbsp; Submit Feedback
                                            ...
                                            <div class="row" id="MapDivHeader">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <asp:UpdatePanel ID="UpdatePanel_Inputs" runat="server" ChildrenAsTriggers="true">
                                                                <ContentTemplate>
                                                                    <div>
                                                                        <div>
                                                                            <asp:Label ID="label1" runat="server" Style="height: 35px; width: 150px; float: left;" Text="Customer Name: &nbsp;&nbsp;" Visible="true" Font-Size="10" Font-Bold="false" ForeColor="Black"></asp:Label>
                                                                        ...
                                                                        <div id="buttonrowcenter3">
                                                                            ...
                                                                            <br />
                                                                            <div id="footer submit" style="text-align: center; color: #343a40; font-size:11px;">(Customer Name must be selected to activate submit button)</div>                                                                            
                                                ...
                                                <div class="col-lg-8" id="MapDivSection">
                                                    <div id="Information" style='text-align: center;'>
                                                        <h2>Select Customer Name and any Filters then click 'Submit' to show data.</h2>
                                                    </div>
                                                                        ...
                                                                        <div class="card card-custom">
                                                                                ...
                                                                                <div class="card-header">
                                                                                    <div class="card-title">
                                                                                        ...
                                                                                        <h3 class="card-label">Dashboard of Wireless Characteristics</h3>
                                                                                        <h6 class="card-label">&nbsp;&nbsp;(Important: Depends on filter settings from above)</h6>
                                                                                        <div style="display: none;">
                                                                                ...
                                                                                <div class="row" id="titlerow200" style="height: 35%; width: 100%; overflow: auto; display: flex;">
                                                                                    ...
                                                                                    <div class="col-md-2" id="title401col" style="text-align: left; font-size:12px; padding-left:40px">
                                                                                        <span style="width: 12px; height: 12px; border-radius: 0%; background-color: #003300; display: inline-block; vertical-align: middle;"></></span> Roaming No: <b><span id="roamingCountNo"></span></b>
                                                                                    </div>
                                                                                ...
                                                                                <div class="row" id="titlerow500" style="height: 35%; width: 100%; overflow: auto; display: flex;">
                                                                                    <div class="col-md-2" id="title104col" style="text-align: left; font-size:12px; padding-left:40px">
                                                                                        <span style="width: 12px; height: 12px; border-radius: 0%; background-color: #ffff00; display: inline-block; vertical-align: middle;"></></span> 2: Weak: <b><span id="coverageScoreCount2"></span></b>
                                                                                    </div>
    ...
    <script>
        ...
        if (IEDetected == 'No') {
            ...
            $(document).ready(function () {
                ...
                //    type: "POST",
                //    async: true,
                //    url: "Sales_Prospective_Customer.aspx/GetDATADATE",
                //    data: JSON.stringify({}),
                //    dataType: "json",
            ...
            function updateSalesOpportunityChartMarket() {
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "Sales_Prospective_Customer.aspx/Get_Store_Detail_Market",  //use a function from C# , change this for different data return
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "Sales_Prospective_Customer.aspx/Get_Zip_Summary_Info",  //use a function from C# , change this for different data return
                    data: JSON.stringify({ 'groupVariable': groupGeo }),
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "Sales_Prospective_Customer.aspx/Get_ZipTable_Data",  //use a function from C# , change this for different data return
            ...
            function UpdateHomeTable() {
                ...
                $.when(
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_Prospective_Customer.aspx/Get_Location_Detail_National1",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_Prospective_Customer.aspx/Get_Location_Detail_National2",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_Prospective_Customer.aspx/Get_Location_Detail_National3",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_Prospective_Customer.aspx/Get_Location_Detail_National4",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_Prospective_Customer.aspx/Get_Location_Detail_National5",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_Prospective_Customer.aspx/Get_Location_Detail_National6",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_Prospective_Customer.aspx/Get_Store_Detail_National1",  //use a function from C# , change this for different data return
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_Prospective_Customer.aspx/Get_Store_Detail_National2",  //use a function from C# , change this for different data return
                        data: JSON.stringify({ 'StateVariable': StateVariable, 'ZipVariable': ZipVariable }),
                        dataType: "json",
                        contentType: "application/json; charset=utf-8",
                        success: function (data) {
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_Prospective_Customer.aspx/Get_Store_Detail_National3",  //use a function from C# , change this for different data return
                        data: JSON.stringify({ 'StateVariable': StateVariable, 'ZipVariable': ZipVariable }),
                        dataType: "json",
                        contentType: "application/json; charset=utf-8",
                        success: function (data) {
                ...
                //    type: "POST",
                //    async: true,
                //    url: "Sales_Prospective_Customer.aspx/Get_CMA_Summary_Info",  //use a function from C# , change this for different data return
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "Sales_Prospective_Customer.aspx/Get_NationalTable_Data",  //use a function from C# , change this for different data return
                    data: JSON.stringify({
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "Sales_Prospective_Customer.aspx/Getdonut1", //v5 updated
                    data: JSON.stringify({
                        'groupVariable': groupGeo, 'overallCatVariable': '%', 'campaignVariable': '%', 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable,
                        'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                        'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable }),
                ...
                if (groupGeo == 'SALES') {
                    if (marketGeo == '%') {
                        ...
                        $.when(
                            ...
                            //    type: "POST",
                            //    async: true,
                            //    url: "Sales_Prospective_Customer.aspx/Get_cma_theme_data",  //use a function from C# , change this for different data return
                            //    data: JSON.stringify({ 'groupVariable': groupGeo, 'marketVariable': marketGeo }),
                            //    dataType: "json",
                            //    contentType: "application/json; charset=utf-8",
                            //    success: function (data) {
                        ...
                        $.when(
                            ...
                            $.ajax({
                                type: "POST",
                                async: true,
                                url: "Sales_Prospective_Customer.aspx/Get_county_theme_data",  //use a function from C# , change this for different data return
                                data: JSON.stringify({ 'groupVariable': groupGeo, 'marketVariable': marketGeo }),
                                dataType: "json",
                                contentType: "application/json; charset=utf-8",
                                success: function (data) {
                        ...
                        if (marketGeo == 'FLORIDA' | marketGeo == 'GEORGIA SOUTH CAROLINA' | marketGeo == 'GREATER LAKES' | marketGeo == 'GULF STATES' | marketGeo == 'HEARTLAND STATES' | marketGeo == 'KAMO' |
                            ...
                            $.when(
                                ...
                                $.ajax({
                                    type: "POST",
                                    async: true,
                                    url: "Sales_Prospective_Customer.aspx/Get_zip_theme_data",  //use a function from C# , change this for different data return
            ...
            function NationalTable(data) {
                ...
                table.DataTable({
                    ...
                    columnDefs: [{ width: 50, targets: [0, 8, 15] }, { visible: false, searchable: false, targets: [ 6,7] }, { className: "dt-center", targets: [0, 8, 12, 13, 14, 15] }],
                    columns: [
                        { 'data': 'ROWNUM' },
                        { 'data': 'CUSTOMER_NAME' },
                        { 'data': 'ADDR_LINE1' },
            ...
            function showDataAll(data) {
                ...
                var orderColumn;
                var SortVariable = $('#<%= ddlSort_1.ClientID %> option:selected').val();
                if (SortVariable == "COVERAGE_SCORE") { orderColumn = 7; }
                else if (SortVariable == "FIVEG") { orderColumn = 8; }
                else if (SortVariable == "TPUT_TEXT") { orderColumn = 10; }
                else if (SortVariable == "ROAM_TEXT") { orderColumn = 11; }
                else if (SortVariable == "BAND_14") { orderColumn = 13; }
                else if (SortVariable == "FIBER_CUST") { orderColumn = 14; }
                else if (SortVariable == "FIVEG_PLUS") { orderColumn = 9; }
                else if (SortVariable == "FIRST_NET") { orderColumn = 12; }         
                ...
                var table = $('#showDataModal_table').DataTable({
                    ...
                    //scroller: true,
                    sort: true,
                    order: ([[orderColumn, 'desc'],[15, 'asc']] ),
                    dom: 'rtlifp',
                    //buttons: [{}],
                    columnDefs: [{ width: 50, targets: [7] }, { className: "dt-center", targets: [11, 12, 13, 14, 15] }],
                    columns: [                        
            ...
            var storeMapV3_National = function (locationData, storeData, MarketBoundaryData) {
                ...
                var CAMPAIGN1 = locationData.filter(function (el) {
                    return el.CUSTOMER_NAME.includes(CampaignVariable);
                });
                //var CAMPAIGN2 = locationData.filter(function (el) {
                //    return el.CUSTOMER_NAME.includes("CAMPAIGN2");
                //});
                //var CAMPAIGN3 = locationData.filter(function (el) {
                //    return el.CUSTOMER_NAME.includes("CAMPAIGN3");
                //});


                mcg = L.markerClusterGroup({ chunkedLoading: true, disableClusteringAtZoom: 9, spiderfyOnMaxZoom: false }),
                ...
                for (i in CAMPAIGN1) {
                    var popup =
                        '<b>Customer Name:</b> ' + CAMPAIGN1[i].CUSTOMER_NAME +
                        '<br/><b>Location ID:</b> ' + CAMPAIGN1[i].ID +
                        '<br/><b>Phone:</b> ' + CAMPAIGN1[i].PHONE +
                        '<br/><b>Address:</b> ' + CAMPAIGN1[i].ADDR_LINE1 +
                        '<br/><b>City, State Zip:</b> ' + CAMPAIGN1[i].CITY + ', ' + CAMPAIGN1[i].STATE + ' ' + CAMPAIGN1[i].ZIPCODE +
                ...
                document.getElementById('mapcountwarning').innerHTML = "";
                document.getElementById('mapcounttitle').innerHTML = "Prospective Customer - Wireless Scoring";
                document.getElementById('mapcountsubtitle').innerHTML = "";
                ...
                //        '<br />Fiber Available: ' + FIBER_AVAILABLECOMMA + '<br />' + 'Current Fiber Customers: ' + FIBER_CUSTOMERSCOMMA + '<br />Prospective Fiber Opportunities: ' + FIBER_OPPORTUNITYCOMMA +
        ...
        function loadDonut1(data) {
            ...
            donutcharting101('donut1', title, totalCount, covScore_1, covScore_2, covScore_3, covScore_4, covScore_5 ); //call my chart building function
        }
        ...
        function loadDonut2(data) {
            ...
            donutcharting102('donut2', title, totalCount, fiveG_Yes, fiveG_No, fiveG_Partial); //call my chart building function
        }
        ...
        function loadDonut3(data) {
            ...
            donutcharting103('donut3', title, totalCount, speed_VeryLow, speed_Low, speed_Medium, speed_High, speed_VeryHigh); //call my chart building function
        }
        ...
        function loadDonut4(data) {
            ...
            donutcharting104('donut4', title, totalCount, roaming_No, roaming_Medium, roaming_Heavy); //call my chart building function
        ...
        function loadDonut5(data) {
            ...
            donutcharting105('donut5', title, totalCount, band14_Yes, band14_No, band14_Partial); //call my chart building function
        ...
        function loadDonut6(data) {
            ...
            donutcharting106('donut6', title, totalCount, devicePen_Low, devicePen_Medium, devicePen_High); //call my chart building function
            
        }        

        /* DONUT CHART CREATER */
        function donutcharting101(container, title, totalCount, covScore_1, covScore_2, covScore_3, covScore_4, covScore_5) {
            ...
            $(function () {
                ...
                Highcharts.chart(container, { //define the Highchart
                    colors: ['#003300', '#008000', '#00cc00', '#ffff00', '#e6b800'], //series' colors light blue
        ...
        /* DONUT CHART CREATER */
        function donutcharting102(container, title, totalCount, fiveG_Yes, fiveG_No, fiveG_Partial) {
            Highcharts.setOptions({
                lang: {
                    thousandsSep: ','
                }
        ...
        /* DONUT CHART CREATER */
        function donutcharting103(container, title, totalCount, speed_VeryLow, speed_Low, speed_Medium, speed_High, speed_VeryHigh) {
            Highcharts.setOptions({
                lang: {
                    thousandsSep: ','
                }
        ...
        /* DONUT CHART CREATER */
        function donutcharting104(container, title, totalCount, roaming_No, roaming_Medium, roaming_Heavy) {
            Highcharts.setOptions({
                lang: {
                    thousandsSep: ','
                }
        ...
        /* DONUT CHART CREATER */
        function donutcharting105(container, title, totalCount, band14_Yes, band14_No, band14_Partial) {
            Highcharts.setOptions({
                lang: {
                    thousandsSep: ','
                }
        ...
        /* DONUT CHART CREATER */
        function donutcharting106(container, title, totalCount, devicePen_Low, devicePen_Medium, devicePen_High) {
            Highcharts.setOptions({
                lang: {
                    thousandsSep: ','
                }
