<%@ Page Title="QA Testing Sales National Wireless Campaign" Language="C#" MasterPageFile="~/MasterPageNationalWirelessCampaign.master" AutoEventWireup="true" CodeFile="Sales_National_Wireless_Campaign_QA_Testing.aspx.cs" Inherits="sales_Sales_National_Wireless_Campaign_QA_Testing" %>
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline mr-5">
                        ...
                        <%--<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item">
                                <a href="/sales/Sales_National_Wireless_Campaign_QA_Testing.aspx" class="text-muted">National Retail - Store Wireless Scoring</a>
                            </li>
                        </ul>--%>
                        <!--end::Breadcrumb-->
                    </div>
    ...
    <script>
        ...
        if (IEDetected == 'No') {
            ...
            $(document).ready(function () {
                ...
                //    type: "POST",
                //    async: true,
                //    url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/GetDATADATE",
                //    data: JSON.stringify({}),
                //    dataType: "json",
            ...
            function updateSalesOpportunityChartMarket() {
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Store_Detail_Market",  //use a function from C# , change this for different data return
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Zip_Summary_Info",  //use a function from C# , change this for different data return
                    data: JSON.stringify({ 'groupVariable': groupGeo }),
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_ZipTable_Data",  //use a function from C# , change this for different data return
            ...
            function UpdateHomeTable() {
                ...
                $.when(
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National1",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National2",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National3",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National4",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National5",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National6",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National7",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National8",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National9",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National10",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National11",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National12",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National13",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National14",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National15",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National16",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National17",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National18",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National19",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National20",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National21",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National22",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National23",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National24",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National25",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National26",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National27",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National28",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National29",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National30",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National31",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National32",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National33",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National34",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National35",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National36",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National37",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National38",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National39",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National40",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National41",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National42",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National43",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National44",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Location_Detail_National45",  //use a function from C# , change this for different data return
                        data: JSON.stringify({
                            'groupVariable': groupGeo, 'CampaignVariable': CampaignVariable, 'StateVariable': StateVariable, 'ZipVariable': ZipVariable, 'CoverageScoreVariable': CoverageScoreVariable, 'FiveGVariable': FiveGVariable,
                            'TPUT_TEXTVariable': TPUT_TEXTVariable, 'CompetitorVariable': CompetitorVariable, 'ROAMVariable': ROAMVariable, 'B14Variable': B14Variable, 'FiberCustVariable': FiberCustVariable, 'SortVariable': SortVariable
                        }),
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Store_Detail_National1",  //use a function from C# , change this for different data return
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Store_Detail_National2",  //use a function from C# , change this for different data return
                        data: JSON.stringify({ 'StateVariable': StateVariable, 'ZipVariable': ZipVariable }),
                        dataType: "json",
                        contentType: "application/json; charset=utf-8",
                        success: function (data) {
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_Store_Detail_National3",  //use a function from C# , change this for different data return
                        data: JSON.stringify({ 'StateVariable': StateVariable, 'ZipVariable': ZipVariable }),
                        dataType: "json",
                        contentType: "application/json; charset=utf-8",
                        success: function (data) {
                ...
                //    type: "POST",
                //    async: true,
                //    url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_CMA_Summary_Info",  //use a function from C# , change this for different data return
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_NationalTable_Data",  //use a function from C# , change this for different data return
                    data: JSON.stringify({
                ...
                if (groupGeo == 'SALES') {
                    if (marketGeo == '%') {
                        ...
                        $.when(
                            ...
                            //    type: "POST",
                            //    async: true,
                            //    url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_cma_theme_data",  //use a function from C# , change this for different data return
                            //    data: JSON.stringify({ 'groupVariable': groupGeo, 'marketVariable': marketGeo }),
                            //    dataType: "json",
                            //    contentType: "application/json; charset=utf-8",
                            //    success: function (data) {
                        ...
                        $.when(
                            ...
                            $.ajax({
                                type: "POST",
                                async: true,
                                url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_county_theme_data",  //use a function from C# , change this for different data return
                                data: JSON.stringify({ 'groupVariable': groupGeo, 'marketVariable': marketGeo }),
                                dataType: "json",
                                contentType: "application/json; charset=utf-8",
                                success: function (data) {
                        ...
                        if (marketGeo == 'FLORIDA' | marketGeo == 'GEORGIA SOUTH CAROLINA' | marketGeo == 'GREATER LAKES' | marketGeo == 'GULF STATES' | marketGeo == 'HEARTLAND STATES' | marketGeo == 'KAMO' |
                            ...
                            $.when(
                                ...
                                $.ajax({
                                    type: "POST",
                                    async: true,
                                    url: "Sales_National_Wireless_Campaign_QA_Testing.aspx/Get_zip_theme_data",  //use a function from C# , change this for different data return
