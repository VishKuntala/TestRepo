...
const addOverlayLayer = (layer, canvasData, title, isDefault, minZoomVisibility, maxZoomVisibility, showHideOnZoom) => {
    //console.log('before filtering overlays: ' + overLays);
    overLays = R.filter(l => l.title !== title, overLays);
    overLays.push({ layer, canvasData, title, minZoomVisibility, maxZoomVisibility, isDefault, showHideOnZoom });
    //console.log('after filtering overlays: ' + overLays);
}
...
const rebuildMapOverlaysData = map => {
    ...
    //console.log('rebuild map overlays data: ' + overLays);
