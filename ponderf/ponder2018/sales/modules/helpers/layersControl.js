...
const {
    ...
    FUTURE_PSA_LOCATIONS,
    FUTURE_FIBER_OPPORTUNITY,
    PSA_LOICATIONS,
    TOP_PSA_LOCATIONS,
...
const getUpdatedSpanElement = (category, options) => {    
    ...
    if (color) {
        switch (category) {
            ...
            case FUTURE_PSA_LOCATIONS:
                return `<div class="triangle-label"><i style="border-bottom: 10px solid ${color};"></i>${category}</div>`;
            case FUTURE_FIBER_OPPORTUNITY:
