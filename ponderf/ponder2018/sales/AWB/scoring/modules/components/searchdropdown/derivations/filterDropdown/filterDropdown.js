...
const filterDropdown = ({ adminUser, instance }) => {
    ...
    const initSubscriptions = async () => {
        ...
        instance.appendSubscription(instance.stateManager.subscribe("postDropdownValueChanged",
            async d => {
                ...
                // if it is one of the dropdowns marked to reset the map, reset the currentMapZoom and currentMapCenter to the starting values
