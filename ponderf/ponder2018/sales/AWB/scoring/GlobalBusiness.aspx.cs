...
public partial class sales_scoring_GlobalBusiness : System.Web.UI.Page
{
    ...
    private static string BuildWhereClause(string industry, string svIds, string companyNames,
        string noLowAccounts, string statecode, string zipcode, string fiveg, string band14, string tputText, string roamingDependency, string covScore)
    {
        string sql = "1=1";
             ...
             string valueColumn, string nameColumn, string sortColumn, string sortDirection = "ASC")
        {
            ...
            if (string.IsNullOrEmpty(searchString))
            {
                ...
                sql = sql + BuildWhereClause(industry, svIds, companyNames, noLowAccounts, statecode,zipcode, fiveg, band14, tputText, roamingDependency, covScore);
            }
            else
            {
