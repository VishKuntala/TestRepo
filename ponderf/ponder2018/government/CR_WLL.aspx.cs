...
public partial class government_CR_WLL : System.Web.UI.Page
{
    ...
    [WebMethod]
    public static string GetWLLCARRIERREGION()
    {
        //Construction Started
        string sql = @"SELECT  * FROM PONDER.WLLCARRIERREGION";
    ...
    [WebMethod]
    public static string GetWLLCARRIERREGION_CHART2()
    {
        //Construction Started
        string sql = @"SELECT  * FROM PONDER.WLLCARRIERREGION_CHART2";
