<%@ Page Title="FirstNet Markets" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Markets_FirstNet.aspx.cs" Inherits="government_Markets_FirstNet" %>
    ...
    <div class="col-xl-12">
        ...
        <div class="m-portlet">
            ...
            <div class="m-portlet__head">
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">2020 FirstNet Market View
                        </h3>
                    </div>
                </div>
            </div>
            <div class="m-portlet__body">
                <div class="m-section">
                    <%--<span class="m-section__heading">Market View: FirstNet Projects
                    </span>--%>
                    ...
                    <div class="row" id="table1row" style="height: 35%; width: 100%; overflow: auto; display: flex;">
                        <div class="col-md-12" id="table1col" style="height: 100%;">
                            <div id="FNCARRIERMARKET" style="visibility: visible;"></div>
                        </div>
                    </div>
                    <br />
                    <div class="row" id="table2row" style="height: 35%; width: 100%; overflow: auto; display: flex;">
                        <div class="col-md-12" id="table2col" style="height: 100%;">
                            <div id="FNFOREACTMARKET" style="visibility: visible;"></div>
                        </div>
                    </div>
                    <br />
                    <div class="row" id="table3row" style="height: 35%; width: 100%; overflow: auto; display: flex;">
                        <div class="col-md-12" id="table3col" style="height: 100%;">
                            <div id="FNOUTLOOKMARKET" style="visibility: visible;"></div>
                        </div>
                    </div>
    ...
    <script>
        ...
        function Getmarketdata(market) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Markets_FirstNet.aspx/GetFNCARRIERMARKET",
                data: JSON.stringify({ 'marketVariable': market }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
                    loadFNCARRIERMARKET(data);
                },
                error: function (data) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Markets_FirstNet.aspx/GetFNFOREACTMARKET",
                data: JSON.stringify({ 'marketVariable': market }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
                    loadFNFOREACTMARKET(data);
                },
                error: function (data) {
                    alert('there was an arror!');
                }
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Markets_FirstNet.aspx/GetFNOUTLOOKMARKET",
                data: JSON.stringify({ 'marketVariable': market }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
                    loadFNOUTLOOKMARKET(data);
                },
                error: function (data) {
                    alert('there was an arror!');
                }
        ...
        var chart2;
        /* Ajax call to load the FNCARRIERMARKET chart data */

        function loadFNCARRIERMARKET(data) {
            ...
            const options = {
                ...
                series: series,
                title: {
                    text: marketTitle + ' FirstNet Carriers by State',
                    style: {
                        fontSize: "18px",
                        fontWeight: 'bold'
                    }
            ...
            // Create chart
            const chart = Highcharts.chart('FNCARRIERMARKET', options)
        }
        ...
        function loadFNFOREACTMARKET(data) {
            var marketTitle = $('#ddlMarket option:selected').val();
            ...
            createFNColchart(FN_series_values[0], 'FNFOREACTMARKET', marketTitle + ' FirstNet Carrier Forecast', 'Forecast vs. Actual');
        ...
        /* HC SUMMARY CHART LOADER */
        function loadFNOUTLOOKMARKET(data) {
            var marketTitle = $('#ddlMarket option:selected').val();
            ...
            createFN2Colchart(FN2_series_values[0], 'FNOUTLOOKMARKET', marketTitle + ' FirstNet Carrier Outlook', 'Milestones');
