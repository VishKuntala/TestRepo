<%@ Page Title="WLL Central Region" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CR_WLL.aspx.cs" Inherits="government_CR_WLL" %>
            ...
            <div class="m-portlet__head">
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">RAN Central Region - WLL 2020 POE
                        </h3>
                    </div>
                </div>
            </div>
                ...
                <div class="m-section">
                    <div class="row" id="table1row" style="height: 35%; width: 100%; overflow: auto; display: flex;">
                        <div class="col-md-12" id="table1col" style="height: 100%;">
                            <div id="WLLCARRIERREGION" style="visibility: visible;"></div>
                        </div>
                    </div>
                    <br />
                    <div class="row" id="table2row" style="height: 35%; width: 100%; overflow: auto; display: flex;">
                        <div class="col-md-12" id="table2col" style="height: 100%;">
                            <div id="WLLCARRIERREGION_CHART2" style="visibility: visible;"></div>
                        </div>
                    </div>
                </div>
            </div>            
    ...
    <script>
        ...
        $(document).ready(function () {
            $.ajax({
                type: "POST",
                async: true,
                url: "CR_WLL.aspx/GetWLLCARRIERREGION",
                data: JSON.stringify({}),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
                    loadWLLCARRIERREGION(data);
                },
                error: function (data) {
                }
            });
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "CR_WLL.aspx/GetWLLCARRIERREGION_CHART2",
                data: JSON.stringify({}),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
                    loadWLLCARRIERREGION_CHART2(data);
                },
                error: function (data) {
                }
            });
        ...
        function loadWLLCARRIERREGION(data) {
            ...
            createFNColchart(FN_series_values[0], 'WLLCARRIERREGION', 'Central Region WLL Carrier Forecast', 'Forecast vs. Actual');
        ...
        /* HC SUMMARY CHART LOADER */
        function loadWLLCARRIERREGION_CHART2(data) {
            ...
            createFN2Colchart(FN2_series_values[0], 'WLLCARRIERREGION_CHART2', 'Central Region WLL Carrier Outlook', 'Milestones');
