<%@ Page Title="B14 mPilot Scheduler" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="mPilot_Scheduler.aspx.cs" Inherits="toolsandauto_mPilot_Scheduler" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="d-flex align-items-center">
        <div class="mr-auto">
            <h3 class="m-subheader__title m-subheader__title--separator">B14 mPilot Scheduler</h3>
            ...
            <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                ...
                <li class="m-nav__item">
                    <a href="/toolsandauto/mPilot_Scheduler.aspx" class="m-nav__link">
                        <span class="m-nav__link-text">B14 mPilot Scheduler
                        </span>
                    </a>
                </li>
            </ul>
        ...
        <div class="m-portlet">
            <div class="m-portlet__head">
                <div class="m-portlet__head-caption">
                    <h3 class="center_title">B14 mPilot Scheduler</h3>
                </div>
            </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "mPilot_Scheduler.aspx/Get_SchedulerData",
        ...
        function pcb_queryFillList(sql1, myObject) {
            $.ajax({
                type: "POST",
                async: true,
                url: "mPilot_Scheduler.aspx/callAXIOMquery",
        ...
        function pcb_queryUpdates(sql1) {            
            $.ajax({
                type: "POST",
                async: false,
                url: "mPilot_Scheduler.aspx/callAXIOMinsert",
                data: JSON.stringify({ 'sql': sql1 }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
        ...
        function mpilot_scheduler_update() {
            ...
            $.ajax({
                type: "POST",
                async: false,
                url: "mPilot_Scheduler.aspx/mpilot_scheduler_update",
                data: JSON.stringify({}),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
        ...
        $(function () {
            ...
            $("#btnSearch").click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "mPilot_Scheduler.aspx/GetSearchAll",
