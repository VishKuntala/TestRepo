<%@ Page Title="NewEngland" Language="C#" MasterPageFile="~/MasterPageNewEngland.master" AutoEventWireup="true" CodeFile="NewEngland.aspx.cs" Inherits="NewEngland_NewEngland" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="d-flex align-items-center">
        <div class="mr-auto">
            ...
            <br />--%>
            <h3 class="m-subheader__title m-subheader__title--separator">New England
            </h3>
            <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                <li class="m-nav__item m-nav__item--home">
                    <a href="/NewEngland/NewEngland.aspx" class="m-nav__link m-nav__link--icon">
                ...
                <li class="m-nav__item">
                    <a href="/NewEngland/NewEngland.aspx" class="m-nav__link">
                        <span class="m-nav__link-text">New England
                        </span>
                    </a>
                </li>
            </ul>
                                    ...
                                    <div class="tab-pane active" id="m_tabs_1_1" role="tabpanel">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12" id="RecentDiv">
                                                <div class="row">
                                                <%--<div class="col-lg-2" id="RecentDiv1">&nbsp;</div>--%>
                                                ...
                                                <div id="Recent_Sales_Detail" class="m-section__content" style="height: 300px; width: 100%">
                                                    ...
                                                    <div id="B14_Summary_div" class="m-section__content" style="height: 100px; width: 100%">
                                                    <table id="B14_Summary" class="table compact" style="width: 100%; height: 100%; font-size: 12px; white-space: nowrap; text-align: center; color: black;">
                                                        <thead>
                                                            <tr>
                                                                <th bgcolor="#87CEFA">On Air Category</th>
                                                                <th bgcolor="#87CEFA">Count</th>
                                                                <th bgcolor="#87CEFA">B14 on Separate Job</th>
                                                                <th bgcolor="#87CEFA">FirstNet NSB</th>
                                                                <th bgcolor="#87CEFA">No B14 at FA</th>
                                                    ...
                                                    <div id="B14_Detail_div" class="m-section__content" style="height: 700px; width: 100%">
                                                    <table id="B14_Detail" class="table compact" style="width: 100%; height: 100%; font-size: 12px; white-space: nowrap; text-align: center; color: black;">
                                                        <thead>
                                                            <tr>

                                                                <th bgcolor="#87CEFA">On Air Category</th>
                                                                <th bgcolor="#87CEFA">B14 Category</th>
                                                                <th bgcolor="#87CEFA">On Air Date</th>
                                                                <th bgcolor="#87CEFA">State</th>
                                                                <th bgcolor="#87CEFA">County</th>
                                                                <th bgcolor="#87CEFA">City</th>
                                                                <th bgcolor="#87CEFA">NSB PACE Name</th>
                                                                <th bgcolor="#87CEFA">NSB Subprogram</th>
                                                                <th bgcolor="#87CEFA">NSB PACE Number</th>
                                                                <th bgcolor="#87CEFA">B14 Job Number</th>
                                                ...
                                                <%--<div class="col-lg-2" id="RecentDiv3"></div>--%>
                                                    </div>
                                    ...
                                    <div class="tab-pane" id="m_tabs_1_3" role="tabpanel">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12" id="RecentDiv_CRAN">
                                                <div class="row">
                                                <div class="col-lg-2" id="RecentDiv1_CRAN">&nbsp;</div>
                                                <div class="col-lg-8" id="RecentDiv2_CRAN">
                                                ...
                                                <div class="col-lg-2" id="RecentDiv3_CRAN"></div>
                                                    </div>
                                       ...
                                       <div class="m-portlet__head-caption">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12" id="RecentDiv_IB">
                                                <div class="row">
                                                <div class="col-lg-2" id="RecentDiv1_IB">&nbsp;</div>
                                                <div class="col-lg-8" id="RecentDiv2_IB">
                                                ...
                                                <div class="col-lg-2" id="RecentDiv3_IB"></div>
                                                    </div>
    ...
    <script>
        ...
        function Getmarketdata(market, time, market_long) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "NewEngland.aspx/GetDATADATE",
                data: JSON.stringify({}),
                dataType: "json",
        ...
        function Get_B14() {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "NewEngland.aspx/Get_B14_Summary",
                data: JSON.stringify({ 'geoVariable': salesGeo }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
                    console.log('b14 ajax done, data: ' + data);
                    load_B14(data);
                },
                error: function (data) {
                }
        ...
        function Get_B14_Full() {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "NewEngland.aspx/Get_B14_Detail",
                data: JSON.stringify({ 'geoVariable': salesGeo }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
                    console.log('b14 Full ajax done, data: ' + data);
                    load_B14_Full(data);
                },
                error: function (data) {
                }
        ...
        */
        ...
        var recent_lat_index = 0; //to allow for easier table updates, use this variable to indicate which column in the sql detail has lat. Keep it first in query to simplify
        var recent_long_index = 1; //to allow for easier table updates, use this variable to indicate which column in the sql detail has lat. Keep it second in query to simplify
        ...
        function updateSalesChart(market, time, market_long) {
            ...
            $.when(
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "NewEngland.aspx/Get_Recent_Sales_Detail",  //use a function from C# , change this for different data return
                    data: JSON.stringify({  'geoVariable': salesGeo }),
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "NewEngland.aspx/Get_Recent_Sales_Detail2",  //use a function from C# , change this for different data return
                    data: JSON.stringify({  'geoVariable': salesGeo }),
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "NewEngland.aspx/Get_Recent_Sales_Detail3",  //use a function from C# , change this for different data return
                    data: JSON.stringify({  'geoVariable': salesGeo }),
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
        ...
        function updateSalesChart_CRAN(market, time, market_long) {
            ...
            $.when(
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "NewEngland.aspx/Get_Recent_Sales_Detail_CRAN",  //use a function from C# , change this for different data return
                    data: JSON.stringify({  'geoVariable': salesGeo }),
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "NewEngland.aspx/Get_Recent_Sales_Detail_CRAN2",  //use a function from C# , change this for different data return
                    data: JSON.stringify({  'geoVariable': salesGeo }),
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "NewEngland.aspx/Get_Recent_Sales_Detail_CRAN3",  //use a function from C# , change this for different data return
                    data: JSON.stringify({  'geoVariable': salesGeo }),
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "NewEngland.aspx/Get_Recent_Sales_Detail_CRAN4",  //use a function from C# , change this for different data return
                    data: JSON.stringify({  'geoVariable': salesGeo }),
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
        ...
        function updateSalesChart_IB(market, time, market_long) {
            ...
            $.when(
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "NewEngland.aspx/Get_Recent_Sales_Detail_IB",  //use a function from C# , change this for different data return
                    data: JSON.stringify({ 'geoVariable': salesGeo }),
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "NewEngland.aspx/Get_Recent_Sales_Detail_IB2",  //use a function from C# , change this for different data return
                    data: JSON.stringify({ 'geoVariable': salesGeo }),
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "NewEngland.aspx/Get_Recent_Sales_Detail_IB3",  //use a function from C# , change this for different data return
                    data: JSON.stringify({ 'geoVariable': salesGeo }),
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "NewEngland.aspx/Get_Recent_Sales_Detail_IB4",  //use a function from C# , change this for different data return
                    data: JSON.stringify({ 'geoVariable': salesGeo }),
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
        ...
        function load_B14(data) {

            
            dataparsed = JSON.parse(data.d);
            ...
            if (dataparsed.length <= 0) {
                ...
                $('#B14_Summary').dataTable().fnDestroy(); //destroy old table
                $.fn.dataTable.moment('MM-DD-YYYY');
                $('#B14_Summary').DataTable({ //build new table
                    orderCellsTop: false,
                    fixedHeader: false,
                    paging: false,
                    sort: true,
                    ...
                    binfo: true,
                    dom: 'Bfrtip',
                    buttons: [{ extend: 'csv', title: 'B14_Summary_Export' }, { extend: 'excelHtml5', title: 'B14_Summary_Export' }],
                    ...
                    columns: [ //define columns, you can hard code them like this, or build them dynamically with a loop based on your parsed JSON data
                        ...
                        { 'data': 'ON_AIR_CATEGORY' },
                        { 'data': 'COUNT' },
                        { 'data': 'SEPARATE_B14_JOB' },
                        { 'data': 'FIRSTNET_NSB' },
                        { 'data': 'NO_B14_AT_FA' }
                    ...
                    "fnDrawCallback": function () {
                        $('#B14_Summary tr').find('td').each(function () {
        ...
        function load_B14_Full(data) {
            ...
            if (dataparsed.length <= 0) {
                ...
                $('#B14_Detail').dataTable().fnDestroy(); //destroy old table
                $.fn.dataTable.moment('MM-DD-YYYY');
                $('#B14_Detail').DataTable({ //build new table
                    orderCellsTop: false,
                    fixedHeader: false,
                    paging: false,
                    sort: true,
                    ...
                    binfo: true,
                    dom: 'Bfrtip',
                    buttons: [{ extend: 'csv', title: 'B14_Detail_Export' }, { extend: 'excelHtml5', title: 'B14_Detail_Export' }],
                    //columnDefs: [{ visible: false, targets: 8 }],
                    columns: [ //define columns, you can hard code them like this, or build them dynamically with a loop based on your parsed JSON data
                        ...
                        { 'data': 'NSB_PACE_NAME' },
                        { 'data': 'NSB_SUBPROGRAM' },
                        { 'data': 'NSB_PACE_NUMBER' },
                        { 'data': 'B14_JOB_PACE_NUMBER' }
                    ...
                    "fnDrawCallback": function () {
                        $('#B14_Detail tr').find('td').each(function () {
                            $(this).on('mouseover', function () {
                                $(this).parent().css('background', 'silver');
        ...
        function salesMap(market, time, market_long, DATE1, DATE2, DATE3, DATE4) {
        ...
        function salesMap_CRAN(market, time, market_long, DATE1, DATE2, DATE3, DATE4) {
            ...
            for (i = 0; i < recentUpcomingTable.length; i++) {
                ...
                popup = 
                    //'<br/><b>Latitude:</b> ' + recentOnAirTable[i][recent_lat_index] +
                    //'<br/><b>Longitude:</b> ' + recentOnAirTable[i][recent_long_index] +
                    '<br/>On Air Category:</b> ' + recentOnAirTable[i][2] +
                    //'<br/><b>Subprogram:</b> ' + recentOnAirTable[i][3] +
                    '<br/><b>Sales Region:</b> ' + recentOnAirTable[i][4] +
                    '<br/><b>VPGM Market:</b> ' + recentOnAirTable[i][5] +
                    '<br/><b>State:</b> ' + recentOnAirTable[i][6] +
            ...
            var map2 = L.map("salesmapid_CRAN", {
                ...
                center: [39.73, -104.99],
                zoom: 10,
                layers: [streets2, OApoints, Uppoints] //add back in for past    HOApoints,
            });
        ...
        function salesMap_IB(market, time, market_long, DATE1, DATE2, DATE3, DATE4) {
            ...
            document.getElementById('mapcounttitle_IB').innerHTML = market_long + " - IB Jobs";
