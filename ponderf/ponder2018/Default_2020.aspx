<%@ Page Title="Dashboard" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Default_2020.aspx.cs" Inherits="_Default_2020" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="d-flex align-items-center">
        <div class="mr-auto">
            ...
            <br />--%>
            <h3 class="m-subheader__title m-subheader__title--separator">RAN Capital Plan Production - NEW Org
            </h3>
            <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                <li class="m-nav__item m-nav__item--home">
                    <a href="/Default_2020.aspx" class="m-nav__link m-nav__link--icon">
                ...
                <li class="m-nav__item">
                    <a href="/Default_2020.aspx" class="m-nav__link">
            ...
            <div class="m-portlet__body">
                ...
                <div class="m-section">
                    ...
                    <div class="m-portlet__body">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#m_tabs_1_1" id="tab1">
                                    <i class="flaticon-calendar"></i><span class="m--visible-desktop-inline-block"><span id="PREV_YR"></span>&nbsp;View</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#m_tabs_1_2" id="tab2">
    ...
    <script>        
        ...
        function attachClickHandlers() {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Default_2020.aspx/GetCURRYEAR",
                data: JSON.stringify({}),
                dataType: "json",
        ...
        $(function () {
            ...
            $("#btnSearch").click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "Default_2020.aspx/GetSearchAll",
        ...
        function Getmarketdata(market) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Default_2020.aspx/GetDATADATE",
                data: JSON.stringify({}),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Default_2020.aspx/GetProject_AllIn", //v5 updated
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Default_2020.aspx/GetProject_AllIn_FA", //v5 updated
                data: JSON.stringify({ 'marketVariable': market }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
            ...
            if (market == "ALL") {
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "Default_2020.aspx/GetPRODUCTION_CHART_ALL", //v5 updated
                    data: JSON.stringify({ 'marketVariable': market }),
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "Default_2020.aspx/GetPRODUCTION_CHART", //v5 updated
                    data: JSON.stringify({ 'marketVariable': market }),
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
            ...
            //    type: "POST",
            //    async: true,
            //    url: "Default_2020.aspx/GetFORECAST_ATTAIN_ALLIN",
            //    data: JSON.stringify({ 'marketVariable': market }),
            //    dataType: "json",
            //    contentType: "application/json; charset=utf-8",
            //    success: function (data) {
            ...
            //    type: "POST",
            //    async: true,
            //    url: "Default_2020.aspx/GetFORECAST_ATTAIN_ALLIN_30CH",
            //    data: JSON.stringify({ 'marketVariable': market }),
            //    dataType: "json",
            //    contentType: "application/json; charset=utf-8",
            //    success: function (data) {
            ...
            //    type: "POST",
            //    async: true,
            //    url: "Default_2020.aspx/GetFORECAST_ATTAIN_ALLIN_90CH",
            //    data: JSON.stringify({ 'marketVariable': market }),
            //    dataType: "json",
            //    contentType: "application/json; charset=utf-8",
            //    success: function (data) {
            ...
            if (market == "ALL") {
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "Default_2020.aspx/GetDashboardMARKET_ALL", //v5 updated
                    data: JSON.stringify({ 'marketVariable': market }),
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "Default_2020.aspx/GetDashboardMARKET", //v5 updated
                    data: JSON.stringify({ 'marketVariable': market }),
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
            ...
            if (market == "ALL") {
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "Default_2020.aspx/GetDashboardMARKET_2_ALL", //v5 updated
                    data: JSON.stringify({ 'marketVariable': market }),
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "Default_2020.aspx/GetDashboardMARKET_2", //v5 updated
                    data: JSON.stringify({ 'marketVariable': market }),
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
            ...
            if (market == "ALL") {
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "Default_2020.aspx/GetDashboardMARKET_prev_yr_ALL", //v5 updated
                    data: JSON.stringify({ 'marketVariable': market }),
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "Default_2020.aspx/GetDashboardMARKET_prev_yr", //v5 updated
                    data: JSON.stringify({ 'marketVariable': market }),
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
            ...
            if (market == "ALL") {
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "Default_2020.aspx/GetDashboardMARKET_2_prev_yr_ALL", //v5 updated
                    data: JSON.stringify({ 'marketVariable': market }),
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "Default_2020.aspx/GetDashboardMARKET_2_prev_yr", //v5 updated
                    data: JSON.stringify({ 'marketVariable': market }),
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    success: function (data) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Default_2020.aspx/Getdonut1", //v5 updated
                data: JSON.stringify({ 'marketVariable': market }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Default_2020.aspx/Getdonut2", //v5 updated
                data: JSON.stringify({ 'marketVariable': market }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Default_2020.aspx/Getdonut3", //v5 updated
                data: JSON.stringify({ 'marketVariable': market }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Default_2020.aspx/Getdonut4", //v5 updated
                data: JSON.stringify({ 'marketVariable': market }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Default_2020.aspx/Getdonut5", //v5 updated
                data: JSON.stringify({ 'marketVariable': market }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {                   
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Default_2020.aspx/Getdonut6", //v5 updated
                data: JSON.stringify({ 'marketVariable': market }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Default_2020.aspx/GetColumn1plus1", //v5 updated
                data: JSON.stringify({ 'marketVariable': market }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Default_2020.aspx/GetColumn2plus1", //v5 updated
                data: JSON.stringify({ 'marketVariable': market }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Default_2020.aspx/GetColumn3plus1", //v5 updated
                data: JSON.stringify({ 'marketVariable': market }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Default_2020.aspx/GetColumn4plus1", //v5 updated
                data: JSON.stringify({ 'marketVariable': market }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Default_2020.aspx/GetColumn5plus1", //v5 updated
                data: JSON.stringify({ 'marketVariable': market }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Default_2020.aspx/GetColumn6plus1", //v5 updated
                data: JSON.stringify({ 'marketVariable': market }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Default_2020.aspx/GetColumn1plus2", //v5 updated 
                data: JSON.stringify({ 'marketVariable': market }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Default_2020.aspx/GetColumn2plus2", //v5 updated
                data: JSON.stringify({ 'marketVariable': market }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Default_2020.aspx/GetColumn3plus2", //v5 updated
                data: JSON.stringify({ 'marketVariable': market }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Default_2020.aspx/GetColumn4plus2", //v5 updated
                data: JSON.stringify({ 'marketVariable': market }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Default_2020.aspx/GetColumn5plus2", //v5 updated
                data: JSON.stringify({ 'marketVariable': market }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Default_2020.aspx/GetColumn6plus2", //v5 updated
                data: JSON.stringify({ 'marketVariable': market }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Default_2020.aspx/GetColumn1plus3", //v5 updated
                data: JSON.stringify({ 'marketVariable': market }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Default_2020.aspx/GetColumn2plus3", //v5 updated
                data: JSON.stringify({ 'marketVariable': market }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Default_2020.aspx/GetColumn3plus3", //v5 updated
                data: JSON.stringify({ 'marketVariable': market }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Default_2020.aspx/GetColumn4plus3", //v5 updated
                data: JSON.stringify({ 'marketVariable': market }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Default_2020.aspx/GetColumn5plus3", //v5 updated
                data: JSON.stringify({ 'marketVariable': market }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Default_2020.aspx/GetColumn6plus3", //v5 updated
                data: JSON.stringify({ 'marketVariable': market }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Default_2020.aspx/Getdonut1prev_yr", //v5 updated
                data: JSON.stringify({ 'marketVariable': market }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Default_2020.aspx/Getdonut2prev_yr", //v5 updated
                data: JSON.stringify({ 'marketVariable': market }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Default_2020.aspx/Getdonut3prev_yr", //v5 updated
                data: JSON.stringify({ 'marketVariable': market }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Default_2020.aspx/Getdonut4prev_yr", //v5 updated
                data: JSON.stringify({ 'marketVariable': market }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Default_2020.aspx/Getdonut5prev_yr", //v5 updated
                data: JSON.stringify({ 'marketVariable': market }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "Default_2020.aspx/Getdonut6prev_yr", //v5 updated
                data: JSON.stringify({ 'marketVariable': market }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function (data) {
        ...
        function ClickLink_MCA() {
            var market = $('#ddlMarket option:selected').val();
            window.open('/capacity/Drilldown_2020.aspx?accordheader=1&market=' + market, '_blank');
        }
        function ClickLink_CRAN() {
            var market = $('#ddlMarket option:selected').val();
            window.open('/capacity/Drilldown_2020.aspx?accordheader=2&market=' + market, '_blank');
        }
        function ClickLink_LTE1C() {
            var market = $('#ddlMarket option:selected').val();
            window.open('/capacity/Drilldown_2020.aspx?accordheader=3&market=' + market, '_blank');
        }
        function ClickLink_IB() {
            var market = $('#ddlMarket option:selected').val();
            window.open('/capacity/Drilldown_2020.aspx?accordheader=4&market=' + market, '_blank');
        }
        function ClickLink_BWESW() {
            var market = $('#ddlMarket option:selected').val();
            window.open('/capacity/Drilldown_2020.aspx?accordheader=5&market=' + market, '_blank');
        }
